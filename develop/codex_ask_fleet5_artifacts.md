...
results 브랜치 9f8fe9e1  (소스 main@db6d2be6 기준 스냅샷)
```

5 개 모델 모두 **지금 규칙·코드로 만들어진 판**이다 (2026-09-21 재생성 확인).
...
**질문은 Q0~Q5 여섯이다.** Q0 은 5 절 끝에 있다 — 게이트에 열려 있는 항목을 내가
"앵커가 낡은 것일 뿐 라벨은 맞다" 고 진단했는데, **그 진단이 맞는지**를 묻는 것이라
그 표 바로 뒤에 두었다. 우선순위로는 Q0 과 Q2 가 가장 높다.
