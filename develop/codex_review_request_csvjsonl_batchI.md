...
# 배치 I — 대상 모델: nvidia__NVIDIA-Nemotron-3-Super-120B-A12B-BF16, nvidia__NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16, tiiuae__Falcon-H1-7B-Instruct


# ============================================================
# 모델: nvidia__NVIDIA-Nemotron-3-Super-120B-A12B-BF16
# ============================================================
...
| KV cache 크기 | 2·n_kv·d_head = 2·2·128 = 512 elems / token / layer; 8 attention layer(s) ⇒ 4096 / token |
...
| 구분 | 소스 | 역할 |
|---|---|---|
| config (1차) | HF `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16` config.json @ `2dc98e2afe4face0e4ce40972a915c45368bd34a` (sha256 `ac7dddf84baf…`) | 심볼 값의 출처 |
...
```
  ...
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,1,d_chunk,d_chunk]*[d_state,n_h_ssm] -> [B,n_h_ssm,1,d_chunk,d_chunk]
  ...
  model.layers.N.mixer                               sum              [B,1,d_state,n_h_ssm,d_head_ssm,d_chunk] -> [B,1,d_chunk,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               expand           [B,n_kv,1,T,d_head] -> [B,n_kv,n_h_ssm/n_g_ssm,T,d_head]
  model.layers.N.mixer                               clone            [B,n_kv,n_h_ssm/n_g_ssm,T,d_head] -> [B,n_kv,n_h_ssm/n_g_ssm,T,d_head]
  model.layers.N.mixer                               _unsafe_view     [B,n_kv,n_h_ssm/n_g_ssm,T,d_head] -> [B,n_h,T,d_head]
...
```
  ...
  model.layers.N.mixer                               elementwise_mul  [B,d_state,d_head_ssm,1]*[B,d_state,1,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
  ...
  model.layers.N.mixer                               view             [B,d_state,d_state] -> [d_state,d_state,B]
  model.layers.N.mixer                               batched_matmul   [n_h_ssm,d_head_ssm,d_state]*[d_state,d_state,B] -> [n_h_ssm,d_head_ssm,B]
  model.layers.N.mixer                               view             [n_h_ssm,d_head_ssm,B] -> [B,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm]*[d_state,d_head_ssm] -> [B,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               expand           [B,n_kv,1,T+1,d_head] -> [B,n_kv,n_h_ssm/n_g_ssm,T+1,d_head]
  model.layers.N.mixer                               clone            [B,n_kv,n_h_ssm/n_g_ssm,T+1,d_head] -> [B,n_kv,n_h_ssm/n_g_ssm,T+1,d_head]
  model.layers.N.mixer                               _unsafe_view     [B,n_kv,n_h_ssm/n_g_ssm,T+1,d_head] -> [B,n_h,T+1,d_head]
...
# ============================================================
# 모델: nvidia__NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16
# ============================================================
...
| tie embeddings | False |
| decode 방식 | autoregressive, 1 token/step, reuses KV cache (prefill builds it) |
| KV cache 크기 | 2·n_kv·d_head = 2·2·128 = 512 elems / token / layer; 12 attention layer(s) ⇒ 6144 / token |
...
```
  ...
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,1,d_chunk] -> [B,n_h_ssm,1,d_chunk,1]
  model.layers.N.mixer                               expand           [B,n_h_ssm,1,d_chunk,1] -> [B,n_h_ssm,1,d_chunk,d_chunk]
  model.layers.N.mixer                               ones             [] -> [d_state,d_chunk]
  model.layers.N.mixer                               tril             [d_state,d_chunk] -> [d_state,d_chunk]
  model.layers.N.mixer                               bitwise_not      [d_state,d_chunk] -> [d_state,d_chunk]
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,1,d_chunk,d_chunk]*[d_state,d_chunk] -> [B,n_h_ssm,1,d_chunk,d_chunk]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,1,d_chunk,d_chunk] -> [B,n_h_ssm,1,d_chunk,d_chunk]
  model.layers.N.mixer                               exp              [B,n_h_ssm,1,d_chunk,d_chunk] -> [B,n_h_ssm,1,d_chunk,d_chunk]
  model.layers.N.mixer                               unsqueeze        [B,1,d_state,n_h_ssm,d_chunk] -> [B,1,d_state,1,n_h_ssm,d_chunk]
  model.layers.N.mixer                               unsqueeze        [B,1,d_chunk,n_h_ssm,d_state] -> [B,1,1,d_chunk,n_h_ssm,d_state]
  ...
  model.layers.N.mixer.gate                          div_             [T,k]*[T,1] -> [T,k]
  model.layers.N.mixer.gate                          elementwise_mul  [T,k] -> [T,k]
  model.layers.N.mixer.fc1_latent_proj               t                [d_inner/n_g,d_model] -> w=[d_inner/n_g,d_model] [d_model,d_inner/n_g]
  model.layers.N.mixer.fc1_latent_proj               matmul           [T,d_model]*[d_model,d_inner/n_g] -> w=[d_inner/n_g,d_model] [T,d_inner/n_g]
  model.layers.N.mixer.experts                       view             [T,k] -> [k*T]
  model.layers.N.mixer.experts                       sort             [k*T] -> [k*T]*[k*T]
  model.layers.N.mixer.experts                       floor_divide     [k*T] -> [k*T]
  model.layers.N.mixer.experts                       index            [T,d_inner/n_g]*[k*T] -> [k*T,d_inner/n_g]
  model.layers.N.mixer.experts                       index            [k*T]*[k*T] -> [k*T]
  model.layers.N.mixer.experts                       _to_copy         [k*T] -> [k*T]
  model.layers.N.mixer.experts                       histc            [k*T] -> [E]
  model.layers.N.mixer.experts                       cumsum           [E] -> [E]
  ...
  model.layers.N.mixer.experts                       arange           [] -> [k*T]
  model.layers.N.mixer.experts                       index_put_       [k*T]*[k*T]*[k*T] -> [k*T]
  model.layers.N.mixer.experts                       index            [k*T,d_inner/n_g]*[k*T] -> [k*T,d_inner/n_g]
  model.layers.N.mixer.experts                       view             [k*T,d_inner/n_g] -> [T,k,d_inner/n_g]
  model.layers.N.mixer.experts                       sum              [T,k,d_inner/n_g] -> [T,d_inner/n_g]
  model.layers.N.mixer.experts                       _to_copy         [T,d_inner/n_g] -> [T,d_inner/n_g]
  model.layers.N.mixer.fc2_latent_proj               t                [d_model,d_inner/n_g] -> w=[d_model,d_inner/n_g] [d_inner/n_g,d_model]
  model.layers.N.mixer.fc2_latent_proj               matmul           [T,d_inner/n_g]*[d_inner/n_g,d_model] -> w=[d_model,d_inner/n_g] [T,d_model]
  model.layers.N.mixer.shared_experts.up_proj        t                [d_shared,d_model] -> w=[d_shared,d_model] [d_model,d_shared]
  model.layers.N.mixer.shared_experts.up_proj        view             [B,T,d_model] -> [T,d_model]
  model.layers.N.mixer.shared_experts.up_proj        matmul           [T,d_model]*[d_model,d_shared] -> w=[d_shared,d_model] [T,d_shared]
  model.layers.N.mixer.shared_experts.up_proj        _unsafe_view     [T,d_shared] -> [B,T,d_shared]
  ...
  model.layers.93                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.94                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.95                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.96                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.97                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.98                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.99                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.100                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.101                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.102                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.103                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.104                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.105                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.106                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.layers.107                                   elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  model.norm_f                                       _to_copy         [B,T,d_model] -> [B,T,d_model]
  model.norm_f                                       pow              [B,T,d_model] -> [B,T,d_model]
  model.norm_f                                       mean             [B,T,d_model] -> [B,T,1]
  model.norm_f                                       elementwise_add  [B,T,1] -> [B,T,1]
...
```
  ...
  model.layers.N.mixer.gate                          elementwise_mul  [B,k] -> [B,k]
  model.layers.N.mixer.fc1_latent_proj               t                [d_inner/n_g,d_model] -> w=[d_inner/n_g,d_model] [d_model,d_inner/n_g]
  model.layers.N.mixer.fc1_latent_proj               matmul           [B,d_model]*[d_model,d_inner/n_g] -> w=[d_inner/n_g,d_model] [B,d_inner/n_g]
  model.layers.N.mixer.experts                       view             [B,k] -> [k]
  model.layers.N.mixer.experts                       sort             [k] -> [k]*[k]
  model.layers.N.mixer.experts                       floor_divide     [k] -> [k]
  model.layers.N.mixer.experts                       index            [B,d_inner/n_g]*[k] -> [k,d_inner/n_g]
  model.layers.N.mixer.experts                       index            [k]*[k] -> [k]
  model.layers.N.mixer.experts                       _to_copy         [k] -> [k]
  model.layers.N.mixer.experts                       histc            [k] -> [E]
  model.layers.N.mixer.experts                       cumsum           [E] -> [E]
  ...
  model.layers.N.mixer.experts                       arange           [] -> [k]
  model.layers.N.mixer.experts                       index_put_       [k]*[k]*[k] -> [k]
  model.layers.N.mixer.experts                       index            [k,d_inner/n_g]*[k] -> [k,d_inner/n_g]
  model.layers.N.mixer.experts                       view             [k,d_inner/n_g] -> [B,k,d_inner/n_g]
  model.layers.N.mixer.experts                       sum              [B,k,d_inner/n_g] -> [B,d_inner/n_g]
  model.layers.N.mixer.experts                       _to_copy         [B,d_inner/n_g] -> [B,d_inner/n_g]
  model.layers.N.mixer.fc2_latent_proj               t                [d_model,d_inner/n_g] -> w=[d_model,d_inner/n_g] [d_inner/n_g,d_model]
  model.layers.N.mixer.fc2_latent_proj               matmul           [B,d_inner/n_g]*[d_inner/n_g,d_model] -> w=[d_model,d_inner/n_g] [B,d_model]
  model.layers.N.mixer.shared_experts.up_proj        t                [d_shared,d_model] -> w=[d_shared,d_model] [d_model,d_shared]
  model.layers.N.mixer.shared_experts.up_proj        view             [B,1,d_model] -> [B,d_model]
  model.layers.N.mixer.shared_experts.up_proj        matmul           [B,d_model]*[d_model,d_shared] -> w=[d_shared,d_model] [B,d_shared]
  model.layers.N.mixer.shared_experts.up_proj        _unsafe_view     [B,d_shared] -> [B,1,d_shared]
  ...
  model.layers.93                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.94                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.95                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.96                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.97                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.98                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.99                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.100                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.101                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.102                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.103                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.104                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.105                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.106                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.107                                   elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.norm_f                                       _to_copy         [B,1,d_model] -> [B,1,d_model]
  model.norm_f                                       pow              [B,1,d_model] -> [B,1,d_model]
  model.norm_f                                       mean             [B,1,d_model] -> [B,1,1]
  model.norm_f                                       elementwise_add  [B,1,1] -> [B,1,1]
...
# ============================================================
# 모델: tiiuae__Falcon-H1-7B-Instruct
# ============================================================
...
| tie embeddings | False |
| decode 방식 | autoregressive, 1 token/step, reuses KV cache (prefill builds it) |
| KV cache 크기 | 2·n_kv·d_head = 2·2·128 = 512 elems / token / layer; 44 attention layer(s) ⇒ 22528 / token |
...
| 이름 없음 (정수 유지) | 6,424 | 2.68% |
| 같은 shape에서 이미 쓴 심볼 재사용 | 1,858 | 0.77% |

등록된 규칙 **231,592축**, 약한 근거 1,858축, 휴리스틱 **0축 (0.0%)**, 이름 없음 6,424축.
...
```
  ...
  model.layers.N.mamba                               transpose        [B,n_h_ssm,2,2] -> [B,2,2,n_h_ssm]
...
```
  ...
  model.layers.0                                     elementwise_mul  [B,d_model] -> [B,d_model]
  ...
  model.layers.0                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.0                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  ...
  model.layers.1                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.1                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.1                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.1                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.2                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.2                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.2                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.2                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.3                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.3                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.3                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.3                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.4                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.4                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.4                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.4                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.5                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.5                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.5                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.5                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.6                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.6                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.6                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.6                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.7                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.7                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.7                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.7                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.8                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.8                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.8                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.8                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.9                                     elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.9                                     elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.9                                     elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.9                                     elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.10                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.10                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.10                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.10                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.11                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.11                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.11                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.11                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.12                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.12                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.12                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.12                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.13                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.13                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.13                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.13                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.14                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.14                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.14                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.14                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.15                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.15                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.15                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.15                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.16                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.16                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.16                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.16                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.17                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.17                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.17                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.17                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.18                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.18                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.18                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.18                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.19                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.19                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.19                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.19                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.20                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.20                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.20                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.20                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.21                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.21                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.21                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.21                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.22                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.22                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.22                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.22                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.23                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.23                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.23                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.23                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.24                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.24                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.24                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.24                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.25                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.25                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.25                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.25                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.26                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.26                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.26                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.26                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.27                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.27                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.27                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.27                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.28                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.28                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.28                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.28                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.29                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.29                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.29                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.29                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.30                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.30                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.30                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.30                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.31                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.31                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.31                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.31                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.32                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.32                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.32                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.32                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.33                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.33                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.33                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.33                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.34                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.34                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.34                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.34                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.35                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.35                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.35                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.35                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.36                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.36                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.36                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.36                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.37                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.37                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.37                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.37                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.38                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.38                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.38                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.38                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.39                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.39                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.39                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.39                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.40                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.40                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.40                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.40                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.41                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.41                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.41                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.41                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.42                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.42                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.42                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.42                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.43                                    elementwise_mul  [B,d_model] -> [B,d_model]
  model.layers.43                                    elementwise_mul  [B,1,d_model] -> [B,1,d_model]
  model.layers.43                                    elementwise_add  [B,d_model]*[B,1,d_model] -> [B,1,d_model]
  model.layers.43                                    elementwise_add  [B,1,d_model]*[B,1,d_model] -> [B,1,d_model]
