...
| `tie` | `model.layers.*.mixer` | 128 | `d_state` | `d_chunk`, `d_state`, `n_h_ssm` | 2 | `[B, 1, d_state, n_h_ssm, d_chunk]` | 80 |
...
| `d_state` | 128 | `model.layers.*.mixer` | 11200 |
...
| `d_chunk` | 128 | `model.layers.*.mixer` | 3840 |
