...
- `2*d_state` in `model.layers.*.mixer (레이어 8개)` — heur_multiple, 48축
...
| `d_state` | 128 | `model.layers.*.mixer` | 14264 |
...
| `d_head` | 128 | `model.layers.*.mixer` | 80 |
| `2*d_state` |  | `model.layers.*.mixer` | 32 |
...
- `model.layers.*.mixer`
  ...
  - `[[B, 2, n_h_ssm/n_g_ssm, T+1, d_state]]`
  - `[[B, 2, n_h_ssm/n_g_ssm, T, d_state]]`
  ...
  - `[[B, d_state, 1, n_h_ssm]]`
  - `[[B, d_state, 1, n_kv, d_head_ssm, n_h_ssm]]`
  - `[[B, d_state, 1]]`
  ...
  - `[[B, d_state, n_h_ssm]]`
  - `[[B, d_state, n_kv, 1]]`
  - `[[B, d_state, n_kv, d_head_ssm, n_h_ssm]]`
  - `[[B, d_state, n_kv, n_kv, 1, 1]]`
  - `[[B, d_state, n_kv, n_kv, 1]]`
  - `[[B, d_state, n_kv, n_kv, d_head_ssm, n_h_ssm]]`
  - `[[B, d_state, n_kv, n_kv]]`
  - `[[B, d_state, n_kv]]`
  - `[[B, d_state]]`
  - `[[B, n_g_ssm, 1, d_state]]`
