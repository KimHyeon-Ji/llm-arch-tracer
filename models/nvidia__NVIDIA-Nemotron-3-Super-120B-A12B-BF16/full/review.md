...
```
  ...
  model.layers.N.mixer                               constant_pad_nd  [B,T,d_state,d_head_ssm] -> [B,d_chunk,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               elementwise_mul  [B,T,d_state,d_head_ssm]*[B,T,n_h_ssm,1] -> [B,T,d_state,d_head_ssm]
