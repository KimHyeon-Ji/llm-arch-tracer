...
```
  ...
  model.layers.N.mixer                               sum              [B,1,d_chunk,n_h_ssm,d_chunk,d_head] -> [B,1,d_chunk,d_chunk,n_h_ssm]
  ...
  model.layers.N.mixer                               sum              [B,1,d_chunk,d_chunk,n_h_ssm,1] -> [B,1,d_chunk,n_h_ssm,d_chunk]
...
```
  ...
  model.layers.N.mixer                               expand           [n_h_ssm,1,1] -> [n_h_ssm,d_head_ssm,n_h_ssm]
  model.layers.N.mixer                               unsqueeze        [B,d_state,d_head_ssm] -> [B,d_state,d_head_ssm,1]
  model.layers.N.mixer                               elementwise_mul  [B,d_state,d_head_ssm,1]*[n_h_ssm,d_head_ssm,n_h_ssm] -> [B,n_h_ssm,d_head_ssm,d_state]
