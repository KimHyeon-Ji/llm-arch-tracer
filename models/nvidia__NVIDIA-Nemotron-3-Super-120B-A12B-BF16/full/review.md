...
등록된 규칙 **185,821축**, 약한 근거 3,978축, 휴리스틱 **48축 (0.02%)**, 이름 없음 3,240축.

지어낸 이름이 가장 많이 붙은 자리 (여기부터 확인하면 된다):

| 모듈 | 라벨 | 규칙 | 축 수 |
|---|---|---|---:|
| `model.layers.7.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.16.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.25.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.36.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.47.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.58.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.69.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
| `model.layers.78.mixer` | `2*d_head` | 휴리스틱: 심볼의 배수 | 6 |
...
```
  ...
  model.layers.N.mixer                               split_with_sizes [B,T,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,T,0]*[B,T,0]*[B,T,d_inner]*[B,T,d_inner+2*n_g*d_state]*[B,T,d_head]
  ...
  model.layers.N.mixer                               _to_copy         [d_head] -> [d_head]
  model.layers.N.mixer                               exp              [d_head] -> [d_head]
  model.layers.N.mixer                               neg              [d_head] -> [d_head]
  model.layers.N.mixer                               elementwise_add  [B,T,d_head]*[d_head] -> [B,T,d_head]
  model.layers.N.mixer                               softplus         [B,T,d_head] -> [B,T,d_head]
  model.layers.N.mixer                               clamp            [B,T,d_head] -> [B,T,d_head]
  model.layers.N.mixer                               view             [B,T,d_inner] -> [B,T,d_head,d_head_ssm]
  model.layers.N.mixer                               _to_copy         [B,T,d_head,d_head_ssm] -> [B,T,d_head,d_head_ssm]
  ...
  model.layers.N.mixer                               view             [B,T,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,T,d_head,d_state]
  model.layers.N.mixer                               unsqueeze        [d_head] -> [d_head,B]
  model.layers.N.mixer                               constant_pad_nd  [B,T,d_head,d_head_ssm] -> [B,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [d_head,B]*[B,d_head,d_state,d_head_ssm] -> [B,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               unsqueeze        [B,T,d_head] -> [B,T,d_head,1]
  model.layers.N.mixer                               elementwise_mul  [B,T,d_head,d_head_ssm]*[B,T,d_head,1] -> [B,T,d_head,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [d_head]*[B,T,d_head] -> [B,T,d_head]
  model.layers.N.mixer                               view             [B,d_head,d_state,d_head_ssm] -> [B,1,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               constant_pad_nd  [B,T,d_head] -> [B,d_head,d_state]
  model.layers.N.mixer                               view             [B,d_head,d_state] -> [B,1,d_head,d_state]
  model.layers.N.mixer                               constant_pad_nd  [B,T,d_head,d_state] -> [B,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               view             [B,d_head,d_state,n_h_ssm] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,1,d_head,d_state] -> [B,d_head,1,d_state]
  model.layers.N.mixer                               cumsum           [B,d_head,1,d_state] -> [B,d_head,1,d_state]
  model.layers.N.mixer                               unsqueeze        [B,d_head,1,d_state] -> [B,d_head,1,d_state,1]
  model.layers.N.mixer                               expand           [B,d_head,1,d_state,1] -> [B,d_head,1,d_state,n_h_ssm]
  ...
  model.layers.N.mixer                               masked_fill      [B,d_head,1,d_state,n_h_ssm]*[d_head,d_state] -> [B,d_head,1,d_state,n_h_ssm]
  model.layers.N.mixer                               cumsum           [B,d_head,1,d_state,n_h_ssm] -> [B,d_head,1,d_state,n_h_ssm]
  model.layers.N.mixer                               exp              [B,d_head,1,d_state,n_h_ssm] -> [B,d_head,1,d_state,n_h_ssm]
  model.layers.N.mixer                               unsqueeze        [B,1,d_head,d_state,n_h_ssm] -> [B,1,d_head,1,d_state,n_h_ssm]
  model.layers.N.mixer                               unsqueeze        [B,1,d_head,d_state,n_h_ssm] -> [B,1,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,1,d_head,1,d_state,n_h_ssm]*[B,1,1,d_head,d_state,n_h_ssm] -> [B,1,d_head,d_state,n_h_ssm,d_chunk]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,n_h_ssm,d_chunk] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,d_head,1,d_state,n_h_ssm] -> [B,1,d_head,d_state,n_h_ssm]
  ...
  model.layers.N.mixer                               elementwise_mul  [B,1,d_head,d_state,n_h_ssm,1]*[B,1,1,d_head,d_state,d_head_ssm] -> [B,1,d_head,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,n_h_ssm,d_head_ssm] -> [B,1,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               slice            [B,d_head,1,d_state] -> [B,d_head,1,1]
  model.layers.N.mixer                               sub              [B,d_head,1,1]*[B,d_head,1,d_state] -> [B,d_head,1,d_state]
  model.layers.N.mixer                               exp              [B,d_head,1,d_state] -> [B,d_head,1,d_state]
  model.layers.N.mixer                               permute          [B,d_head,1,d_state] -> [B,1,d_head,d_state]
  model.layers.N.mixer                               permute          [B,1,d_head,d_state,n_h_ssm] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,1,d_head,d_state,d_head_ssm] -> [B,1,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               permute          [B,1,d_head,d_state,d_head_ssm] -> [B,1,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               alias            [B,1,d_head,d_head_ssm,d_state] -> [B,1,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               zeros_like       [B,1,d_head,d_head_ssm,d_state] -> [B,1,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               concat           [B,1,d_head,d_head_ssm,d_state]*[B,1,d_head,d_head_ssm,d_state] -> [B,2,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               select           [B,d_head,1,d_state] -> [B,d_head,1]
  model.layers.N.mixer                               constant_pad_nd  [B,d_head,1] -> [B,d_head,n_kv]
  model.layers.N.mixer                               expand           [B,d_head,n_kv,1] -> [B,d_head,n_kv,n_kv]
  model.layers.N.mixer                               ones             [] -> [2,2]
  model.layers.N.mixer                               tril             [2,2] -> [2,2]
  model.layers.N.mixer                               bitwise_not      [2,2] -> [2,2]
  model.layers.N.mixer                               masked_fill      [B,d_head,n_kv,n_kv]*[2,2] -> [B,d_head,n_kv,n_kv]
  model.layers.N.mixer                               cumsum           [B,d_head,n_kv,n_kv] -> [B,d_head,n_kv,n_kv]
  model.layers.N.mixer                               exp              [B,d_head,n_kv,n_kv] -> [B,d_head,n_kv,n_kv]
  model.layers.N.mixer                               sum              [B,d_head,n_kv,n_kv,d_head_ssm,d_state] -> [B,d_head,n_kv,d_head_ssm,d_state]
  model.layers.N.mixer                               slice            [B,2,d_head,d_head_ssm,d_state] -> [B,1,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               select           [B,2,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,d_head_ssm,n_h_ssm] -> [B,1,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,1,d_head,d_state,d_head_ssm]*[B,1,d_head,d_state,d_head_ssm] -> [B,1,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,d_head,d_state,d_head_ssm]*[B,d_head,d_state,d_head_ssm] -> [B,d_head,d_state,d_head_ssm]
  model.layers.N.mixer                               slice            [B,d_head,d_state,d_head_ssm] -> [B,T,d_head,d_head_ssm]
  model.layers.N.mixer                               zeros_like       [B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               copy_            [B,d_head,d_head_ssm,d_state]*[B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  ...
  model.layers.N.mixer.k_proj                        t                [n_kv*d_head,n_h*d_head] -> w=[n_kv*d_head,n_h*d_head] [d_model,n_kv*d_head]
  model.layers.N.mixer.k_proj                        view             [B,T,d_model] -> [T,d_model]
  model.layers.N.mixer.k_proj                        matmul           [T,d_model]*[d_model,n_kv*d_head] -> w=[n_kv*d_head,n_h*d_head] [T,n_kv*d_head]
  ...
  model.layers.N.mixer.v_proj                        t                [n_kv*d_head,n_h*d_head] -> w=[n_kv*d_head,n_h*d_head] [d_model,n_kv*d_head]
  model.layers.N.mixer.v_proj                        view             [B,T,d_model] -> [T,d_model]
  model.layers.N.mixer.v_proj                        matmul           [T,d_model]*[d_model,n_kv*d_head] -> w=[n_kv*d_head,n_h*d_head] [T,n_kv*d_head]
...
```
  ...
  model.layers.N.mixer                               split_with_sizes [B,1,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,1,0]*[B,1,0]*[B,1,d_inner]*[B,1,d_inner+2*n_g*d_state]*[B,1,d_head]
  ...
  model.layers.N.mixer                               exp              [d_head] -> [d_head]
  model.layers.N.mixer                               neg              [d_head] -> [d_head]
  model.layers.N.mixer                               select           [B,1,d_head] -> [B,d_head]
  model.layers.N.mixer                               unsqueeze        [B,d_head] -> [B,1,d_head]
  model.layers.N.mixer                               transpose        [B,1,d_head] -> [B,d_head,1]
  model.layers.N.mixer                               expand           [B,d_head,1] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               unsqueeze        [d_head] -> [d_head,B]
  model.layers.N.mixer                               expand           [d_head,B] -> [d_head,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,d_head,d_head_ssm]*[d_head,d_head_ssm] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               softplus         [B,d_head,d_head_ssm] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               clamp            [B,d_head,d_head_ssm] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               unsqueeze        [d_head,B] -> [d_head,B,1]
  model.layers.N.mixer                               expand           [d_head,B,1] -> [d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               unsqueeze        [B,d_head,d_head_ssm] -> [B,d_head,d_head_ssm,1]
  model.layers.N.mixer                               elementwise_mul  [B,d_head,d_head_ssm,1]*[d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               exp              [B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  ...
  model.layers.N.mixer                               view             [B,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,d_head,d_state]
  model.layers.N.mixer                               elementwise_mul  [B,d_head,d_head_ssm,1]*[B,d_head,1,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               view             [B,1,d_inner] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,d_head,d_head_ssm,d_state]*[B,d_head,d_head_ssm,1] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               clone            [B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               elementwise_mul  [B,d_head,d_head_ssm,d_state]*[B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               elementwise_add  [B,d_head,d_head_ssm,d_state]*[B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               copy_            [B,d_head,d_head_ssm,d_state]*[B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               _to_copy         [B,d_head,d_head_ssm,d_state] -> [B,d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               view             [B,d_head,d_head_ssm,d_state] -> [d_head,d_head_ssm,d_state]
  model.layers.N.mixer                               view             [B,d_head,d_state] -> [d_head,d_state,B]
  model.layers.N.mixer                               batched_matmul   [d_head,d_head_ssm,d_state]*[d_head,d_state,B] -> [d_head,d_head_ssm,B]
  model.layers.N.mixer                               view             [d_head,d_head_ssm,B] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,d_head,d_head_ssm]*[d_head,d_head_ssm] -> [B,d_head,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,d_head,d_head_ssm]*[B,d_head,d_head_ssm] -> [B,d_head,d_head_ssm]
  ...
  model.layers.N.mixer.k_proj                        matmul           [B,d_model]*[d_model,n_kv*d_head] -> w=[n_kv*d_head,n_h*d_head] [B,n_kv*d_head]
  ...
  model.layers.N.mixer.v_proj                        matmul           [B,d_model]*[d_model,n_kv*d_head] -> w=[n_kv*d_head,n_h*d_head] [B,n_kv*d_head]
