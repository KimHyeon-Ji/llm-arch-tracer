...
```
  ...
  model.layers.N.mamba                               expand           [B,T,1,1,d_state] -> [B,T,1,d_state,d_state]
  model.layers.N.mamba                               clone            [B,T,1,d_state,d_state] -> [B,T,1,d_state,d_state]
  model.layers.N.mamba                               view             [B,T,1,d_state,d_state] -> [B,T,d_state,d_state]
  ...
  model.layers.N.mamba                               constant_pad_nd  [B,T,d_state,d_state] -> [B,d_chunk,n_h_ssm,d_state]
  model.layers.N.mamba                               view             [B,d_chunk,n_h_ssm,d_state] -> [B,1,d_chunk,n_h_ssm,d_state]
  model.layers.N.mamba                               constant_pad_nd  [B,T,d_state,d_state] -> [B,d_chunk,d_state,n_h_ssm]
...
```
  ...
  model.layers.N.mamba                               exp              [n_h_ssm] -> [n_h_ssm]
  model.layers.N.mamba                               neg              [n_h_ssm] -> [n_h_ssm]
  model.layers.N.mamba                               select           [B,1,d_state] -> [B,n_h_ssm]
  ...
  model.layers.N.mamba                               expand           [n_h_ssm,1,1] -> [n_h_ssm,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               unsqueeze        [B,n_h_ssm,d_head_ssm] -> [B,n_h_ssm,d_head_ssm,1]
  model.layers.N.mamba                               elementwise_mul  [B,n_h_ssm,d_head_ssm,1]*[n_h_ssm,d_head_ssm,n_h_ssm] -> [B,n_h_ssm,d_head_ssm,d_state]
