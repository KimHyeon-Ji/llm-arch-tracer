...
| prefill | `model.layers.*.mlp.shared_mlp.gate_proj` | matmul | `[['T', 'd_model'], ['d_model', 'd_moe']]` | `['d_moe', 'd_model']` | `[['T', '3072']]` |
| prefill | `model.layers.*.mlp.shared_mlp.act_fn` | silu | `[['B', 'T', '3072']]` | `None` | `[['B', 'T', '3072']]` |
| prefill | `model.layers.*.mlp.shared_mlp.up_proj` | matmul | `[['T', 'd_model'], ['d_model', 'd_moe']]` | `['d_moe', 'd_model']` | `[['T', '3072']]` |
...
| decode | `model.layers.*.mlp.shared_mlp.gate_proj` | matmul | `[['B', 'd_model'], ['d_model', 'd_moe']]` | `['d_moe', 'd_model']` | `[['B', '3072']]` |
| decode | `model.layers.*.mlp.shared_mlp.act_fn` | silu | `[['B', '1', '3072']]` | `None` | `[['B', '1', '3072']]` |
| decode | `model.layers.*.mlp.shared_mlp.up_proj` | matmul | `[['B', 'd_model'], ['d_model', 'd_moe']]` | `['d_moe', 'd_model']` | `[['B', '3072']]` |
