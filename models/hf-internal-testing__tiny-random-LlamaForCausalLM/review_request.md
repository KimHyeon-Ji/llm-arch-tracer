...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3/4 | `[B, n_h, T, d_head]  (축 3)` | 124 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1/4 | `[B, n_h, 1, d_head]  (축 1)` | 124 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 0/3 | `[B, n_h, T, T]  (축 1)` | 32 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 2/3 | `[B, 1, T, d_head]  (축 3)` | 22 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 2/4 | `[B, T, n_h, d_head]  (축 2)` | 20 |
