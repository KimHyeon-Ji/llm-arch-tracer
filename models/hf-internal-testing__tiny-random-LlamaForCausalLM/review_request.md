# 검토 의뢰서 — hf-internal-testing/tiny-random-LlamaForCausalLM
...
- `d_head vs n_h vs n_kv` in `model.layers.*.self_attn` — 값 4 를 두고 후보가 3개, 372축
...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3 | `[B, n_h, T, d_head]` | 104 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head]` | 80 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3 | `[B, n_h, 1, d_head]` | 80 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head]` | 64 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head/2]` | 24 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 0 | `[n_h, T, T]` | 24 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head/2]` | 24 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3 | `[B, n_h, T+1, d_head]` | 24 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 2 | `[B, T, d_head]` | 22 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 2 | `[B, 1, d_head]` | 22 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 2 | `[B, T, n_h, d_head]` | 20 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3 | `[B, T, n_h, d_head]` | 20 |
...
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 2 | `[B, 1, n_h, d_head]` | 16 |
| `tie` | `model.layers.*.self_attn` | 4 | `d_head` | `d_head`, `n_h`, `n_kv` | 3 | `[B, 1, n_h, d_head]` | 16 |
| `tie` | `model.layers.*.self_attn` | 4 | `n_h` | `d_head`, `n_h`, `n_kv` | 1 | `[B, n_h, T+1, d_head]` | 16 |
...
| `n_h` | 4 | `model.layers.*.self_attn` | 340 |
...
### C. 모듈이 내는 출력 shape 전부 (19개 모듈 / 113종)
