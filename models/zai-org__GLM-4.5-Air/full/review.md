...
```
  ...
  model.layers.N.self_attn                           unsqueeze        [B,T,d_head-d_rope] -> [B,B,T,d_head-d_rope]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,T,d_head-d_rope]*[B,B,T,d_head-d_rope] -> [B,n_h,T,d_head-d_rope]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,T,d_head-d_rope]*[B,B,T,d_head-d_rope] -> [B,n_kv,T,d_head-d_rope]
  ...
  model.layers.N.mlp.gate                            view             [T,E] -> [T,B,E]
  model.layers.N.mlp.gate                            topk             [T,B,E] -> [T,B,2]*[T,B,2]
  model.layers.N.mlp.gate                            sum              [T,B,2] -> [T,B]
  model.layers.N.mlp.gate                            topk             [T,B] -> [T,B]*[T,B]
  model.layers.N.mlp.gate                            zeros_like       [T,B] -> [T,B]
  model.layers.N.mlp.gate                            scatter_         [T,B]*[T,B] -> [T,B]
  model.layers.N.mlp.gate                            unsqueeze        [T,B] -> [T,B,B]
  model.layers.N.mlp.gate                            expand           [T,B,B] -> [T,B,E]
  model.layers.N.mlp.gate                            view             [T,B,E] -> [T,E]
...
```
  ...
  model.rotary_emb                                   concat           [B,B,d_rope/2]*[B,B,d_rope/2] -> [B,B,d_head-d_rope]
  model.rotary_emb                                   cos              [B,B,d_head-d_rope] -> [B,B,d_head-d_rope]
  model.rotary_emb                                   elementwise_mul  [B,B,d_head-d_rope] -> [B,B,d_head-d_rope]
  model.rotary_emb                                   sin              [B,B,d_head-d_rope] -> [B,B,d_head-d_rope]
  model.rotary_emb                                   _to_copy         [B,B,d_head-d_rope] -> [B,B,d_head-d_rope]
  ...
  model.layers.N.self_attn.q_proj                    view             [B,n_h*d_head] -> [B,B,n_h*d_head]
  ...
  model.layers.N.self_attn.k_proj                    view             [B,n_kv*d_head] -> [B,B,n_kv*d_head]
  ...
  model.layers.N.self_attn.v_proj                    view             [B,n_kv*d_head] -> [B,B,n_kv*d_head]
  ...
  model.layers.N.self_attn                           unsqueeze        [B,B,d_head-d_rope] -> [B,B,B,d_head-d_rope]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,B,d_head-d_rope]*[B,B,B,d_head-d_rope] -> [B,n_h,B,d_head-d_rope]
  model.layers.N.self_attn                           slice            [B,n_h,B,d_head-d_rope] -> [B,n_h,B,d_rope/2]
  model.layers.N.self_attn                           neg              [B,n_h,B,d_rope/2] -> [B,n_h,B,d_rope/2]
  model.layers.N.self_attn                           concat           [B,n_h,B,d_rope/2]*[B,n_h,B,d_rope/2] -> [B,n_h,B,d_head-d_rope]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,d_head-d_rope]*[B,n_h,B,d_head-d_rope] -> [B,n_h,B,d_head-d_rope]
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,B,d_head-d_rope]*[B,B,B,d_head-d_rope] -> [B,n_kv,B,d_head-d_rope]
  model.layers.N.self_attn                           slice            [B,n_kv,B,d_head-d_rope] -> [B,n_kv,B,d_rope/2]
  model.layers.N.self_attn                           neg              [B,n_kv,B,d_rope/2] -> [B,n_kv,B,d_rope/2]
  model.layers.N.self_attn                           concat           [B,n_kv,B,d_rope/2]*[B,n_kv,B,d_rope/2] -> [B,n_kv,B,d_head-d_rope]
  model.layers.N.self_attn                           elementwise_add  [B,n_kv,B,d_head-d_rope]*[B,n_kv,B,d_head-d_rope] -> [B,n_kv,B,d_head-d_rope]
  model.layers.N.self_attn                           concat           [B,n_h,B,d_head-d_rope]*[B,n_h,B,d_head-d_rope] -> [B,n_h,B,d_head]
  model.layers.N.self_attn                           concat           [B,n_kv,B,d_head-d_rope]*[B,n_kv,B,d_head-d_rope] -> [B,n_kv,B,d_head]
  ...
  model.layers.N.mlp.gate                            view             [B,E] -> [B,B,E]
  model.layers.N.mlp.gate                            topk             [B,B,E] -> [B,B,2]*[B,B,2]
  model.layers.N.mlp.gate                            sum              [B,B,2] -> [B,B]
  model.layers.N.mlp.gate                            topk             [B,B] -> [B,B]*[B,B]
  model.layers.N.mlp.gate                            zeros_like       [B,B] -> [B,B]
  model.layers.N.mlp.gate                            scatter_         [B,B]*[B,B] -> [B,B]
  model.layers.N.mlp.gate                            unsqueeze        [B,B] -> [B,B,B]
  model.layers.N.mlp.gate                            expand           [B,B,B] -> [B,B,E]
  model.layers.N.mlp.gate                            view             [B,B,E] -> [B,E]
