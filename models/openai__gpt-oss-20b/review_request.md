...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1/4 | `[B, n_h, T, d_head/2]  (축 1)` | 1440 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3/4 | `[B, n_kv, T, d_head]  (축 3)` | 960 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 4/5 | `[B, n_kv, n_h/n_kv, T, d_head]  (축 4)` | 480 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0/3 | `[B, n_h, T, T]  (축 1)` | 288 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 2/4 | `[B, T, n_h, d_head]  (축 2)` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0/1 | `[n_h]  (축 0)` | 24 |
