...
```
  ...
  model.layers.N.self_attn                           unsqueeze        [B,T,d_head/2] -> [B,B,T,d_head/2]
  model.layers.N.self_attn                           split            [B,n_h,T,d_head] -> [B,n_h,T,d_head/2]*[B,n_h,T,d_head/2]
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,T,d_head/2]*[B,B,T,d_head/2] -> [B,n_h,T,d_head/2]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,T,d_head/2]*[B,B,T,d_head/2] -> [B,n_kv,T,d_head/2]
  ...
  model.layers.N.self_attn                           view             [n_h] -> [B,n_h,B,B]
  model.layers.N.self_attn                           expand           [B,n_h,B,B] -> [B,n_h,T,B]
  model.layers.N.self_attn                           concat           [B,n_h,T,T]*[B,n_h,T,B] -> [B,n_h,T,T+1]
  model.layers.N.self_attn                           max              [B,n_h,T,T+1] -> [B,n_h,T,B]*[B,n_h,T,B]
  model.layers.N.self_attn                           sub              [B,n_h,T,T+1]*[B,n_h,T,B] -> [B,n_h,T,T+1]
...
```
  ...
  model                                              unsqueeze        [B,T+1] -> [B,B,T+1]
  model                                              unsqueeze        [B,B,T+1] -> [B,B,B,T+1]
  model                                              le               [B,B,B,T+1]*[B,B,B,B] -> [B,B,B,T+1]
  model                                              expand           [B,B,B,T+1] -> [B,B,B,T+1]
  model                                              scalar_tensor    [] -> []
  model                                              where            [B,B,B,T+1]*[]*[] -> [B,B,B,T+1]
  ...
  model                                              where            [B,B,B,w_local]*[]*[] -> [B,B,B,w_local]
  model.rotary_emb                                   unsqueeze        [d_head/2] -> [B,d_head/2]
  model.rotary_emb                                   unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  model.rotary_emb                                   expand           [B,d_head/2,B] -> [B,d_head/2,B]
  ...
  model.rotary_emb                                   cos              [B,B,d_head/2] -> [B,B,d_head/2]
  model.rotary_emb                                   elementwise_mul  [B,B,d_head/2] -> [B,B,d_head/2]
  model.rotary_emb                                   sin              [B,B,d_head/2] -> [B,B,d_head/2]
  model.rotary_emb                                   _to_copy         [B,B,d_head/2] -> [B,B,d_head/2]
  ...
  model.layers.N.self_attn                           split            [B,n_h,B,d_head] -> [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2]
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,B,d_head/2]*[B,B,B,d_head/2] -> [B,n_h,B,d_head/2]
  model.layers.N.self_attn                           sub              [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2] -> [B,n_h,B,d_head/2]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2] -> [B,n_h,B,d_head/2]
  model.layers.N.self_attn                           concat           [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2] -> [B,n_h,B,d_head]
  model.layers.N.self_attn                           split            [B,n_kv,B,d_head] -> [B,n_kv,B,d_head/2]*[B,n_kv,B,d_head/2]
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,B,d_head/2]*[B,B,B,d_head/2] -> [B,n_kv,B,d_head/2]
  model.layers.N.self_attn                           sub              [B,n_kv,B,d_head/2]*[B,n_kv,B,d_head/2] -> [B,n_kv,B,d_head/2]
  model.layers.N.self_attn                           elementwise_add  [B,n_kv,B,d_head/2]*[B,n_kv,B,d_head/2] -> [B,n_kv,B,d_head/2]
  model.layers.N.self_attn                           concat           [B,n_kv,B,d_head/2]*[B,n_kv,B,d_head/2] -> [B,n_kv,B,d_head]
  model.layers.N.self_attn                           concat           [B,n_kv,w_local-1,d_head]*[B,n_kv,B,d_head] -> [B,n_kv,w_local,d_head]
  model.layers.N.self_attn                           slice            [B,n_kv,w_local,d_head] -> [B,n_kv,w_local-1,d_head]
  model.layers.N.self_attn                           unsqueeze        [B,n_kv,w_local,d_head] -> [B,n_kv,B,w_local,d_head]
  model.layers.N.self_attn                           expand           [B,n_kv,B,w_local,d_head] -> [B,n_kv,n_h/n_kv,w_local,d_head]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,w_local]*[B,B,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           view             [n_h] -> [B,n_h,B,B]
  model.layers.N.self_attn                           expand           [B,n_h,B,B] -> [B,n_h,B,B]
  model.layers.N.self_attn                           concat           [B,n_h,B,w_local]*[B,n_h,B,B] -> [B,n_h,B,w_local+n_sink]
  model.layers.N.self_attn                           max              [B,n_h,B,w_local+n_sink] -> [B,n_h,B,B]*[B,n_h,B,B]
  model.layers.N.self_attn                           sub              [B,n_h,B,w_local+n_sink]*[B,n_h,B,B] -> [B,n_h,B,w_local+n_sink]
  model.layers.N.self_attn                           softmax          [B,n_h,B,w_local+n_sink] -> [B,n_h,B,w_local+n_sink]
  model.layers.N.self_attn                           slice            [B,n_h,B,w_local+n_sink] -> [B,n_h,B,w_local]
  ...
  model.layers.N.self_attn.o_proj                    view             [B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,T+1]*[B,B,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.self_attn                           concat           [B,n_h,B,T+1]*[B,n_h,B,B] -> [B,n_h,B,(T+1)+n_sink]
  model.layers.N.self_attn                           max              [B,n_h,B,(T+1)+n_sink] -> [B,n_h,B,B]*[B,n_h,B,B]
  model.layers.N.self_attn                           sub              [B,n_h,B,(T+1)+n_sink]*[B,n_h,B,B] -> [B,n_h,B,(T+1)+n_sink]
  model.layers.N.self_attn                           softmax          [B,n_h,B,(T+1)+n_sink] -> [B,n_h,B,(T+1)+n_sink]
  model.layers.N.self_attn                           slice            [B,n_h,B,(T+1)+n_sink] -> [B,n_h,B,T+1]
