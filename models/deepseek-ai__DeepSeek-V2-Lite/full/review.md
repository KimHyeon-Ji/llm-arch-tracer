...
```
  ...
  model.layers.N.self_attn                           view             [B,n_h,T,d_head] -> [B,n_h,T,d_rope/2,2]
  ...
  model.layers.N.self_attn                           view             [B,1,T,d_head] -> [B,1,T,d_rope/2,2]
  ...
  model.layers.N.self_attn                           view             [B,n_h,T,d_rope/2,2] -> [B,n_h,T,d_head]
...
```
  ...
  model.layers.N.self_attn                           view             [B,n_h,1,d_head] -> [B,n_h,1,d_rope/2,2]
  ...
  model.layers.N.self_attn                           view             [B,n_h,1,d_rope/2,2] -> [B,n_h,1,d_head]
