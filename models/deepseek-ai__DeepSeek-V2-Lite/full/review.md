...
```
  ...
  model.layers.N.self_attn.q_proj                    t                [(n_h+2*n_kv)*d_head,n_h*d_v] -> w=[(n_h+2*n_kv)*d_head,n_h*d_v] [n_h*d_v,(n_h+2*n_kv)*d_head]
  model.layers.N.self_attn.q_proj                    view             [B,T,d_model] -> [T,d_model]
  model.layers.N.self_attn.q_proj                    matmul           [T,d_model]*[n_h*d_v,(n_h+2*n_kv)*d_head] -> w=[(n_h+2*n_kv)*d_head,n_h*d_v] [T,n_h*(d_nope+d_rope)]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [T,n_h*(d_nope+d_rope)] -> [B,T,(n_h+2*n_kv)*d_head]
  ...
  model.layers.N.self_attn.kv_a_proj_with_mqa        t                [c_kv+d_rope,n_h*d_v] -> w=[c_kv+d_rope,n_h*d_v] [n_h*d_v,c_kv+d_rope]
  model.layers.N.self_attn.kv_a_proj_with_mqa        view             [B,T,d_model] -> [T,d_model]
  model.layers.N.self_attn.kv_a_proj_with_mqa        matmul           [T,d_model]*[n_h*d_v,c_kv+d_rope] -> w=[c_kv+d_rope,n_h*d_v] [T,c_kv+d_rope]
  ...
  model.layers.N.self_attn                           view             [B,n_h,T,d_head] -> [B,n_h,T,d_rope/2,E_shared]
  model.layers.N.self_attn                           view_as_complex  [B,n_h,T,d_rope/2,E_shared] -> [B,n_h,T,d_rope/2]
  model.layers.N.self_attn                           _to_copy         [B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn                           view             [B,B,T,d_head] -> [B,B,T,d_rope/2,E_shared]
  model.layers.N.self_attn                           view_as_complex  [B,B,T,d_rope/2,E_shared] -> [B,B,T,d_rope/2]
  ...
  model.layers.N.self_attn                           view_as_real     [B,n_h,T,d_rope/2] -> [B,n_h,T,d_rope/2,E_shared]
  model.layers.N.self_attn                           view             [B,n_h,T,d_rope/2,E_shared] -> [B,n_h,T,d_head]
  model.layers.N.self_attn                           elementwise_mul  [B,B,T,d_rope/2]*[B,B,T,d_rope/2] -> [B,B,T,d_rope/2]
  model.layers.N.self_attn                           view_as_real     [B,B,T,d_rope/2] -> [B,B,T,d_rope/2,E_shared]
  ...
  model.layers.N.mlp.shared_experts.gate_proj        matmul           [T,d_model]*[d_model,2*d_moe] -> w=[2*d_moe,d_model] [T,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.gate_proj        _unsafe_view     [T,E_shared*d_moe] -> [B,T,2*d_moe]
  ...
  model.layers.N.mlp.shared_experts.up_proj          matmul           [T,d_model]*[d_model,2*d_moe] -> w=[2*d_moe,d_model] [T,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.up_proj          _unsafe_view     [T,E_shared*d_moe] -> [B,T,2*d_moe]
  ...
  model.layers.N.mlp.shared_experts.down_proj        view             [B,T,2*d_moe] -> [T,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.down_proj        matmul           [T,E_shared*d_moe]*[2*d_moe,d_model] -> w=[d_model,2*d_moe] [T,d_model]
...
```
  ...
  model.rotary_emb                                   ones_like        [B,B,d_rope/2] -> [B,B,d_rope/2]
  model.rotary_emb                                   polar            [B,B,d_rope/2]*[B,B,d_rope/2] -> [B,B,d_rope/2]
  model.rotary_emb                                   elementwise_mul  [B,B,d_rope/2] -> [B,B,d_rope/2]
  ...
  model.layers.N.self_attn.q_proj                    matmul           [B,d_model]*[n_h*d_v,(n_h+2*n_kv)*d_head] -> w=[(n_h+2*n_kv)*d_head,n_h*d_v] [B,n_h*(d_nope+d_rope)]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [B,n_h*(d_nope+d_rope)] -> [B,B,(n_h+2*n_kv)*d_head]
  ...
  model.layers.N.self_attn.kv_a_proj_with_mqa        matmul           [B,d_model]*[n_h*d_v,c_kv+d_rope] -> w=[c_kv+d_rope,n_h*d_v] [B,c_kv+d_rope]
  ...
  model.layers.N.self_attn                           view             [B,n_h,B,d_head] -> [B,n_h,B,d_rope/2,E_shared]
  model.layers.N.self_attn                           view_as_complex  [B,n_h,B,d_rope/2,E_shared] -> [B,n_h,B,d_rope/2]
  model.layers.N.self_attn                           _to_copy         [B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn                           view             [B,B,B,d_head] -> [B,B,B,d_rope/2,E_shared]
  model.layers.N.self_attn                           view_as_complex  [B,B,B,d_rope/2,E_shared] -> [B,B,B,d_rope/2]
  ...
  model.layers.N.self_attn                           view_as_real     [B,n_h,B,d_rope/2] -> [B,n_h,B,d_rope/2,E_shared]
  model.layers.N.self_attn                           view             [B,n_h,B,d_rope/2,E_shared] -> [B,n_h,B,d_head]
  model.layers.N.self_attn                           elementwise_mul  [B,B,B,d_rope/2]*[B,B,B,d_rope/2] -> [B,B,B,d_rope/2]
  model.layers.N.self_attn                           view_as_real     [B,B,B,d_rope/2] -> [B,B,B,d_rope/2,E_shared]
  ...
  model.layers.N.self_attn.o_proj                    _unsafe_view     [B,n_h*d_v] -> [B,B,n_h*d_v]
  ...
  model.layers.N.mlp.shared_experts.gate_proj        matmul           [B,d_model]*[d_model,2*d_moe] -> w=[2*d_moe,d_model] [B,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.gate_proj        _unsafe_view     [B,E_shared*d_moe] -> [B,B,2*d_moe]
  model.layers.N.mlp.shared_experts.act_fn           silu             [B,B,2*d_moe] -> [B,B,2*d_moe]
  model.layers.N.mlp.shared_experts.up_proj          t                [2*d_moe,d_model] -> w=[2*d_moe,d_model] [d_model,2*d_moe]
  model.layers.N.mlp.shared_experts.up_proj          view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mlp.shared_experts.up_proj          matmul           [B,d_model]*[d_model,2*d_moe] -> w=[2*d_moe,d_model] [B,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.up_proj          _unsafe_view     [B,E_shared*d_moe] -> [B,B,2*d_moe]
  model.layers.N.mlp.shared_experts                  elementwise_mul  [B,B,2*d_moe]*[B,B,2*d_moe] -> [B,B,2*d_moe]
  model.layers.N.mlp.shared_experts.down_proj        t                [d_model,2*d_moe] -> w=[d_model,2*d_moe] [2*d_moe,d_model]
  model.layers.N.mlp.shared_experts.down_proj        view             [B,B,2*d_moe] -> [B,E_shared*d_moe]
  model.layers.N.mlp.shared_experts.down_proj        matmul           [B,E_shared*d_moe]*[2*d_moe,d_model] -> w=[d_model,2*d_moe] [B,d_model]
