# 검토 의뢰서 — openai/gpt-oss-120b

파이썬 파이프라인이 규칙으로 결정할 수 있는 것을 전부 결정하고, **판단이 필요한 것만** 여기 남겼다. 절차와 출력 형식은 `review/` 에 있다.

- transformers 모듈: `gpt_oss`
- 판단 필요: **2건**

## 증거 — 이미 받아둔 실제 소스

- `develop/sources/modeling_gpt_oss.py` — 있음, 이 파일을 열어서 판정한다
- `develop/sources/configuration_gpt_oss.py` — 있음, 이 파일을 열어서 판정한다

- 온라인 원본: https://github.com/huggingface/transformers/tree/main/src/transformers/models/gpt_oss
...
- `d_head vs n_h` in `model.layers.*.self_attn` — 값 64 를 두고 후보가 2개, 5616축
...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 4 | `[B, n_kv, n_h/n_kv, T, d_head]` | 720 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, d_head/2]` | 648 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, d_head/2]` | 648 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, d_head]` | 576 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, T, d_head]` | 540 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_h, T, d_head]` | 504 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_h, 1, d_head]` | 504 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 4 | `[B, n_kv, n_h/n_kv, w_local, d_head]` | 360 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 4 | `[B, n_kv, n_h/n_kv, T+1, d_head]` | 360 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, T, T]` | 288 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, d_head]` | 288 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, T+1]` | 252 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, 1]` | 252 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 2 | `[B, T, n_h, d_head]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, T, n_h, d_head]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, d_head, T]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, T]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, 1, d_head]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, 1]` | 180 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, w_local, d_head]` | 180 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, T, n_kv, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, T, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 2 | `[B, 1, n_h, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, 1, n_h, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, 1, n_kv, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, w_local, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, B, w_local]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, B, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, T+1, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T+1, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, B, T+1]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, w_local+n_sink]` | 126 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, (T+1)+n_sink]` | 126 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, w_local-1, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h]` | 36 |
...
| prefill | `model.layers.*.self_attn.q_proj` | linear | `[['n_h*d_head'], ['T', 'd_model'], ['d_model', 'n_h*d_head']]` | `['n_h*d_head', 'd_model']` | `[['T', 'n_h*d_head']]` |
| prefill | `model.layers.*.self_attn.k_proj` | linear | `[['n_kv*d_head'], ['T', 'd_model'], ['d_model', 'n_kv*d_head']]` | `['n_kv*d_head', 'd_model']` | `[['T', 'n_kv*d_head']]` |
| prefill | `model.layers.*.self_attn.v_proj` | linear | `[['n_kv*d_head'], ['T', 'd_model'], ['d_model', 'n_kv*d_head']]` | `['n_kv*d_head', 'd_model']` | `[['T', 'n_kv*d_head']]` |
...
| prefill | `model.layers.*.self_attn.o_proj` | linear | `[['d_model'], ['T', 'n_h*d_head'], ['n_h*d_head', 'd_model']]` | `['d_model', 'n_h*d_head']` | `[['T', 'd_model']]` |
...
| decode | `model.layers.*.self_attn.q_proj` | linear | `[['n_h*d_head'], ['B', 'd_model'], ['d_model', 'n_h*d_head']]` | `['n_h*d_head', 'd_model']` | `[['B', 'n_h*d_head']]` |
| decode | `model.layers.*.self_attn.k_proj` | linear | `[['n_kv*d_head'], ['B', 'd_model'], ['d_model', 'n_kv*d_head']]` | `['n_kv*d_head', 'd_model']` | `[['B', 'n_kv*d_head']]` |
| decode | `model.layers.*.self_attn.v_proj` | linear | `[['n_kv*d_head'], ['B', 'd_model'], ['d_model', 'n_kv*d_head']]` | `['n_kv*d_head', 'd_model']` | `[['B', 'n_kv*d_head']]` |
| decode | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'B', 'd_head'], ['n_h', 'd_head', 'w_local']]` | `None` | `[['n_h', 'B', 'w_local']]` |
| decode | `model.layers.*.self_attn` | softmax | `[['B', 'n_h', '1', 'w_local+n_sink']]` | `None` | `[['B', 'n_h', '1', 'w_local+n_sink']]` |
| decode | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'B', 'w_local'], ['n_h', 'w_local', 'd_head']]` | `None` | `[['n_h', 'B', 'd_head']]` |
| decode | `model.layers.*.self_attn.o_proj` | linear | `[['d_model'], ['B', 'n_h*d_head'], ['n_h*d_head', 'd_model']]` | `['d_model', 'n_h*d_head']` | `[['B', 'd_model']]` |
...
| `d_model` | 2880 | `model.layers.*.mlp.experts`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm`, `model.layers.*.self_attn.o_proj` 외 45개 | 8690 |
...
| `n_kv` | 8 | `model.layers.*.self_attn` | 3384 |
...
| `V` | 201088 | `lm_head`, `model.embed_tokens` | 20 |
...
- `model.layers.*.self_attn`
  ...
  - `[[B, n_h, 1, 1]]`
  - `[[B, n_h, 1, T+1]]`
  - `[[B, n_h, 1, d_head/2], [B, n_h, 1, d_head/2]]`
  - `[[B, n_h, 1, d_head/2]]`
  - `[[B, n_h, 1, d_head]]`
  - `[[B, n_h, 1, w_local+n_sink]]`
  - `[[B, n_h, 1, w_local]]`
  - `[[B, n_h, T+1, d_head]]`
  - `[[B, n_h, T, 1], [B, n_h, T, 1]]`
  - `[[B, n_h, T, 1]]`
  - `[[B, n_h, T, T+1]]`
  - `[[B, n_h, T, T]]`
  - `[[B, n_h, T, d_head/2], [B, n_h, T, d_head/2]]`
  - `[[B, n_h, T, d_head/2]]`
  - `[[B, n_h, T, d_head]]`
  - `[[B, n_h, d_head, T+1]]`
  - `[[B, n_h, d_head, T]]`
  ...
  - `[[B, n_kv, 1, T+1, d_head]]`
  - `[[B, n_kv, 1, T, d_head]]`
  - `[[B, n_kv, 1, d_head/2], [B, n_kv, 1, d_head/2]]`
  - `[[B, n_kv, 1, d_head/2]]`
  - `[[B, n_kv, 1, d_head]]`
  - `[[B, n_kv, 1, w_local, d_head]]`
  - `[[B, n_kv, T+1, d_head]]`
  - `[[B, n_kv, T, d_head/2], [B, n_kv, T, d_head/2]]`
  - `[[B, n_kv, T, d_head/2]]`
  - `[[B, n_kv, T, d_head]]`
  - `[[B, n_kv, n_h/n_kv, T+1, d_head]]`
  - `[[B, n_kv, n_h/n_kv, T, d_head]]`
  - `[[B, n_kv, n_h/n_kv, w_local, d_head]]`
  - `[[B, n_kv, w_local, d_head]]`
  - `[[B, n_kv, w_local-1, d_head]]`
  - `[[]]`
  - `[[n_h, B, T+1]]`
  - `[[n_h, B, d_head]]`
  - `[[n_h, B, w_local]]`
