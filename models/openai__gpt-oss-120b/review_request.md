...
- `d_head vs n_h` in `model.layers.*.self_attn` — 값 64 를 두고 후보가 2개, 5328축
...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, T]` | 540 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, w_local]` | 270 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, T+1]` | 270 |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm`, `model.layers.*.self_attn.q_proj` 외 48개 | 14014 |
| `T` |  | `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm`, `model` 외 46개 | 7470 |
...
| `n_h` | 64 | `model.layers.*.self_attn` | 4752 |
...
| `B*k*T` |  | `model.layers.*.mlp.experts` | 2772 |
| `B*k` |  | `model.layers.*.mlp.experts` | 2772 |
...
| `B*T` |  | `model.layers.*.mlp.router`, `model.layers.*.mlp.experts`, `model.layers.*.self_attn.q_proj`, `model.layers.*.self_attn.k_proj` 외 4개 | 1120 |
| `T+1` |  | `model.layers.*.self_attn`, `model` | 1077 |
| `w_local` | 128 | `model.layers.*.self_attn`, `model` | 868 |
| `B*n_h` |  | `model.layers.*.self_attn` | 864 |
| `2*d_moe` |  | `model.layers.*.mlp.experts` | 792 |
| `n_h/n_kv` |  | `model.layers.*.self_attn` | 576 |
| `k` | 4 | `model.layers.*.mlp.router`, `model.layers.*.mlp.experts` | 576 |
...
### C. 모듈이 내는 출력 shape 전부 (52개 모듈 / 241종)
