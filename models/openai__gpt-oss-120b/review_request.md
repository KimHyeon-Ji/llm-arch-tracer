...
| prefill | `model.layers.*.mlp.experts` | sum | `[['T', 'k', 'd_moe']]` | `None` | `[['T', 'd_model']]` |
...
| decode | `model.layers.*.mlp.experts` | sum | `[['B', 'k', 'd_moe']]` | `None` | `[['B', 'd_model']]` |
...
| `d_model` | 2880 | `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm`, `model.layers.*.self_attn.o_proj`, `model.layers.*.self_attn.q_proj` 외 45개 | 5738 |
...
| `d_moe` | 2880 | `model.layers.*.mlp.experts` | 2952 |
