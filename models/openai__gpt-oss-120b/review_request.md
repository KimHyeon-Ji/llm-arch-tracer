...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 4 | `[B, n_kv, n_h/n_kv, T, d_head]` | 504 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_h, T, d_head]` | 432 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_h, 1, d_head]` | 432 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, d_head]` | 216 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, T, d_head]` | 162 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h, T, d_head]` | 144 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 2 | `[B, T, n_h, d_head]` | 144 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, 1, 1]` | 144 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, w_local, d_head]` | 90 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, T, n_kv, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 1 | `[B, n_h, T, 1]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 2 | `[B, 1, n_h, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, 1, n_h, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, 1, n_kv, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, 1, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, T+1, d_head]` | 72 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `n_h` | 0 | `[n_h]` | 36 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `n_h` | 3 | `[B, n_kv, w_local-1, d_head]` | 18 |
