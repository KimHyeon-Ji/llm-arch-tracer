...
```
  ...
  model                                              gt               [B,B,B,E]*[B,B,B,B] -> [B,B,B,E]
  model                                              bitwise_and      []*[B,B,B,E] -> [B,B,B,E]
  model                                              le               [B,B,B,E]*[B,B,B,B] -> [B,B,B,E]
  model                                              bitwise_and      [B,B,B,E]*[B,B,B,E] -> [B,B,B,E]
  model                                              expand           [B,B,B,E] -> [B,B,B,E]
  model                                              where            [B,B,B,E]*[]*[] -> [B,B,B,E]
  model.rotary_emb                                   unsqueeze        [d_head/2] -> [B,d_head/2]
  model.rotary_emb                                   unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  model.rotary_emb                                   expand           [B,d_head/2,B] -> [B,d_head/2,B]
