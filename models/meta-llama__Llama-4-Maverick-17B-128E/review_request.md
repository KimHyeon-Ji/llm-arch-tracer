...
|---|---|---|---|---|---|---|---|
| `heur` | `model.layers.*.feed_forward` | 2048 | `E*T` | — | 0 | `[E*T, d_model]` | 96 |
| `heur` | `model.layers.*.feed_forward` | 2048 | `E*T` | — | 0 | `[E*T, B]` | 48 |
| `heur` | `model.layers.*.feed_forward.experts` | 2048 | `E*T` | — | 0 | `[E*T, d_model]` | 48 |
...
### C. 모듈이 내는 출력 shape 전부 (74개 모듈 / 263종)
