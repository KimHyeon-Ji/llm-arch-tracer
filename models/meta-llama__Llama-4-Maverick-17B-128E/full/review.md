...
```
  ...
  model.layers.N.self_attn                           batched_matmul   [n_h,1,d_head]*[n_h,d_head,T+1] -> [n_h,1,T+1]
  model.layers.N.self_attn                           _unsafe_view     [n_h,1,T+1] -> [B,n_h,1,T+1]
  ...
  model.layers.N.self_attn                           batched_matmul   [n_h,1,T+1]*[n_h,T+1,d_head] -> [n_h,1,d_head]
  model.layers.N.self_attn                           _unsafe_view     [n_h,1,d_head] -> [B,n_h,1,d_head]
  ...
  model.layers.N.feed_forward.experts                view             [E,d_model] -> [E,1,d_model]
  model.layers.N.feed_forward.experts                batched_matmul   [E,1,d_model]*[E,d_model,2*d_moe] -> w=[E,d_model,2*d_moe] [E,1,2*d_moe]
  model.layers.N.feed_forward.experts                split            [E,1,2*d_moe] -> [E,1,d_moe]*[E,1,d_moe]
  model.layers.N.feed_forward.experts.act_fn         silu             [E,1,d_moe] -> [E,1,d_moe]
  model.layers.N.feed_forward.experts                elementwise_mul  [E,1,d_moe]*[E,1,d_moe] -> [E,1,d_moe]
  model.layers.N.feed_forward.experts                batched_matmul   [E,1,d_moe]*[E,d_moe,d_model] -> w=[E,d_moe,d_model] [E,1,d_model]
  model.layers.N.feed_forward.experts                view             [E,1,d_model] -> [E,d_model]
  model.layers.N.feed_forward.shared_expert.gate_proj t                [d_moe,d_model] -> w=[d_moe,d_model] [d_model,d_moe]
  ...
  model.layers.N.feed_forward                        view             [E,d_model] -> [E,1,d_model]
  model.layers.N.feed_forward                        sum              [E,1,d_model] -> [B,d_model]
