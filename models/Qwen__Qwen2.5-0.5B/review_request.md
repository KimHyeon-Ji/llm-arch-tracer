...
| prefill | `model.layers.*.self_attn.q_proj` | linear | `[['d_model'], ['T', 'd_model'], ['d_model', 'n_h*d_head']]` | `['n_h*d_head', 'd_model']` | `[['T', 'n_h*d_head']]` |
...
| decode | `model.layers.*.self_attn.q_proj` | linear | `[['d_model'], ['B', 'd_model'], ['d_model', 'n_h*d_head']]` | `['n_h*d_head', 'd_model']` | `[['B', 'n_h*d_head']]` |
