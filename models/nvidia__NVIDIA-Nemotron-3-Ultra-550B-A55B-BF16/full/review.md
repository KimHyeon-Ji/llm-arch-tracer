...
```
  ...
  model.layers.N.mixer                               elementwise_mul  [n_h_ssm,B]*[B,d_state,n_h_ssm,d_head_ssm] -> [B,d_state,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               permute          [B,1,d_state,n_h_ssm] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state,1]
  model.layers.N.mixer                               expand           [B,n_h_ssm,1,d_state,1] -> [B,n_h_ssm,1,d_state,d_chunk]
  ...
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,1,d_state,d_chunk]*[d_state,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,1,d_state,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  model.layers.N.mixer                               exp              [B,n_h_ssm,1,d_state,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  ...
  model.layers.N.mixer                               elementwise_mul  [B,1,d_state,1,n_h_ssm,d_chunk]*[B,1,1,d_state,n_h_ssm,d_chunk] -> [B,1,d_state,d_chunk,n_h_ssm,d_head]
  model.layers.N.mixer                               sum              [B,1,d_state,d_chunk,n_h_ssm,d_head] -> [B,1,d_state,d_chunk,n_h_ssm]
  model.layers.N.mixer                               permute          [B,n_h_ssm,1,d_state,d_chunk] -> [B,1,d_state,d_chunk,n_h_ssm]
  ...
  model.layers.N.mixer                               sum              [B,1,d_state,d_chunk,n_h_ssm,d_head_ssm] -> [B,1,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               slice            [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,1]
  model.layers.N.mixer                               sub              [B,n_h_ssm,1,1]*[B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mixer                               exp              [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mixer                               permute          [B,n_h_ssm,1,d_state] -> [B,1,d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,1,d_state,n_h_ssm,d_chunk] -> [B,1,n_h_ssm,d_state,d_chunk]
  model.layers.N.mixer                               permute          [B,1,d_state,n_h_ssm,d_head_ssm] -> [B,1,n_h_ssm,d_state,n_h]
  model.layers.N.mixer                               sum              [B,1,n_h_ssm,d_state,d_chunk,n_h] -> [B,1,n_h_ssm,d_state,n_h]
  model.layers.N.mixer                               permute          [B,1,n_h_ssm,d_state,n_h] -> [B,1,n_h_ssm,d_head_ssm,d_state]
  ...
  model.layers.N.mixer                               select           [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1]
  ...
  model.layers.N.mixer                               sum              [B,n_h_ssm,n_kv,n_kv,d_head_ssm,d_state] -> [B,n_h_ssm,n_kv,d_head_ssm,d_state]
  ...
  model.layers.N.mixer                               slice            [B,d_state,n_h_ssm,d_head_ssm] -> [B,T,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               transpose        [B,T,n_kv,d_state] -> [B,2,T,d_state]
  ...
  model.layers.N.mixer                               concat           [0]*[B,2,T,d_state] -> [B,2,T,d_state]
  model.layers.N.mixer                               expand           [B,2,1,T,d_state] -> [B,2,n_h_ssm/n_g_ssm,T,d_state]
  model.layers.N.mixer                               clone            [B,2,n_h_ssm/n_g_ssm,T,d_state] -> [B,2,n_h_ssm/n_g_ssm,T,d_state]
  model.layers.N.mixer                               _unsafe_view     [B,2,n_h_ssm/n_g_ssm,T,d_state] -> [B,n_h,T,d_state]
...
```
  ...
  model.layers.N.mixer                               transpose        [B,1,n_h,d_state] -> [B,n_h,1,d_state]
  model.layers.N.mixer.k_proj                        t                [n_h_ssm,n_h*d_head] -> w=[n_h_ssm,n_h*d_head] [d_model,n_h_ssm]
  ...
  model.layers.N.mixer                               transpose        [B,1,2,d_state] -> [B,2,1,d_state]
  model.layers.N.mixer.v_proj                        t                [n_h_ssm,n_h*d_head] -> w=[n_h_ssm,n_h*d_head] [d_model,n_h_ssm]
  ...
  model.layers.N.mixer                               concat           [B,2,T,d_state]*[B,2,1,d_state] -> [B,2,T+1,d_state]
  model.layers.N.mixer                               expand           [B,2,1,T+1,d_state] -> [B,2,n_h_ssm/n_g_ssm,T+1,d_state]
  model.layers.N.mixer                               clone            [B,2,n_h_ssm/n_g_ssm,T+1,d_state] -> [B,2,n_h_ssm/n_g_ssm,T+1,d_state]
  model.layers.N.mixer                               _unsafe_view     [B,2,n_h_ssm/n_g_ssm,T+1,d_state] -> [B,n_h,T+1,d_state]
  ...
  model.layers.N.mixer                               _unsafe_view     [n_h,B,d_state] -> [B,n_h,1,d_state]
  model.layers.N.mixer                               transpose        [B,n_h,1,d_state] -> [B,1,n_h,d_state]
  model.layers.N.mixer.o_proj                        t                [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
