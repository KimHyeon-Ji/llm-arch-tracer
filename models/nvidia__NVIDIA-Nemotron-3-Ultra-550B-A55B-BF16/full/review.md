...
등록된 규칙 **225,889축**, 약한 근거 4,882축, 휴리스틱 **0축 (0.0%)**, 이름 없음 4,056축.
...
```
  ...
  model.layers.N.mixer                               view             [B,T,n_g*d_state] -> [B,T,n_g_ssm,d_head]
  model.layers.N.mixer                               _to_copy         [B,T,n_g_ssm,d_head] -> [B,T,n_g_ssm,d_head]
  model.layers.N.mixer                               unsqueeze        [B,T,n_g_ssm,d_head] -> [B,T,n_g_ssm,1,d_head]
  model.layers.N.mixer                               expand           [B,T,n_g_ssm,1,d_head] -> [B,T,n_g_ssm,n_h_ssm/n_g_ssm,d_head]
  model.layers.N.mixer                               clone            [B,T,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,T,n_g_ssm,n_h_ssm/n_g_ssm,d_head]
  model.layers.N.mixer                               view             [B,T,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,T,n_h_ssm,d_head]
  model.layers.N.mixer                               unsqueeze        [n_h_ssm] -> [n_h_ssm,B]
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm,d_head_ssm] -> [B,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [n_h_ssm,B]*[B,d_head,n_h_ssm,d_head_ssm] -> [B,d_head,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer                               view             [B,d_head,n_h_ssm,d_head_ssm] -> [B,1,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm] -> [B,d_head,n_h_ssm]
  model.layers.N.mixer                               view             [B,d_head,n_h_ssm] -> [B,1,d_head,n_h_ssm]
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm,d_head] -> [B,d_head,n_h_ssm,d_state]
  model.layers.N.mixer                               view             [B,d_head,n_h_ssm,d_state] -> [B,1,d_head,n_h_ssm,d_state]
  model.layers.N.mixer                               permute          [B,1,d_head,n_h_ssm] -> [B,n_h_ssm,1,d_head]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1,d_head]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1,d_head,1]
  model.layers.N.mixer                               expand           [B,n_h_ssm,1,d_head,1] -> [B,n_h_ssm,1,d_head,d_state]
  model.layers.N.mixer                               ones             [] -> [d_head,d_state]
  model.layers.N.mixer                               tril             [d_head,d_state] -> [d_head,d_state]
  model.layers.N.mixer                               bitwise_not      [d_head,d_state] -> [d_head,d_state]
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,1,d_head,d_state]*[d_head,d_state] -> [B,n_h_ssm,1,d_head,d_state]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,1,d_head,d_state] -> [B,n_h_ssm,1,d_head,d_state]
  model.layers.N.mixer                               exp              [B,n_h_ssm,1,d_head,d_state] -> [B,n_h_ssm,1,d_head,d_state]
  model.layers.N.mixer                               unsqueeze        [B,1,d_head,n_h_ssm,d_state] -> [B,1,d_head,1,n_h_ssm,d_state]
  model.layers.N.mixer                               unsqueeze        [B,1,d_head,n_h_ssm,d_state] -> [B,1,1,d_head,n_h_ssm,d_state]
  model.layers.N.mixer                               elementwise_mul  [B,1,d_head,1,n_h_ssm,d_state]*[B,1,1,d_head,n_h_ssm,d_state] -> [B,1,d_head,d_state,n_h_ssm,d_chunk]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,n_h_ssm,d_chunk] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,n_h_ssm,1,d_head,d_state] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,1,d_head,d_state,n_h_ssm,1]*[B,1,d_head,d_state,n_h_ssm,1] -> [B,1,d_head,d_state,n_h_ssm,1]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,n_h_ssm,1] -> [B,1,d_head,d_state,n_h_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,1,d_head,d_state,n_h_ssm,1]*[B,1,1,d_head,n_h_ssm,d_head_ssm] -> [B,1,d_head,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               sum              [B,1,d_head,d_state,n_h_ssm,d_head_ssm] -> [B,1,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               slice            [B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1,1]
  model.layers.N.mixer                               sub              [B,n_h_ssm,1,1]*[B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1,d_head]
  model.layers.N.mixer                               exp              [B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1,d_head]
  model.layers.N.mixer                               permute          [B,n_h_ssm,1,d_head] -> [B,1,d_head,n_h_ssm]
  model.layers.N.mixer                               permute          [B,1,d_head,n_h_ssm,d_state] -> [B,1,n_h_ssm,d_head,d_state]
  model.layers.N.mixer                               permute          [B,1,d_head,n_h_ssm,d_head_ssm] -> [B,1,n_h_ssm,d_head,n_h]
  model.layers.N.mixer                               sum              [B,1,n_h_ssm,d_head,d_state,n_h] -> [B,1,n_h_ssm,d_head,n_h]
  model.layers.N.mixer                               permute          [B,1,n_h_ssm,d_head,n_h] -> [B,1,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               alias            [B,1,n_h_ssm,d_head_ssm,d_head] -> [B,1,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               zeros_like       [B,1,n_h_ssm,d_head_ssm,d_head] -> [B,1,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               concat           [B,1,n_h_ssm,d_head_ssm,d_head]*[B,1,n_h_ssm,d_head_ssm,d_head] -> [B,2,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               select           [B,n_h_ssm,1,d_head] -> [B,n_h_ssm,1]
  model.layers.N.mixer                               constant_pad_nd  [B,n_h_ssm,1] -> [B,n_h_ssm,n_kv]
  model.layers.N.mixer                               expand           [B,n_h_ssm,n_kv,1] -> [B,n_h_ssm,n_kv,n_kv]
  model.layers.N.mixer                               ones             [] -> [2,2]
  model.layers.N.mixer                               tril             [2,2] -> [2,2]
  model.layers.N.mixer                               bitwise_not      [2,2] -> [2,2]
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,n_kv,n_kv]*[2,2] -> [B,n_h_ssm,n_kv,n_kv]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,n_kv,n_kv] -> [B,n_h_ssm,n_kv,n_kv]
  model.layers.N.mixer                               exp              [B,n_h_ssm,n_kv,n_kv] -> [B,n_h_ssm,n_kv,n_kv]
  model.layers.N.mixer                               sum              [B,n_h_ssm,n_kv,n_kv,d_head_ssm,d_head] -> [B,n_h_ssm,n_kv,d_head_ssm,d_head]
  model.layers.N.mixer                               slice            [B,2,n_h_ssm,d_head_ssm,d_head] -> [B,1,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               select           [B,2,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               sum              [B,1,d_head,n_h_ssm,d_head_ssm,d_state] -> [B,1,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,1,d_head,n_h_ssm,d_head_ssm]*[B,1,d_head,n_h_ssm,d_head_ssm] -> [B,1,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,d_head,n_h_ssm,d_head_ssm]*[B,d_head,n_h_ssm,d_head_ssm] -> [B,d_head,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               slice            [B,d_head,n_h_ssm,d_head_ssm] -> [B,T,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               zeros_like       [B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               copy_            [B,n_h_ssm,d_head_ssm,d_head]*[B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
...
```
  ...
  model.layers.N.mixer                               expand           [n_h_ssm,B,1] -> [n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,d_head_ssm] -> [B,n_h_ssm,d_head_ssm,1]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,1]*[n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               exp              [B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               view             [B,1,n_g*d_state] -> [B,n_g_ssm,d_head]
  model.layers.N.mixer                               unsqueeze        [B,n_g_ssm,d_head] -> [B,n_g_ssm,1,d_head]
  model.layers.N.mixer                               expand           [B,n_g_ssm,1,d_head] -> [B,n_g_ssm,n_h_ssm/n_g_ssm,d_head]
  model.layers.N.mixer                               clone            [B,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,n_g_ssm,n_h_ssm/n_g_ssm,d_head]
  model.layers.N.mixer                               view             [B,n_g_ssm,n_h_ssm/n_g_ssm,d_head] -> [B,n_h_ssm,d_head]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,1]*[B,n_h_ssm,1,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               view             [B,1,d_inner] -> [B,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,d_head]*[B,n_h_ssm,d_head_ssm,1] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               clone            [B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,d_head]*[B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               elementwise_add  [B,n_h_ssm,d_head_ssm,d_head]*[B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               copy_            [B,n_h_ssm,d_head_ssm,d_head]*[B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               _to_copy         [B,n_h_ssm,d_head_ssm,d_head] -> [B,n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               view             [B,n_h_ssm,d_head_ssm,d_head] -> [n_h_ssm,d_head_ssm,d_head]
  model.layers.N.mixer                               view             [B,n_h_ssm,d_head] -> [n_h_ssm,d_head,B]
  model.layers.N.mixer                               batched_matmul   [n_h_ssm,d_head_ssm,d_head]*[n_h_ssm,d_head,B] -> [n_h_ssm,d_head_ssm,B]
