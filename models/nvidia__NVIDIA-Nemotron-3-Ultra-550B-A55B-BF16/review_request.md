...
| `d_state` | 128 | `model.layers.*.mixer` | 12096 |
...
| `d_head` | 128 | `model.layers.*.mixer` | 96 |
...
- `model.layers.*.mixer`
  ...
  - `[[B, 1, n_h_ssm, d_state, 1, n_h]]`
  - `[[B, 1, n_h_ssm, d_state, d_chunk, 1]]`
  - `[[B, 1, n_h_ssm, d_state, d_chunk, n_h]]`
  - `[[B, 1, n_h_ssm, d_state, d_chunk]]`
  - `[[B, 1, n_h_ssm, d_state, n_h]]`
  - `[[B, 1, n_h_ssm]]`
  - `[[B, 2, 1, T+1, d_state]]`
  - `[[B, 2, 1, T, d_state]]`
  - `[[B, 2, 1, d_state]]`
  ...
  - `[[B, n_h_ssm, 1, d_state]]`
  - `[[B, n_h_ssm, 1, n_kv, d_head_ssm, d_state]]`
  - `[[B, n_h_ssm, 1]]`
  ...
  - `[[B, n_h_ssm, d_state]]`
  - `[[B, n_h_ssm, n_kv, 1]]`
  - `[[B, n_h_ssm, n_kv, d_head_ssm, d_state]]`
  - `[[B, n_h_ssm, n_kv, n_kv, 1, 1]]`
  - `[[B, n_h_ssm, n_kv, n_kv, 1]]`
  - `[[B, n_h_ssm, n_kv, n_kv, d_head_ssm, d_state]]`
  - `[[B, n_h_ssm, n_kv, n_kv]]`
  - `[[B, n_h_ssm, n_kv]]`
  - `[[B, n_h_ssm]]`
  - `[[T, d_model]]`
