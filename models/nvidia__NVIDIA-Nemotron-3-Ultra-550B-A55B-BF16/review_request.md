...
| `tie` | `model.layers.*.mixer` | 128 | `d_head` | `d_chunk`, `d_state` | 3 | `[B, n_kv, 1, d_head]` | 252 |
| `tie` | `model.layers.*.mixer` | 128 | `d_head` | `d_chunk`, `d_state` | 3 | `[B, n_kv, T, d_head]` | 240 |
...
| `tie` | `model.layers.*.mixer` | 128 | `d_chunk` | `d_chunk`, `d_state` | 5 | `[B, 1, d_state, n_h_ssm, d_head_ssm, d_chunk]` | 96 |
| `tie` | `model.layers.*.mixer` | 64 | `d_head_ssm` | `d_head_ssm`, `n_h` | 3 | `[B, T, n_h_ssm, d_head_ssm]` | 96 |
| `tie` | `model.layers.*.mixer` | 64 | `d_head_ssm` | `d_head_ssm`, `n_h` | 1 | `[n_h_ssm, d_head_ssm]` | 96 |
| `tie` | `model.layers.*.mixer` | 64 | `d_head_ssm` | `d_head_ssm`, `n_h` | 1 | `[n_h_ssm, d_head_ssm, d_state]` | 96 |
| `tie` | `model.layers.*.mixer` | 128 | `d_state` | `d_chunk`, `d_state` | 2 | `[n_h_ssm, d_head_ssm, d_state]` | 96 |
| `tie` | `model.layers.*.mixer` | 64 | `n_h` | `d_head_ssm`, `n_h` | 1 | `[B, n_h, T, d_head]` | 72 |
