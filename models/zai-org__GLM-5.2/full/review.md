...
```
  ...
  model.layers.N.self_attn.indexer                   concat           [B,T,1,d_rope]*[B,T,1,c_I-d_rope] -> [B,T,1,c_I]
...
```
  ...
  model.layers.N.self_attn.indexer                   concat           [B,1,1,d_rope]*[B,1,1,c_I-d_rope] -> [B,1,1,c_I]
