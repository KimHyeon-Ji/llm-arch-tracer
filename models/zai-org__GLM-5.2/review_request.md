# 검토 의뢰서 — zai-org/GLM-5.2

파이썬 파이프라인이 규칙으로 결정할 수 있는 것을 전부 결정하고, **판단이 필요한 것만** 여기 남겼다. 절차와 출력 형식은 `review/` 에 있다.

- transformers 모듈: `glm_moe_dsa`
- 판단 필요: **6건**

## 증거 — 이미 받아둔 실제 소스

- `develop/sources/modeling_glm_moe_dsa.py` — 있음, 이 파일을 열어서 판정한다
- `develop/sources/configuration_glm_moe_dsa.py` — 있음, 이 파일을 열어서 판정한다

- 온라인 원본: https://github.com/huggingface/transformers/tree/main/src/transformers/models/glm_moe_dsa
...
- `d_head vs d_rope vs n_h vs n_kv` in `model.layers.*.self_attn` — 값 64 를 두고 후보가 4개, 14976축
- `d_head vs d_rope` in `model.layers.*.self_attn` — 값 64 를 두고 후보가 2개, 1092축
- `d_head vs d_rope vs n_h vs n_kv` in `model.layers.*.self_attn.indexer` — 값 64 를 두고 후보가 4개, 672축
- `c_q vs k_I` in `model.layers.*.self_attn.indexer.wq_b` — 값 2048 를 두고 후보가 2개, 338축
- `c_q vs k_I` in `model.layers.*.self_attn.indexer` — 값 2048 를 두고 후보가 2개, 168축
...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_v]` | 1560 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_rope/2]` | 1404 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 0 | `[n_h, T, T]` | 1404 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_rope/2]` | 1404 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 0 | `[n_h, B, T+1]` | 1404 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_v]` | 936 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T+1, d_v]` | 624 |
| `tie` | `model.layers.*.self_attn.indexer.wq_b` | 2048 | `c_q` | `c_q`, `k_I` | 1 | `[d_model, c_q]` | 546 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head]` | 546 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, n_h, T, d_head]` | 546 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head]` | 546 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, n_h, 1, d_head]` | 546 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, n_h, d_v]` | 468 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, d_v, T]` | 468 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, d_v, T+1]` | 468 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, n_h]` | 390 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, n_h]` | 390 |
| `tie` | `model.layers.*.self_attn` | 2048 | `c_q` | `c_q`, `k_I` | 2 | `[B, T, c_q]` | 354 |
| `tie` | `model.layers.*.self_attn` | 2048 | `c_q` | `c_q`, `k_I` | 2 | `[B, 1, c_q]` | 354 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_nope]` | 312 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 0 | `[n_h, T, d_v]` | 312 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, n_h, d_v]` | 312 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_nope]` | 312 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 0 | `[n_h, B, d_v]` | 312 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, d_head]` | 208 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, d_head]` | 208 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, n_h, d_nope+d_v]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_nope+d_v]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, 1, T, n_h]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, n_h, d_nope+d_v]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_nope+d_v]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, 1, 1, n_h]` | 156 |
| `tie` | `model.layers.*.self_attn.indexer` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, T, n_h_I, d_head]` | 147 |
| `tie` | `model.layers.*.self_attn.indexer` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, T, 1, n_h]` | 147 |
| `tie` | `model.layers.*.self_attn.indexer` | 64 | `d_head` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, 1, n_h_I, d_head]` | 147 |
| `tie` | `model.layers.*.self_attn.indexer` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 3 | `[B, 1, 1, n_h]` | 147 |
| `tie` | `model.layers.*.self_attn.indexer` | 2048 | `c_q` | `c_q`, `k_I` | 2 | `[B, T, c_q]` | 42 |
| `tie` | `model.layers.*.self_attn.indexer` | 2048 | `c_q` | `c_q`, `k_I` | 2 | `[B, 1, c_q]` | 42 |
| `tie` | `model.layers.*.self_attn.indexer.wq_b` | 2048 | `c_q` | `c_q`, `k_I` | 1 | `[n_h_I*c_I, c_q]` | 21 |
| `tie` | `model.rotary_emb` | 64 | `d_head` | `d_head`, `d_rope` | 2 | `[B, T, d_head]` | 3 |
...
| prefill | `model.layers.*.self_attn.q_b_proj` | matmul | `[['T', 'c_q'], ['c_q', 'n_h*d_v']]` | `['n_h*d_v', 'c_q']` | `[['T', 'n_h*d_v']]` |
...
| prefill | `model.layers.*.self_attn.indexer.wq_b` | matmul | `[['T', 'c_q'], ['c_q', 'n_h_I*c_I']]` | `['n_h_I*c_I', 'c_q']` | `[['T', 'n_h_I*c_I']]` |
| prefill | `model.layers.*.self_attn.indexer.wk` | matmul | `[['T', 'd_model'], ['d_model', 'c_I']]` | `['c_I', 'd_model']` | `[['T', 'c_I']]` |
| prefill | `model.layers.*.self_attn.indexer.k_norm` | layernorm | `[['B', 'T', 'c_I'], ['c_I'], ['c_I']]` | `['c_I']` | `[['B', 'T', 'c_I'], ['B', 'T', '1'], ['B', 'T', '1']]` |
| prefill | `model.layers.*.self_attn.indexer` | batched_matmul | `[['T', 'n_h_I', 'c_I'], ['T', 'c_I', 'T']]` | `None` | `[['T', 'n_h_I', 'T']]` |
| prefill | `model.layers.*.self_attn.indexer` | relu | `[['B', 'T', 'n_h_I', 'T']]` | `None` | `[['B', 'T', 'n_h_I', 'T']]` |
| prefill | `model.layers.*.self_attn.indexer.weights_proj` | matmul | `[['T', 'd_model'], ['d_model', 'n_h_I']]` | `['n_h_I', 'd_model']` | `[['T', 'n_h_I']]` |
| prefill | `model.layers.*.self_attn.indexer` | batched_matmul | `[['T', '1', 'n_h_I'], ['T', 'n_h_I', 'T']]` | `None` | `[['T', '1', 'T']]` |
| prefill | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'T', 'd_v'], ['n_h', 'd_v', 'T']]` | `None` | `[['n_h', 'T', 'T']]` |
| prefill | `model.layers.*.self_attn` | softmax | `[['B', 'n_h', 'T', 'T']]` | `None` | `[['B', 'n_h', 'T', 'T']]` |
| prefill | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'T', 'T'], ['n_h', 'T', 'd_v']]` | `None` | `[['n_h', 'T', 'd_v']]` |
...
| decode | `model.layers.*.self_attn.q_b_proj` | matmul | `[['B', 'c_q'], ['c_q', 'n_h*d_v']]` | `['n_h*d_v', 'c_q']` | `[['B', 'n_h*d_v']]` |
...
| decode | `model.layers.*.self_attn.indexer.wq_b` | matmul | `[['B', 'c_q'], ['c_q', 'n_h_I*c_I']]` | `['n_h_I*c_I', 'c_q']` | `[['B', 'n_h_I*c_I']]` |
| decode | `model.layers.*.self_attn.indexer.wk` | matmul | `[['B', 'd_model'], ['d_model', 'c_I']]` | `['c_I', 'd_model']` | `[['B', 'c_I']]` |
| decode | `model.layers.*.self_attn.indexer.k_norm` | layernorm | `[['B', '1', 'c_I'], ['c_I'], ['c_I']]` | `['c_I']` | `[['B', '1', 'c_I'], ['B', '1', '1'], ['B', '1', '1']]` |
| decode | `model.layers.*.self_attn.indexer` | batched_matmul | `[['B', 'n_h_I', 'c_I'], ['B', 'c_I', 'T+1']]` | `None` | `[['B', 'n_h_I', 'T+1']]` |
| decode | `model.layers.*.self_attn.indexer` | relu | `[['B', '1', 'n_h_I', 'T+1']]` | `None` | `[['B', '1', 'n_h_I', 'T+1']]` |
| decode | `model.layers.*.self_attn.indexer.weights_proj` | matmul | `[['B', 'd_model'], ['d_model', 'n_h_I']]` | `['n_h_I', 'd_model']` | `[['B', 'n_h_I']]` |
| decode | `model.layers.*.self_attn.indexer` | batched_matmul | `[['B', '1', 'n_h_I'], ['B', 'n_h_I', 'T+1']]` | `None` | `[['B', '1', 'T+1']]` |
| decode | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'B', 'd_v'], ['n_h', 'd_v', 'T+1']]` | `None` | `[['n_h', 'B', 'T+1']]` |
| decode | `model.layers.*.self_attn` | softmax | `[['B', 'n_h', '1', 'T+1']]` | `None` | `[['B', 'n_h', '1', 'T+1']]` |
| decode | `model.layers.*.self_attn` | batched_matmul | `[['n_h', 'B', 'T+1'], ['n_h', 'T+1', 'd_v']]` | `None` | `[['n_h', 'B', 'd_v']]` |
...
| `k` | 8 | `model.layers.*.mlp.experts`, `model.layers.*.mlp.gate`, `model.layers.*.mlp.experts.act_fn` | 6075 |
| `d_v` | 256 | `model.layers.*.self_attn` | 5616 |
| `c_q` | 2048 | `model.layers.*.self_attn.q_a_layernorm`, `model.layers.*.self_attn.q_a_proj`, `model.layers.*.self_attn.q_b_proj`, `model.layers.*.self_attn` 외 2개 | 5496 |
| `k*T` |  | `model.layers.*.mlp.experts`, `model.layers.*.mlp.experts.act_fn` | 4125 |
...
- `model.layers.*.self_attn.indexer`
  ...
  - `[[B, 1, n_h_I, T+1]]`
  - `[[B, 1, n_h_I, c_I]]`
  - `[[B, 1, n_h_I, d_head], [B, 1, n_h_I, d_head]]`
  - `[[B, 1, n_h_I, d_head]]`
  - `[[B, 1, n_h_I, d_rope/2]]`
  - `[[B, 1, n_h_I]]`
  - `[[B, T+1, c_I]]`
  ...
  - `[[B, T, n_h_I, T]]`
  - `[[B, T, n_h_I, c_I]]`
  - `[[B, T, n_h_I, d_head], [B, T, n_h_I, d_head]]`
  - `[[B, T, n_h_I, d_head]]`
  - `[[B, T, n_h_I, d_rope/2]]`
  - `[[B, T, n_h_I]]`
  - `[[B, c_I, T+1]]`
  ...
  - `[[T, n_h_I, T]]`
  - `[[T, n_h_I, c_I]]`
- `model.layers.*.self_attn.indexer.k_norm`
  - `[[B, 1, c_I], [B, 1, 1], [B, 1, 1]]`
  - `[[B, T, c_I], [B, T, 1], [B, T, 1]]`
