...
| `tie` | `model.layers.*.self_attn` | 64 | `d_rope` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, d_rope]` | 390 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_rope` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, d_rope]` | 390 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, T, n_h, d_nope+d_rope]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_nope+d_rope]` | 156 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 2 | `[B, 1, n_h, d_nope+d_rope]` | 156 |
| `tie` | `model.layers.*.self_attn` | 64 | `n_h` | `d_head`, `d_rope`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_nope+d_rope]` | 156 |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.self_attn`, `model.layers.*.self_attn.indexer`, `model.layers.*.mlp.gate`, `model.layers.*.input_layernorm` 외 107개 | 50657 |
...
| `n_h` | 64 | `model.layers.*.self_attn` | 13572 |
| `d_rope/2` |  | `model.layers.*.self_attn`, `model.layers.*.self_attn.indexer`, `model.rotary_emb` | 9936 |
...
| `d_v` | 256 | `model.layers.*.self_attn` | 4992 |
...
| `d_rope` | 64 | `model.layers.*.self_attn`, `model.layers.*.self_attn.indexer`, `model.rotary_emb` | 3026 |
| `n_h_I` | 32 | `model.layers.*.self_attn.indexer`, `model.layers.*.self_attn.indexer.weights_proj` | 2772 |
| `c_I` | 128 | `model.layers.*.self_attn.indexer`, `model.layers.*.self_attn.indexer.wk`, `model.layers.*.self_attn.indexer.k_norm` | 1743 |
| `n_h*(d_nope+d_rope)` |  | `model.layers.*.self_attn.q_b_proj`, `model.layers.*.self_attn` | 1404 |
...
| `n_h*d_v` |  | `model.layers.*.self_attn.o_proj`, `model.layers.*.self_attn` | 1404 |
| `2*d_moe` |  | `model.layers.*.mlp.experts` | 1050 |
| `d_nope+d_rope` |  | `model.layers.*.self_attn` | 624 |
...
| `c_I-d_rope` |  | `model.layers.*.self_attn.indexer` | 168 |
...
### C. 모듈이 내는 출력 shape 전부 (112개 모듈 / 461종)
...
- `model.layers.*.self_attn.indexer`
  ...
  - `[[B, 1, n_h_I, c_I]]`
  - `[[B, 1, n_h_I, d_rope/2]]`
  - `[[B, 1, n_h_I, d_rope], [B, 1, n_h_I, c_I-d_rope]]`
  - `[[B, 1, n_h_I, d_rope]]`
  - `[[B, 1, n_h_I]]`
  - `[[B, T+1, c_I]]`
  - `[[B, T, 1, T]]`
  ...
  - `[[B, T, n_h_I, c_I]]`
  - `[[B, T, n_h_I, d_rope/2]]`
  - `[[B, T, n_h_I, d_rope], [B, T, n_h_I, c_I-d_rope]]`
  - `[[B, T, n_h_I, d_rope]]`
  - `[[B, T, n_h_I]]`
  - `[[B, c_I, T+1]]`
  - `[[B, c_I, T]]`
