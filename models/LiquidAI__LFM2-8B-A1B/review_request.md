...
| prefill | `model.layers.*.feed_forward.experts` | elementwise_mul | `[['k*T', 'd_model'], ['k*T', '1']]` | `None` | `[['k*T', 'd_model']]` |
...
| decode | `model.layers.*.feed_forward.experts` | elementwise_mul | `[['k', 'd_model'], ['k', '1']]` | `None` | `[['k', 'd_model']]` |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.self_attn`, `model.layers.*.conv`, `model.layers.*.operator_norm`, `model.layers.*.ffn_norm` 외 45개 | 6148 |
