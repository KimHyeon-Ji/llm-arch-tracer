...
| C16 | INFO | 8713 unmapped rows, 14 distinct raw ops: ['aten._to_copy.default', 'aten._unsafe_view.default', '... |
...
```
  ...
  model.layers.N.self_attn.q_proj                    matmul           [T,d_model]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [T,d_model]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [T,d_model] -> [B,T,n_h*d_head]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,T,d_head]*[B,B,T,n_h] -> [B,n_kv,T,d_head]
...
```
  ...
  model.layers.N.self_attn.q_proj                    matmul           [B,d_model]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [B,d_model]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [B,d_model] -> [B,B,n_h*d_head]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,B,d_head]*[B,B,B,n_h] -> [B,n_kv,B,d_head]
  ...
  model.layers.48                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.49                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.50                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.51                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.52                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.53                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.54                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.55                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.56                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.57                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.58                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.59                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.60                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.61                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.62                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.63                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.64                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.65                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.66                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.67                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.68                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.69                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.70                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.71                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.72                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.73                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.74                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.75                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.76                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.77                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.78                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.79                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.80                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.81                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.82                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.83                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.84                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.85                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.86                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.87                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.88                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.89                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.90                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.91                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.92                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.93                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.94                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.95                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.96                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.97                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.98                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.99                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.100                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.101                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.102                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.103                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.104                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.105                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.106                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.107                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.108                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.109                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.110                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.111                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.112                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.113                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.114                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.115                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.116                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.117                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.118                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.119                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.120                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.121                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.122                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.123                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.124                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.125                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
