# 조사 안건 — meta-llama/Llama-3.1-405B
...
|---|---|---|---|---:|
| `model.layers.*.self_attn.o_proj` | `n_h*d_head` | `[n_h*d_head, n_h*d_head]` | `[16384, 16384]` | 378 |
| `model.layers.*.self_attn.q_proj` | `n_h*d_head` | `[n_h*d_head, n_h*d_head]` | `[16384, 16384]` | 126 |
...
4. 저장소 README / 공식 model card — https://huggingface.co/meta-llama/Llama-3.1-405B
