...
```
  ...
  model.layers.N.self_attn                           transpose        [B,T,n_h,d_nope+d_v] -> [B,n_h,T,2*d_nope]
  model.layers.N.self_attn                           split_with_sizes [B,n_h,T,2*d_nope] -> [B,n_h,T,d_nope]*[B,n_h,T,d_nope]
  ...
  model.layers.N.mlp.experts                         view             [T,E] -> [k*T]
...
```
  ...
  model.layers.N.self_attn                           transpose        [B,1,n_h,d_nope+d_v] -> [B,n_h,1,2*d_nope]
  model.layers.N.self_attn                           split_with_sizes [B,n_h,1,2*d_nope] -> [B,n_h,1,d_nope]*[B,n_h,1,d_nope]
