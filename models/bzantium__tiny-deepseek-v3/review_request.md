...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 128 | `d_nope` | `d_nope`, `d_v`, `n_h`, `n_kv` | 3 | `[B, n_h, T, d_nope]` | 120 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_nope+d_rope]` | 108 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_rope/2]` | 108 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_rope/2]` | 108 |
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 0 | `[E]` | 90 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_nope]` | 84 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 0 | `[n_h, T, T]` | 84 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_nope+d_rope]` | 84 |
...
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope` | 2 | `[B, T, d_head]` | 52 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope` | 2 | `[B, 1, d_head]` | 52 |
...
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head]` | 42 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope` | 3 | `[B, n_h, T, d_head]` | 42 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head]` | 42 |
| `tie` | `model.layers.*.self_attn` | 64 | `d_head` | `d_head`, `d_rope` | 3 | `[B, n_h, 1, d_head]` | 42 |
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 0 | `[E, d_model]` | 42 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 0 | `[n_h, T, d_nope]` | 36 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_nope]` | 36 |
| `tie` | `model.layers.*.self_attn` | 128 | `d_nope` | `d_nope`, `d_v`, `n_h`, `n_kv` | 3 | `[B, n_h, 1, d_nope]` | 36 |
| `tie` | `model.layers.*.self_attn` | 128 | `n_h` | `d_nope`, `d_v`, `n_h`, `n_kv` | 0 | `[n_h, B, d_nope]` | 36 |
| `tie` | `model.layers.*.mlp.gate` | 2 | `n_grp` | `k_grp`, `n_grp` | 1 | `[T, n_grp]` | 30 |
| `tie` | `model.layers.*.mlp.gate` | 2 | `n_grp` | `k_grp`, `n_grp` | 1 | `[B, n_grp]` | 30 |
...
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 1 | `[B, E]` | 24 |
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 0 | `[E, d_moe]` | 24 |
| `tie` | `model.layers.*.mlp.gate` | 8 | `E` | `E`, `k` | 1 | `[T, E]` | 21 |
| `tie` | `model.layers.*.mlp.gate` | 8 | `E` | `E`, `k` | 1 | `[B, E]` | 21 |
| `tie` | `model.layers.*.mlp.gate` | 2 | `n_grp` | `k_grp`, `n_grp` | 1 | `[T, n_grp, E/n_grp]` | 18 |
| `tie` | `model.layers.*.mlp.gate` | 2 | `n_grp` | `k_grp`, `n_grp` | 1 | `[B, n_grp, E/n_grp]` | 18 |
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 1 | `[T, E]` | 15 |
| `tie` | `model.layers.*.mlp.experts` | 8 | `E` | `E`, `k` | 0 | `[E, B]` | 15 |
