...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.linear_attn` | 64 | `d_chunk` | `d_chunk`, `n_h_lin_v` | 2 | `[B, n_h_lin_v, d_chunk, d_head_lin_k]` | 24300 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, d_chunk]` | 11880 |
| `tie` | `model.layers.*.linear_attn` | 64 | `d_chunk` | `d_chunk`, `n_h_lin_v` | 3 | `[B, n_h_lin_v, 1, d_chunk]` | 11340 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, d_chunk, d_chunk]` | 9585 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, d_chunk, d_head_lin_k]` | 2880 |
...
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, d_chunk, d_head_lin_k]` | 1800 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_v` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, T, n_h_lin_v, d_head_lin_v]` | 1395 |
| `tie` | `model.layers.*.linear_attn` | 64 | `d_chunk` | `d_chunk`, `n_h_lin_v` | 2 | `[B, n_h_lin_v, d_chunk]` | 1395 |
...
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, d_chunk, d_head_lin_k]` | 1215 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 4 | `[B, T, n_h_lin_k, d_conv_lin, d_head_lin_k]` | 1080 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, d_head_lin_k, d_head_lin_v]` | 1080 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 4 | `[B, 1, n_h_lin_k, d_conv_lin, d_head_lin_k]` | 1080 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[d_model, n_h_lin_v]` | 990 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, T, d_head_lin_k]` | 900 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, T, d_head_lin_k]` | 900 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 2 | `[B, n_h_lin_v, d_head_lin_k]` | 900 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, d_head_lin_k]` | 855 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 2 | `[B, T, n_h_lin_v, d_head_lin_k]` | 810 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 0 | `[n_h_lin_v, d_chunk, d_chunk]` | 810 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 2 | `[B, 1, n_h_lin_v, d_head_lin_k]` | 810 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, d_head_lin_k]` | 810 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, d_chunk]` | 765 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, d_chunk, d_head_lin_v]` | 765 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, 1, d_head_lin_k]` | 765 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 1]` | 720 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 0 | `[n_h_lin_v, d_chunk, d_head_lin_v]` | 585 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 2 | `[B, T, n_h_lin_v, 1]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 2]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 3]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 4]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 5]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 6]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 7]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 8]` | 540 |
| `tie` | `model.layers.*.linear_attn` | 64 | `n_h_lin_v` | `d_chunk`, `n_h_lin_v` | 1 | `[B, n_h_lin_v, 1, 9]` | 540 |
...
```yaml
  ...
  - model: Qwen__Qwen3.5-397B-A17B
    module: 'linear_attn$'
    spread: class
    shape: ["B", "n_h_lin_v", "1", "d_chunk", "d_chunk"]
    axis: 1
    from: n_h_lin_v
    to: <소스가 말하는 이름>
    expect: 64
...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 11925 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 5895 |
...
| 모듈 | 정수 | 축 수 | 같은 값의 심볼 |
|---|---|---|---|
| `model.layers.*.linear_attn` | 64 | 5760 | `d_chunk`, `n_h_lin_v` |
...
### C. 모듈이 내는 출력 shape 전부 (93개 모듈 / 672종)
