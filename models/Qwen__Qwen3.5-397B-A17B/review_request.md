...
| `n_h_lin_v` | 64 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm`, `model.layers.*.linear_attn.in_proj_b`, `model.layers.*.linear_attn.in_proj_a` | 106110 |
| `d_chunk` | 64 | `model.layers.*.linear_attn` | 40680 |
