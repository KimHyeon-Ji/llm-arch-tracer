...
- `d_chunk vs n_h_lin_v` in `model.layers.*.linear_attn` — 값 64 를 두고 후보가 2개, 103815축
...
- `d_chunk vs n_h_lin_v` in `model.layers.*.linear_attn.norm` — 값 64 를 두고 후보가 2개, 1170축
- `d_chunk vs n_h_lin_v` in `model.layers.*.linear_attn.in_proj_b` — 값 64 를 두고 후보가 2개, 722축
- `d_chunk vs n_h_lin_v` in `model.layers.*.linear_attn.in_proj_a` — 값 64 를 두고 후보가 2개, 722축
...
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 6, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 7, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 8, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 9, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 10, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 11, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 12, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 13, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 14, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 15, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 16, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 17, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 18, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 19, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 20, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 21, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 22, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 23, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 24, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 25, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 26, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 27, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 28, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 29, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 30, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 31, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 32, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 33, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 34, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 35, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 36, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 37, 64]` | 90 |
| `tie` | `model.layers.*.linear_attn` | 64 | `64` | `d_chunk`, `n_h_lin_v` | 4 | `[B, n_h_lin_v, 1, 38, 64]` | 90 |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 88개 | 120315 |
| `n_h_lin_v` | 64 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm`, `model.layers.*.linear_attn.in_proj_b`, `model.layers.*.linear_attn.in_proj_a` | 106020 |
| `d_chunk` | 64 | `model.layers.*.linear_attn` | 40770 |
...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 9405 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 8415 |
...
| `d_shared` |  | `model.layers.*.mlp.shared_expert.gate_proj`, `model.layers.*.mlp.shared_expert.up_proj`, `model.layers.*.mlp.shared_expert.down_proj`, `model.layers.*.mlp.shared_expert` 외 1개 | 2760 |
...
| `n_kv*d_head` |  | `model.layers.*.self_attn.k_proj`, `model.layers.*.self_attn.v_proj`, `model.layers.*.self_attn` | 540 |
...
| `T+d_conv_lin-1` |  | `model.layers.*.linear_attn.conv1d`, `model.layers.*.linear_attn` | 90 |
| `2*d_head` |  | `model.layers.*.self_attn` | 60 |
...
| `model.layers.*.linear_attn` | 20 | 1260 | — |
...
### C. 모듈이 내는 출력 shape 전부 (93개 모듈 / 674종)
