...
|---|---|---|---|---|---|
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 8304 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 6144 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_v` | `d_head_lin_k`, `d_head_lin_v` | 4080 |
| `tie` | `model.layers.*.linear_attn.norm` | 128 | `d_head_lin_v` | `d_head_lin_k`, `d_head_lin_v` | 48 |
| `heur` | `model.layers.*.self_attn` | 512 | `2*d_head` | — | 32 |
...
| prefill | `model.layers.*.linear_attn` | exp | `[['B', 'n_h_lin_v', '1', 'd_rope', 'd_rope']]` | `None` | `[['B', 'n_h_lin_v', '1', 'd_rope', 'd_rope']]` |
...
| 모듈 | 정수 | 축 수 | 같은 값의 심볼 |
|---|---|---|---|
| `model.layers.*.linear_attn` | 64 | 6144 | `L` |
