...
- `2*d_head` in `model.layers.*.self_attn (레이어 12개)` — heur_multiple, 72축
...
- `d_head_lin_k vs d_head_lin_v` in `model.layers.*.linear_attn` — 값 128 를 두고 후보가 2개, 15120축
- `d_head_lin_k vs d_head_lin_v` in `model.layers.*.linear_attn.norm` — 값 128 를 두고 후보가 2개, 2018축
...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, T, n_h_lin_k, d_head_lin_k]` | 768 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, 1, n_h_lin_k, d_head_lin_k]` | 768 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 2 | `[B, n_h_lin_v, d_head_lin_k]` | 336 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, T, d_head_lin_k]` | 288 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, d_chunk, d_head_lin_k]` | 288 |
| `tie` | `model.layers.*.linear_attn` | 128 | `d_head_lin_k` | `d_head_lin_k`, `d_head_lin_v` | 3 | `[B, n_h_lin_v, 1, d_head_lin_k]` | 288 |
...
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 4, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 5, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 6, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 7, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 8, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 9, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 10, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 11, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 12, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 13, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 14, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 15, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 16, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 17, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 18, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 19, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 20, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 21, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 22, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 23, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 24, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 25, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 26, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 27, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 28, 64]` | 96 |
...
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 33, 64]` | 96 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 34, 64]` | 96 |
...
| prefill | `model.layers.*.linear_attn.conv1d` | conv1d | `[['B', '2*d_k_lin+d_v_lin', 'T'], ['2*d_k_lin+d_v_lin', '1', 'd_conv_lin']]` | `['2*d_k_lin+d_v_lin', '1', 'd_conv_lin']` | `[['B', '2*d_k_lin+d_v_lin', 'T+d_conv_lin-1']]` |
| prefill | `model.layers.*.linear_attn` | silu | `[['B', '2*d_k_lin+d_v_lin', 'T']]` | `None` | `[['B', '2*d_k_lin+d_v_lin', 'T']]` |
...
| decode | `model.layers.*.linear_attn` | conv1d | `[['B', '2*d_k_lin+d_v_lin', '5'], ['2*d_k_lin+d_v_lin', '1', 'd_conv_lin']]` | `None` | `[['B', '2*d_k_lin+d_v_lin', '2']]` |
| decode | `model.layers.*.linear_attn` | silu | `[['B', '2*d_k_lin+d_v_lin', '1']]` | `None` | `[['B', '2*d_k_lin+d_v_lin', '1']]` |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 88개 | 127232 |
...
| `T` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 87개 | 14642 |
...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 10032 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 8976 |
| `d_ff` | 17408 | `model.layers.*.mlp.gate_proj`, `model.layers.*.mlp.up_proj`, `model.layers.*.mlp.down_proj`, `model.layers.*.mlp` 외 1개 | 3712 |
| `d_head` | 256 | `model.layers.*.self_attn`, `model.layers.*.self_attn.q_norm`, `model.layers.*.self_attn.k_norm` | 3136 |
| `n_h` | 24 | `model.layers.*.self_attn`, `model.layers.*.self_attn.q_norm` | 3040 |
| `2*d_k_lin+d_v_lin` |  | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.in_proj_qkv`, `model.layers.*.linear_attn.conv1d` | 2976 |
| `n_kv` | 4 | `model.layers.*.self_attn`, `model.layers.*.self_attn.k_norm` | 2080 |
...
| `d_rope` | 64 | `model.layers.*.self_attn`, `model.rotary_emb` | 1050 |
| `d_conv_lin` | 4 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.conv1d` | 960 |
| `T+1` |  | `model.layers.*.self_attn`, `model` | 799 |
| `n_v/n_k` |  | `model.layers.*.linear_attn` | 768 |
| `n_kv*d_head` |  | `model.layers.*.self_attn.k_proj`, `model.layers.*.self_attn.v_proj`, `model.layers.*.self_attn` | 576 |
| `n_h*d_head` |  | `model.layers.*.self_attn.o_proj`, `model.layers.*.self_attn` | 480 |
| `d_rope/2` |  | `model.layers.*.self_attn`, `model.rotary_emb` | 444 |
| `n_k*d_k` |  | `model.layers.*.linear_attn` | 384 |
| `2*n_h*d_head` |  | `model.layers.*.self_attn.q_proj`, `model.layers.*.self_attn` | 288 |
| `n_h/n_kv` |  | `model.layers.*.self_attn` | 256 |
| `d_head-d_rope` |  | `model.layers.*.self_attn` | 128 |
| `T+d_conv_lin-1` |  | `model.layers.*.linear_attn.conv1d`, `model.layers.*.linear_attn` | 96 |
| `2*d_head` |  | `model.layers.*.self_attn` | 64 |
...
| `model.layers.*.linear_attn` | 3 | 1344 | — |
| `model.layers.*.linear_attn` | 4 | 1344 | `n_kv`, `d_conv_lin` |
| `model.layers.*.linear_attn` | 6 | 1344 | — |
| `model.layers.*.linear_attn` | 7 | 1344 | — |
| `model.layers.*.linear_attn` | 8 | 1344 | — |
| `model.layers.*.linear_attn` | 9 | 1344 | — |
| `model.layers.*.linear_attn` | 10 | 1344 | — |
| `model.layers.*.linear_attn` | 11 | 1344 | — |
| `model.layers.*.linear_attn` | 12 | 1344 | — |
| `model.layers.*.linear_attn` | 13 | 1344 | — |
| `model.layers.*.linear_attn` | 14 | 1344 | — |
| `model.layers.*.linear_attn` | 15 | 1344 | — |
| `model.layers.*.linear_attn` | 16 | 1344 | `n_h_lin_k` |
| `model.layers.*.linear_attn` | 17 | 1344 | — |
| `model.layers.*.linear_attn` | 18 | 1344 | — |
| `model.layers.*.linear_attn` | 19 | 1344 | — |
| `model.layers.*.linear_attn` | 20 | 1344 | — |
| `model.layers.*.linear_attn` | 21 | 1344 | — |
| `model.layers.*.linear_attn` | 22 | 1344 | — |
| `model.layers.*.linear_attn` | 23 | 1344 | — |
| `model.layers.*.linear_attn` | 24 | 1344 | `n_h` |
| `model.layers.*.linear_attn` | 25 | 1344 | — |
| `model.layers.*.linear_attn` | 26 | 1344 | — |
| `model.layers.*.linear_attn` | 27 | 1344 | — |
| `model.layers.*.linear_attn` | 28 | 1344 | — |
| `model.layers.*.linear_attn` | 29 | 1344 | — |
| `model.layers.*.linear_attn` | 30 | 1344 | — |
| `model.layers.*.linear_attn` | 31 | 1344 | — |
| `model.layers.*.linear_attn` | 32 | 1344 | — |
| `model.layers.*.linear_attn` | 33 | 1344 | — |
| `model.layers.*.linear_attn` | 34 | 1344 | — |
| `model.layers.*.linear_attn` | 35 | 1344 | — |
| `model.layers.*.linear_attn` | 36 | 1344 | — |
| `model.layers.*.linear_attn` | 37 | 1344 | — |
| `model.layers.*.linear_attn` | 38 | 1344 | — |
| `model.layers.*.linear_attn` | 39 | 1344 | — |
| `model.layers.*.linear_attn` | 40 | 1344 | — |
| `model.layers.*.linear_attn` | 41 | 1344 | — |
| `model.layers.*.linear_attn` | 42 | 1344 | — |
| `model.layers.*.linear_attn` | 43 | 1344 | — |
| `model.layers.*.linear_attn` | 44 | 1344 | — |
| `model.layers.*.linear_attn` | 45 | 1344 | — |
| `model.layers.*.linear_attn` | 46 | 1344 | — |
| `model.layers.*.linear_attn` | 47 | 1344 | — |
| `model.layers.*.linear_attn` | 48 | 1344 | `n_h_lin_v` |
| `model.layers.*.linear_attn` | 49 | 1344 | — |
| `model.layers.*.linear_attn` | 50 | 1344 | — |
| `model.layers.*.linear_attn` | 51 | 1344 | — |
| `model.layers.*.linear_attn` | 52 | 1344 | — |
| `model.layers.*.linear_attn` | 53 | 1344 | — |
| `model.layers.*.linear_attn` | 54 | 1344 | — |
| `model.layers.*.linear_attn` | 55 | 1344 | — |
| `model.layers.*.linear_attn` | 56 | 1344 | — |
| `model.layers.*.linear_attn` | 57 | 1344 | — |
| `model.layers.*.linear_attn` | 58 | 1344 | — |
| `model.layers.*.linear_attn` | 59 | 1344 | — |
| `model.layers.*.linear_attn` | 60 | 1344 | — |
| `model.layers.*.linear_attn` | 61 | 1344 | — |
| `model.layers.*.linear_attn` | 62 | 1344 | — |
| `model.layers.*.linear_attn` | 63 | 1344 | — |
...
### C. 모듈이 내는 출력 shape 전부 (92개 모듈 / 652종)
...
- `model.layers.*.linear_attn`
  - `[[2*d_k_lin+d_v_lin, 1, d_conv_lin]]`
...
- `model.layers.*.linear_attn.conv1d`
  - `[[B, 2*d_k_lin+d_v_lin, T+d_conv_lin-1]]`
