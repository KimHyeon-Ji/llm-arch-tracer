...
| 6144 | n_h·d_head (Q 투영 폭 / attention 출력 폭) | in_proj_z, linear_attn, o_proj, out_proj, self_attn |
...
```
  ...
  model                                              expand           [B,1,T] -> [n_kv,B,T]
  model                                              select           [n_kv,B,T] -> [B,T]
  model                                              slice            [n_kv,B,T] -> [3,B,T]
  ...
  model.layers.N.linear_attn.in_proj_z               t                [n_h*d_head,d_model] -> w=[n_h*d_head,d_model] [d_model,n_h*d_head]
  model.layers.N.linear_attn.in_proj_z               view             [B,T,d_model] -> [T,d_model]
  model.layers.N.linear_attn.in_proj_z               matmul           [T,d_model]*[d_model,n_h*d_head] -> w=[n_h*d_head,d_model] [T,n_h*d_head]
  model.layers.N.linear_attn.in_proj_z               _unsafe_view     [T,n_h*d_head] -> [B,T,n_h*d_head]
  ...
  model.layers.N.linear_attn                         constant_pad_nd  [B,2*d_k_lin+d_v_lin,T] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         zeros            [] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         slice            [B,2*d_k_lin+d_v_lin,n_kv] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         copy_            [B,2*d_k_lin+d_v_lin,n_kv]*[B,2*d_k_lin+d_v_lin,n_kv] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn.conv1d                  conv1d           [B,2*d_k_lin+d_v_lin,T]*[2*d_k_lin+d_v_lin,B,n_kv] -> w=[2*d_k_lin+d_v_lin,1,n_kv] [B,2*d_k_lin+d_v_lin,20]
  ...
  model.layers.N.linear_attn                         split_with_sizes [B,T,2*d_k_lin+d_v_lin] -> [B,T,2*n_kv*d_head]*[B,T,2*n_kv*d_head]*[B,T,n_h*d_head]
  model.layers.N.linear_attn                         view             [B,T,2*n_kv*d_head] -> [B,T,n_h_lin_k,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         expand           [B,T,n_h_lin_k,1,d_head_lin_k] -> [B,T,n_h_lin_k,3,d_head_lin_k]
  model.layers.N.linear_attn                         clone            [B,T,n_h_lin_k,3,d_head_lin_k] -> [B,T,n_h_lin_k,3,d_head_lin_k]
  model.layers.N.linear_attn                         view             [B,T,n_h_lin_k,3,d_head_lin_k] -> [B,T,n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         view             [B,n_h_lin_v,1,d_rope,d_head_lin_k] -> [n_h_lin_v,d_rope,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,1,d_rope,d_rope] -> [B,n_h_lin_v,1,1,d_rope]
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,1,1,d_rope] -> [B,n_h_lin_v,1,1,1]
  ...
  model.layers.N.self_attn                           slice            [B,n_h,T,d_rope] -> [B,n_h,T,n_h+2*n_kv]
  model.layers.N.self_attn                           neg              [B,n_h,T,n_h+2*n_kv] -> [B,n_h,T,n_h+2*n_kv]
  model.layers.N.self_attn                           concat           [B,n_h,T,n_h+2*n_kv]*[B,n_h,T,n_h+2*n_kv] -> [B,n_h,T,d_rope]
  ...
  model.layers.N.self_attn                           slice            [B,n_kv,T,d_rope] -> [B,n_kv,T,n_h+2*n_kv]
  model.layers.N.self_attn                           neg              [B,n_kv,T,n_h+2*n_kv] -> [B,n_kv,T,n_h+2*n_kv]
  model.layers.N.self_attn                           concat           [B,n_kv,T,n_h+2*n_kv]*[B,n_kv,T,n_h+2*n_kv] -> [B,n_kv,T,d_rope]
...
```
  ...
  model                                              expand           [B,1,1] -> [n_kv,B,1]
  model                                              select           [n_kv,B,1] -> [B,1]
  model                                              slice            [n_kv,B,1] -> [3,B,1]
  model.rotary_emb                                   unsqueeze        [d_rope/2] -> [B,d_rope/2]
  model.rotary_emb                                   unsqueeze        [B,d_rope/2] -> [B,1,d_rope/2]
  model.rotary_emb                                   unsqueeze        [B,1,d_rope/2] -> [B,1,d_rope/2,1]
  model.rotary_emb                                   expand           [B,1,d_rope/2,1] -> [3,B,d_rope/2,1]
  ...
  model.layers.N.linear_attn.in_proj_z               matmul           [B,d_model]*[d_model,n_h*d_head] -> w=[n_h*d_head,d_model] [B,n_h*d_head]
  model.layers.N.linear_attn.in_proj_z               _unsafe_view     [B,n_h*d_head] -> [B,1,n_h*d_head]
  ...
  model.layers.N.linear_attn                         squeeze          [2*d_k_lin+d_v_lin,B,n_kv] -> w=[2*d_k_lin+d_v_lin,1,n_kv] [2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         concat           [B,2*d_k_lin+d_v_lin,n_kv]*[B,2*d_k_lin+d_v_lin,1] -> [B,2*d_k_lin+d_v_lin,5]
  model.layers.N.linear_attn                         slice            [B,2*d_k_lin+d_v_lin,5] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         copy_            [B,2*d_k_lin+d_v_lin,n_kv]*[B,2*d_k_lin+d_v_lin,n_kv] -> [B,2*d_k_lin+d_v_lin,n_kv]
  model.layers.N.linear_attn                         unsqueeze        [2*d_k_lin+d_v_lin,n_kv] -> [2*d_k_lin+d_v_lin,B,n_kv]
  model.layers.N.linear_attn                         conv1d           [B,2*d_k_lin+d_v_lin,5]*[2*d_k_lin+d_v_lin,B,n_kv] -> [B,2*d_k_lin+d_v_lin,2]
  ...
  model.layers.N.linear_attn                         split_with_sizes [B,1,2*d_k_lin+d_v_lin] -> [B,1,2*n_kv*d_head]*[B,1,2*n_kv*d_head]*[B,1,n_h*d_head]
  model.layers.N.linear_attn                         view             [B,1,2*n_kv*d_head] -> [B,1,n_h_lin_k,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         expand           [B,1,n_h_lin_k,1,d_head_lin_k] -> [B,1,n_h_lin_k,3,d_head_lin_k]
  model.layers.N.linear_attn                         clone            [B,1,n_h_lin_k,3,d_head_lin_k] -> [B,1,n_h_lin_k,3,d_head_lin_k]
  model.layers.N.linear_attn                         view             [B,1,n_h_lin_k,3,d_head_lin_k] -> [B,1,n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,d_head_lin_k] -> [B,n_h_lin_v,1,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         transpose        [B,n_h_lin_v,1,d_head_lin_k] -> [B,1,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         _to_copy         [B,1,n_h_lin_v,d_head_lin_k] -> [B,1,n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         view             [B,1,n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         view             [n_h_lin_v,d_head_lin_k] -> [B,1,n_h*d_head]
  model.layers.N.linear_attn.out_proj                t                [d_model,n_h*d_head] -> w=[d_model,n_h*d_head] [n_h*d_head,d_model]
  model.layers.N.linear_attn.out_proj                view             [B,1,n_h*d_head] -> [B,n_h*d_head]
  ...
  model.layers.N.self_attn                           slice            [B,n_h,1,d_rope] -> [B,n_h,1,n_h+2*n_kv]
  model.layers.N.self_attn                           neg              [B,n_h,1,n_h+2*n_kv] -> [B,n_h,1,n_h+2*n_kv]
  model.layers.N.self_attn                           concat           [B,n_h,1,n_h+2*n_kv]*[B,n_h,1,n_h+2*n_kv] -> [B,n_h,1,d_rope]
  ...
  model.layers.N.self_attn                           slice            [B,n_kv,1,d_rope] -> [B,n_kv,1,n_h+2*n_kv]
  model.layers.N.self_attn                           neg              [B,n_kv,1,n_h+2*n_kv] -> [B,n_kv,1,n_h+2*n_kv]
  model.layers.N.self_attn                           concat           [B,n_kv,1,n_h+2*n_kv]*[B,n_kv,1,n_h+2*n_kv] -> [B,n_kv,1,d_rope]
