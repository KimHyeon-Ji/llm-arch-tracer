...
```
  ...
  model.layers.N.shared_transformer.self_attn.q_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.q_proj view             [B,B,d_attn] -> [B,n_h*d_head]
  ...
  model.layers.N.shared_transformer.self_attn.q_proj _unsafe_view     [B,n_h*d_head] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.k_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.k_proj view             [B,B,d_attn] -> [B,n_h*d_head]
  ...
  model.layers.N.shared_transformer.self_attn.k_proj _unsafe_view     [B,n_h*d_head] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.v_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.v_proj view             [B,B,d_attn] -> [B,n_h*d_head]
  ...
  model.layers.N.shared_transformer.self_attn.v_proj _unsafe_view     [B,n_h*d_head] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 t                [d_head,d_attn] -> w=[d_head,d_attn] [d_attn,d_head]
  ...
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 _unsafe_view     [B,d_head] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 view             [B,B,d_head] -> [B,d_head]
  ...
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 _unsafe_view     [B,d_head] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 view             [B,B,d_head] -> [B,d_head]
  ...
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 _unsafe_view     [B,d_head] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 view             [B,B,d_head] -> [B,d_head]
  ...
  model.layers.N.shared_transformer.self_attn.o_proj t                [d_model,d_attn] -> w=[d_model,d_attn] [d_attn,d_model]
  model.layers.N.shared_transformer.self_attn.o_proj view             [B,B,d_attn] -> [B,d_attn]
