...
| 4352 | d_inner + 2·n_g·d_state (Mamba causal conv1d 폭: x, B, C) | act, conv1d, mamba |
...
```
  ...
  model.layers.N.mamba.conv1d                        conv1d           [B,d_inner+2*n_g*d_state,T]*[d_inner+2*n_g*d_state,B,d_conv]*[d_inner+2*n_g*d_state] -> w=[d_inner+2*n_g*d_state,B,d_conv] [B,d_inner+2*n_g*d_state,T+d_conv-1]
  ...
  model.layers.N.mamba                               view             [B,T,d_state] -> [B,T,B,d_state]
  model.layers.N.mamba                               unsqueeze        [B,T,B,d_state] -> [B,T,B,B,d_state]
  model.layers.N.mamba                               expand           [B,T,B,B,d_state] -> [B,T,B,d_head_ssm,d_state]
  model.layers.N.mamba                               clone            [B,T,B,d_head_ssm,d_state] -> [B,T,B,d_head_ssm,d_state]
  model.layers.N.mamba                               view             [B,T,B,d_head_ssm,d_state] -> [B,T,d_head_ssm,d_state]
  model.layers.N.mamba                               unsqueeze        [d_head_ssm] -> [d_head_ssm,B]
  model.layers.N.mamba                               constant_pad_nd  [B,T,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               elementwise_mul  [d_head_ssm,B]*[B,2*d_state,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               unsqueeze        [B,T,d_head_ssm] -> [B,T,d_head_ssm,B]
  model.layers.N.mamba                               elementwise_mul  [B,T,d_head_ssm,n_h_ssm]*[B,T,d_head_ssm,B] -> [B,T,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               elementwise_mul  [d_head_ssm]*[B,T,d_head_ssm] -> [B,T,d_head_ssm]
  model.layers.N.mamba                               view             [B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               constant_pad_nd  [B,T,d_head_ssm] -> [B,2*d_state,d_head_ssm]
  model.layers.N.mamba                               view             [B,2*d_state,d_head_ssm] -> [B,B,2*d_state,d_head_ssm]
  model.layers.N.mamba                               constant_pad_nd  [B,T,d_head_ssm,d_state] -> [B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba                               view             [B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba                               permute          [B,B,2*d_state,d_head_ssm] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba                               cumsum           [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba                               unsqueeze        [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state,B]
  model.layers.N.mamba                               expand           [B,d_head_ssm,B,2*d_state,B] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba                               ones             [] -> [2*d_state,2*d_state]
  model.layers.N.mamba                               tril             [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mamba                               bitwise_not      [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mamba                               masked_fill      [B,d_head_ssm,B,2*d_state,2*d_state]*[2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba                               cumsum           [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba                               exp              [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba                               unsqueeze        [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,B,d_head_ssm,d_state]
  model.layers.N.mamba                               unsqueeze        [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba                               elementwise_mul  [B,B,2*d_state,B,d_head_ssm,d_state]*[B,B,B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba                               sum              [B,B,2*d_state,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba                               permute          [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba                               elementwise_mul  [B,B,2*d_state,2*d_state,d_head_ssm,B]*[B,B,2*d_state,2*d_state,d_head_ssm,B] -> [B,B,2*d_state,2*d_state,d_head_ssm,B]
  model.layers.N.mamba                               sum              [B,B,2*d_state,2*d_state,d_head_ssm,B] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba                               elementwise_mul  [B,B,2*d_state,2*d_state,d_head_ssm,B]*[B,B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               sum              [B,B,2*d_state,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               slice            [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,B]
  model.layers.N.mamba                               sub              [B,d_head_ssm,B,B]*[B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba                               exp              [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba                               permute          [B,d_head_ssm,B,2*d_state] -> [B,B,2*d_state,d_head_ssm]
  model.layers.N.mamba                               permute          [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,d_head_ssm,2*d_state,d_state]
  model.layers.N.mamba                               permute          [B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,d_head_ssm,2*d_state,n_h_ssm]
  model.layers.N.mamba                               sum              [B,B,d_head_ssm,2*d_state,d_state,n_h_ssm] -> [B,B,d_head_ssm,d_state,n_h_ssm]
  model.layers.N.mamba                               permute          [B,B,d_head_ssm,d_state,n_h_ssm] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               alias            [B,B,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               zeros_like       [B,B,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               concat           [B,B,d_head_ssm,n_h_ssm,d_state]*[B,B,d_head_ssm,n_h_ssm,d_state] -> [B,d_conv/2,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               select           [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B]
  model.layers.N.mamba                               constant_pad_nd  [B,d_head_ssm,B] -> [B,d_head_ssm,d_conv/2]
  model.layers.N.mamba                               expand           [B,d_head_ssm,d_conv/2,B] -> [B,d_head_ssm,d_conv/2,d_conv/2]
  ...
  model.layers.N.mamba                               slice            [B,d_conv/2,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               select           [B,d_conv/2,d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               sum              [B,B,2*d_state,d_head_ssm,n_h_ssm,d_state] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               elementwise_add  [B,B,2*d_state,d_head_ssm,n_h_ssm]*[B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               elementwise_add  [B,2*d_state,d_head_ssm,n_h_ssm]*[B,2*d_state,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               slice            [B,2*d_state,d_head_ssm,n_h_ssm] -> [B,T,d_head_ssm,n_h_ssm]
  ...
  model.layers.N.mamba.norm                          view             [B,T,d_inner] -> [B,T,B,d_inner]
  model.layers.N.mamba.norm                          pow              [B,T,B,d_inner] -> [B,T,B,d_inner]
  model.layers.N.mamba.norm                          mean             [B,T,B,d_inner] -> [B,T,B,B]
  model.layers.N.mamba.norm                          elementwise_add  [B,T,B,B] -> [B,T,B,B]
  model.layers.N.mamba.norm                          rsqrt            [B,T,B,B] -> [B,T,B,B]
  model.layers.N.mamba.norm                          elementwise_mul  [B,T,B,d_inner]*[B,T,B,B] -> [B,T,B,d_inner]
  model.layers.N.mamba.norm                          view             [B,T,B,d_inner] -> [B,T,d_inner]
  ...
  model.layers.N.shared_transformer.input_layernorm  mean             [B,T,d_attn] -> [B,T,B]
  model.layers.N.shared_transformer.input_layernorm  elementwise_add  [B,T,B] -> [B,T,B]
  model.layers.N.shared_transformer.input_layernorm  rsqrt            [B,T,B] -> [B,T,B]
  model.layers.N.shared_transformer.input_layernorm  elementwise_mul  [B,T,d_attn]*[B,T,B] -> [B,T,d_attn]
  ...
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 matmul           [T,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 _unsafe_view     [T,r_lora] -> [B,T,d_head]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 view             [B,T,d_head] -> [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 matmul           [T,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [T,d_attn]
  ...
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 matmul           [T,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 _unsafe_view     [T,r_lora] -> [B,T,d_head]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 view             [B,T,d_head] -> [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 matmul           [T,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [T,d_attn]
  ...
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 matmul           [T,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 _unsafe_view     [T,r_lora] -> [B,T,d_head]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 view             [B,T,d_head] -> [T,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 matmul           [T,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [T,d_attn]
  ...
  model.layers.N.shared_transformer.self_attn        unsqueeze        [B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.shared_transformer.self_attn        elementwise_mul  [B,n_h,T,d_head]*[B,B,T,d_head] -> [B,n_h,T,d_head]
  ...
  model.layers.N.shared_transformer.self_attn.o_proj view             [B,T,d_attn] -> [T,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.o_proj matmul           [T,n_h*d_head]*[d_attn,d_model] -> w=[d_model,d_attn] [T,d_model]
  ...
  model.layers.N.shared_transformer.pre_ff_layernorm mean             [B,T,d_model] -> [B,T,B]
  model.layers.N.shared_transformer.pre_ff_layernorm elementwise_add  [B,T,B] -> [B,T,B]
  model.layers.N.shared_transformer.pre_ff_layernorm rsqrt            [B,T,B] -> [B,T,B]
  model.layers.N.shared_transformer.pre_ff_layernorm elementwise_mul  [B,T,d_model]*[B,T,B] -> [B,T,d_model]
  ...
  model.layers.N.mamba_decoder.input_layernorm       mean             [B,T,d_model] -> [B,T,B]
  model.layers.N.mamba_decoder.input_layernorm       elementwise_add  [B,T,B] -> [B,T,B]
  model.layers.N.mamba_decoder.input_layernorm       rsqrt            [B,T,B] -> [B,T,B]
  model.layers.N.mamba_decoder.input_layernorm       elementwise_mul  [B,T,d_model]*[B,T,B] -> [B,T,d_model]
  ...
  model.layers.N.mamba_decoder.mamba.conv1d          conv1d           [B,d_inner+2*n_g*d_state,T]*[d_inner+2*n_g*d_state,B,d_conv]*[d_inner+2*n_g*d_state] -> w=[d_inner+2*n_g*d_state,B,d_conv] [B,d_inner+2*n_g*d_state,T+d_conv-1]
  ...
  model.layers.N.mamba_decoder.mamba                 view             [B,T,d_state] -> [B,T,B,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,T,B,d_state] -> [B,T,B,B,d_state]
  model.layers.N.mamba_decoder.mamba                 expand           [B,T,B,B,d_state] -> [B,T,B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 clone            [B,T,B,d_head_ssm,d_state] -> [B,T,B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 view             [B,T,B,d_head_ssm,d_state] -> [B,T,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [d_head_ssm] -> [d_head_ssm,B]
  model.layers.N.mamba_decoder.mamba                 constant_pad_nd  [B,T,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [d_head_ssm,B]*[B,2*d_state,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,T,d_head_ssm] -> [B,T,d_head_ssm,B]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,T,d_head_ssm,n_h_ssm]*[B,T,d_head_ssm,B] -> [B,T,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [d_head_ssm]*[B,T,d_head_ssm] -> [B,T,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 view             [B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 constant_pad_nd  [B,T,d_head_ssm] -> [B,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 view             [B,2*d_state,d_head_ssm] -> [B,B,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 constant_pad_nd  [B,T,d_head_ssm,d_state] -> [B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 view             [B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 permute          [B,B,2*d_state,d_head_ssm] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba_decoder.mamba                 cumsum           [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state,B]
  model.layers.N.mamba_decoder.mamba                 expand           [B,d_head_ssm,B,2*d_state,B] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 ones             [] -> [2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 tril             [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 bitwise_not      [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 masked_fill      [B,d_head_ssm,B,2*d_state,2*d_state]*[2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 cumsum           [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 exp              [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,d_head_ssm,B,2*d_state,2*d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,B,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,B,2*d_state,B,d_head_ssm,d_state]*[B,B,B,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 sum              [B,B,2*d_state,2*d_state,d_head_ssm,d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 permute          [B,d_head_ssm,B,2*d_state,2*d_state] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,B,2*d_state,2*d_state,d_head_ssm,B]*[B,B,2*d_state,2*d_state,d_head_ssm,B] -> [B,B,2*d_state,2*d_state,d_head_ssm,B]
  model.layers.N.mamba_decoder.mamba                 sum              [B,B,2*d_state,2*d_state,d_head_ssm,B] -> [B,B,2*d_state,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,B,2*d_state,2*d_state,d_head_ssm,B]*[B,B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 sum              [B,B,2*d_state,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 slice            [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,B]
  model.layers.N.mamba_decoder.mamba                 sub              [B,d_head_ssm,B,B]*[B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba_decoder.mamba                 exp              [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B,2*d_state]
  model.layers.N.mamba_decoder.mamba                 permute          [B,d_head_ssm,B,2*d_state] -> [B,B,2*d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 permute          [B,B,2*d_state,d_head_ssm,d_state] -> [B,B,d_head_ssm,2*d_state,d_state]
  model.layers.N.mamba_decoder.mamba                 permute          [B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,d_head_ssm,2*d_state,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 sum              [B,B,d_head_ssm,2*d_state,d_state,n_h_ssm] -> [B,B,d_head_ssm,d_state,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 permute          [B,B,d_head_ssm,d_state,n_h_ssm] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 alias            [B,B,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 zeros_like       [B,B,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 concat           [B,B,d_head_ssm,n_h_ssm,d_state]*[B,B,d_head_ssm,n_h_ssm,d_state] -> [B,d_conv/2,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 select           [B,d_head_ssm,B,2*d_state] -> [B,d_head_ssm,B]
  model.layers.N.mamba_decoder.mamba                 constant_pad_nd  [B,d_head_ssm,B] -> [B,d_head_ssm,d_conv/2]
  model.layers.N.mamba_decoder.mamba                 expand           [B,d_head_ssm,d_conv/2,B] -> [B,d_head_ssm,d_conv/2,d_conv/2]
  ...
  model.layers.N.mamba_decoder.mamba                 slice            [B,d_conv/2,d_head_ssm,n_h_ssm,d_state] -> [B,B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 select           [B,d_conv/2,d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 sum              [B,B,2*d_state,d_head_ssm,n_h_ssm,d_state] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_add  [B,B,2*d_state,d_head_ssm,n_h_ssm]*[B,B,2*d_state,d_head_ssm,n_h_ssm] -> [B,B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_add  [B,2*d_state,d_head_ssm,n_h_ssm]*[B,2*d_state,d_head_ssm,n_h_ssm] -> [B,2*d_state,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 slice            [B,2*d_state,d_head_ssm,n_h_ssm] -> [B,T,d_head_ssm,n_h_ssm]
  ...
  model.layers.N.mamba_decoder.mamba.norm            view             [B,T,d_inner] -> [B,T,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            pow              [B,T,B,d_inner] -> [B,T,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            mean             [B,T,B,d_inner] -> [B,T,B,B]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_add  [B,T,B,B] -> [B,T,B,B]
  model.layers.N.mamba_decoder.mamba.norm            rsqrt            [B,T,B,B] -> [B,T,B,B]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_mul  [B,T,B,d_inner]*[B,T,B,B] -> [B,T,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            view             [B,T,B,d_inner] -> [B,T,d_inner]
  ...
  model.final_layernorm                              mean             [B,T,d_model] -> [B,T,B]
  model.final_layernorm                              elementwise_add  [B,T,B] -> [B,T,B]
  model.final_layernorm                              rsqrt            [B,T,B] -> [B,T,B]
  model.final_layernorm                              elementwise_mul  [B,T,d_model]*[B,T,B] -> [B,T,d_model]
...
```
  ...
  model                                              clone            [B,B,d_model] -> [B,B,d_model]
  model.rotary_emb                                   unsqueeze        [d_head/2] -> [B,d_head/2]
  model.rotary_emb                                   unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  model.rotary_emb                                   expand           [B,d_head/2,B] -> [B,d_head/2,B]
  ...
  model.layers.N.mamba.in_proj                       t                [2*d_inner+2*n_g*d_state+n_h_ssm,d_model] -> w=[2*d_inner+2*n_g*d_state+n_h_ssm,d_model] [d_model,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mamba.in_proj                       view             [B,B,d_model] -> [B,d_model]
  ...
  model.layers.N.mamba.in_proj                       _unsafe_view     [B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mamba                               split_with_sizes [B,B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,0]*[B,B,0]*[B,B,d_inner]*[B,B,d_inner+2*n_g*d_state]*[B,B,d_head_ssm]
  model.layers.N.mamba                               transpose        [B,B,d_inner+2*n_g*d_state] -> [B,d_inner+2*n_g*d_state,B]
  model.layers.N.mamba                               concat           [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,B] -> [B,d_inner+2*n_g*d_state,5]
  model.layers.N.mamba                               slice            [B,d_inner+2*n_g*d_state,5] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mamba                               copy_            [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,d_conv] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mamba                               select           [d_inner+2*n_g*d_state,B,d_conv] -> w=[d_inner+2*n_g*d_state,B,d_conv] [d_inner+2*n_g*d_state,d_conv]
  ...
  model.layers.N.mamba                               unsqueeze        [B,d_inner+2*n_g*d_state] -> [B,B,d_inner+2*n_g*d_state]
  model.layers.N.mamba                               split_with_sizes [B,B,d_inner+2*n_g*d_state] -> [B,B,d_inner]*[B,B,d_state]*[B,B,d_state]
  model.layers.N.mamba                               exp              [d_head_ssm] -> [d_head_ssm]
  model.layers.N.mamba                               neg              [d_head_ssm] -> [d_head_ssm]
  model.layers.N.mamba                               select           [B,B,d_head_ssm] -> [B,d_head_ssm]
  model.layers.N.mamba                               unsqueeze        [B,d_head_ssm] -> [B,B,d_head_ssm]
  model.layers.N.mamba                               transpose        [B,B,d_head_ssm] -> [B,d_head_ssm,B]
  model.layers.N.mamba                               expand           [B,d_head_ssm,B] -> [B,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               unsqueeze        [d_head_ssm] -> [d_head_ssm,B]
  ...
  model.layers.N.mamba                               unsqueeze        [d_head_ssm,B] -> [d_head_ssm,B,B]
  model.layers.N.mamba                               expand           [d_head_ssm,B,B] -> [d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               unsqueeze        [B,d_head_ssm,n_h_ssm] -> [B,d_head_ssm,n_h_ssm,B]
  model.layers.N.mamba                               elementwise_mul  [B,d_head_ssm,n_h_ssm,B]*[d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               exp              [B,d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               view             [B,B,d_state] -> [B,B,d_state]
  model.layers.N.mamba                               unsqueeze        [B,B,d_state] -> [B,B,B,d_state]
  model.layers.N.mamba                               expand           [B,B,B,d_state] -> [B,B,d_head_ssm,d_state]
  model.layers.N.mamba                               clone            [B,B,d_head_ssm,d_state] -> [B,B,d_head_ssm,d_state]
  model.layers.N.mamba                               view             [B,B,d_head_ssm,d_state] -> [B,d_head_ssm,d_state]
  model.layers.N.mamba                               elementwise_mul  [B,d_head_ssm,n_h_ssm,B]*[B,d_head_ssm,B,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba                               view             [B,B,d_inner] -> [B,d_head_ssm,n_h_ssm]
  model.layers.N.mamba                               elementwise_mul  [B,d_head_ssm,n_h_ssm,d_state]*[B,d_head_ssm,n_h_ssm,B] -> [B,d_head_ssm,n_h_ssm,d_state]
  ...
  model.layers.N.mamba.norm                          silu             [B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba.norm                          elementwise_mul  [B,B,d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba.norm                          view             [B,B,d_inner] -> [B,B,B,d_inner]
  model.layers.N.mamba.norm                          pow              [B,B,B,d_inner] -> [B,B,B,d_inner]
  model.layers.N.mamba.norm                          mean             [B,B,B,d_inner] -> [B,B,B,B]
  model.layers.N.mamba.norm                          elementwise_add  [B,B,B,B] -> [B,B,B,B]
  model.layers.N.mamba.norm                          rsqrt            [B,B,B,B] -> [B,B,B,B]
  model.layers.N.mamba.norm                          elementwise_mul  [B,B,B,d_inner]*[B,B,B,B] -> [B,B,B,d_inner]
  model.layers.N.mamba.norm                          view             [B,B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba.norm                          elementwise_mul  [d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba.out_proj                      t                [d_model,d_inner] -> w=[d_model,d_inner] [d_inner,d_model]
  model.layers.N.mamba.out_proj                      view             [B,B,d_inner] -> [B,d_inner]
  model.layers.N.mamba.out_proj                      matmul           [B,d_inner]*[d_inner,d_model] -> w=[d_model,d_inner] [B,d_model]
  model.layers.N.mamba.out_proj                      _unsafe_view     [B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.shared_transformer                  concat           [B,B,d_model]*[B,B,d_model] -> [B,B,d_attn]
  model.layers.N.shared_transformer.input_layernorm  pow              [B,B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.input_layernorm  mean             [B,B,d_attn] -> [B,B,B]
  model.layers.N.shared_transformer.input_layernorm  elementwise_add  [B,B,B] -> [B,B,B]
  model.layers.N.shared_transformer.input_layernorm  rsqrt            [B,B,B] -> [B,B,B]
  model.layers.N.shared_transformer.input_layernorm  elementwise_mul  [B,B,d_attn]*[B,B,B] -> [B,B,d_attn]
  model.layers.N.shared_transformer.input_layernorm  elementwise_mul  [d_attn]*[B,B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.q_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.q_proj view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.q_proj matmul           [B,d_attn]*[d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.q_proj _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.k_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.k_proj view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.k_proj matmul           [B,d_attn]*[d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.k_proj _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.v_proj t                [d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [d_attn,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.v_proj view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.v_proj matmul           [B,d_attn]*[d_attn,n_h*d_head] -> w=[n_h*d_head,d_attn] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.v_proj _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 t                [d_head,d_attn] -> w=[d_head,d_attn] [d_attn,d_head]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 matmul           [B,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.0 _unsafe_view     [B,r_lora] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 view             [B,B,d_head] -> [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 matmul           [B,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_q_adapter_list.N.1 _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn        elementwise_add  [B,B,d_attn]*[B,B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 t                [d_head,d_attn] -> w=[d_head,d_attn] [d_attn,d_head]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 matmul           [B,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.0 _unsafe_view     [B,r_lora] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 view             [B,B,d_head] -> [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 matmul           [B,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_k_adapter_list.N.1 _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 t                [d_head,d_attn] -> w=[d_head,d_attn] [d_attn,d_head]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 view             [B,B,d_attn] -> [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 matmul           [B,d_attn]*[d_attn,d_head] -> w=[d_head,d_attn] [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.0 _unsafe_view     [B,r_lora] -> [B,B,d_head]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 t                [d_attn,d_head] -> w=[d_attn,d_head] [d_head,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 view             [B,B,d_head] -> [B,r_lora]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 matmul           [B,r_lora]*[d_head,d_attn] -> w=[d_attn,d_head] [B,d_attn]
  model.layers.N.shared_transformer.self_attn.linear_v_adapter_list.N.1 _unsafe_view     [B,d_attn] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn        view             [B,B,d_attn] -> [B,B,n_h,d_head]
  model.layers.N.shared_transformer.self_attn        transpose        [B,B,n_h,d_head] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        unsqueeze        [B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.shared_transformer.self_attn        elementwise_mul  [B,n_h,B,d_head]*[B,B,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        slice            [B,n_h,B,d_head] -> [B,n_h,B,d_head/2]
  model.layers.N.shared_transformer.self_attn        neg              [B,n_h,B,d_head/2] -> [B,n_h,B,d_head/2]
  model.layers.N.shared_transformer.self_attn        concat           [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        elementwise_add  [B,n_h,B,d_head]*[B,n_h,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        concat           [B,n_h,T,d_head]*[B,n_h,B,d_head] -> [B,n_h,T+1,d_head]
  model.layers.N.shared_transformer.self_attn        elementwise_mul  [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  ...
  model.layers.N.shared_transformer.self_attn        expand           [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        view             [B,n_h,B,d_head] -> [n_h,B,d_head]
  ...
  model.layers.N.shared_transformer.self_attn        _unsafe_view     [n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.shared_transformer.self_attn        softmax          [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.shared_transformer.self_attn        expand           [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.shared_transformer.self_attn        view             [B,n_h,B,T+1] -> [n_h,B,T+1]
  ...
  model.layers.N.shared_transformer.self_attn        _unsafe_view     [n_h,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.shared_transformer.self_attn        transpose        [B,n_h,B,d_head] -> [B,B,n_h,d_head]
  model.layers.N.shared_transformer.self_attn        view             [B,B,n_h,d_head] -> [B,B,d_attn]
  model.layers.N.shared_transformer.self_attn.o_proj t                [d_model,d_attn] -> w=[d_model,d_attn] [d_attn,d_model]
  model.layers.N.shared_transformer.self_attn.o_proj view             [B,B,d_attn] -> [B,n_h*d_head]
  model.layers.N.shared_transformer.self_attn.o_proj matmul           [B,n_h*d_head]*[d_attn,d_model] -> w=[d_model,d_attn] [B,d_model]
  model.layers.N.shared_transformer.self_attn.o_proj _unsafe_view     [B,d_model] -> [B,B,d_model]
  model.layers.N.shared_transformer.pre_ff_layernorm pow              [B,B,d_model] -> [B,B,d_model]
  model.layers.N.shared_transformer.pre_ff_layernorm mean             [B,B,d_model] -> [B,B,B]
  model.layers.N.shared_transformer.pre_ff_layernorm elementwise_add  [B,B,B] -> [B,B,B]
  model.layers.N.shared_transformer.pre_ff_layernorm rsqrt            [B,B,B] -> [B,B,B]
  model.layers.N.shared_transformer.pre_ff_layernorm elementwise_mul  [B,B,d_model]*[B,B,B] -> [B,B,d_model]
  model.layers.N.shared_transformer.pre_ff_layernorm elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj t                [2*d_ff,d_model] -> w=[2*d_ff,d_model] [d_model,2*d_ff]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj view             [B,B,d_model] -> [B,d_model]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj matmul           [B,d_model]*[d_model,2*d_ff] -> w=[2*d_ff,d_model] [B,2*d_ff]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj _unsafe_view     [B,2*d_ff] -> [B,B,2*d_ff]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.0 t                [r_lora,d_model] -> w=[r_lora,d_model] [d_model,r_lora]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.0 view             [B,B,d_model] -> [B,d_model]
  ...
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.0 _unsafe_view     [B,r_lora] -> [B,B,r_lora]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.1 t                [2*d_ff,r_lora] -> w=[2*d_ff,r_lora] [r_lora,2*d_ff]
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.1 view             [B,B,r_lora] -> [B,r_lora]
  ...
  model.layers.N.shared_transformer.feed_forward.gate_up_proj_adapter_list.N.1 _unsafe_view     [B,2*d_ff] -> [B,B,2*d_ff]
  model.layers.N.shared_transformer.feed_forward     elementwise_add  [B,B,2*d_ff]*[B,B,2*d_ff] -> [B,B,2*d_ff]
  model.layers.N.shared_transformer.feed_forward     split            [B,B,2*d_ff] -> [B,B,d_ff]*[B,B,d_ff]
  model.layers.N.shared_transformer.feed_forward.act_fn gelu             [B,B,d_ff] -> [B,B,d_ff]
  model.layers.N.shared_transformer.feed_forward     elementwise_mul  [B,B,d_ff]*[B,B,d_ff] -> [B,B,d_ff]
  model.layers.N.shared_transformer.feed_forward.down_proj t                [d_model,d_ff] -> w=[d_model,d_ff] [d_ff,d_model]
  model.layers.N.shared_transformer.feed_forward.down_proj view             [B,B,d_ff] -> [B,d_ff]
  model.layers.N.shared_transformer.feed_forward.down_proj matmul           [B,d_ff]*[d_ff,d_model] -> w=[d_model,d_ff] [B,d_model]
  model.layers.N.shared_transformer.feed_forward.down_proj _unsafe_view     [B,d_model] -> [B,B,d_model]
  model.layers.N.linear                              t                [d_model,d_model] -> w=[d_model,d_model] [d_model,d_model]
  model.layers.N.linear                              view             [B,B,d_model] -> [B,d_model]
  model.layers.N.linear                              matmul           [B,d_model]*[d_model,d_model] -> w=[d_model,d_model] [B,d_model]
  model.layers.N.linear                              _unsafe_view     [B,d_model] -> [B,B,d_model]
  model.layers.N.mamba_decoder                       elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.N.mamba_decoder.input_layernorm       pow              [B,B,d_model] -> [B,B,d_model]
  model.layers.N.mamba_decoder.input_layernorm       mean             [B,B,d_model] -> [B,B,B]
  model.layers.N.mamba_decoder.input_layernorm       elementwise_add  [B,B,B] -> [B,B,B]
  model.layers.N.mamba_decoder.input_layernorm       rsqrt            [B,B,B] -> [B,B,B]
  model.layers.N.mamba_decoder.input_layernorm       elementwise_mul  [B,B,d_model]*[B,B,B] -> [B,B,d_model]
  model.layers.N.mamba_decoder.input_layernorm       elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.N.mamba_decoder.mamba.in_proj         t                [2*d_inner+2*n_g*d_state+n_h_ssm,d_model] -> w=[2*d_inner+2*n_g*d_state+n_h_ssm,d_model] [d_model,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mamba_decoder.mamba.in_proj         view             [B,B,d_model] -> [B,d_model]
  ...
  model.layers.N.mamba_decoder.mamba.in_proj         _unsafe_view     [B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 split_with_sizes [B,B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,0]*[B,B,0]*[B,B,d_inner]*[B,B,d_inner+2*n_g*d_state]*[B,B,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 transpose        [B,B,d_inner+2*n_g*d_state] -> [B,d_inner+2*n_g*d_state,B]
  model.layers.N.mamba_decoder.mamba                 concat           [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,B] -> [B,d_inner+2*n_g*d_state,5]
  model.layers.N.mamba_decoder.mamba                 slice            [B,d_inner+2*n_g*d_state,5] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mamba_decoder.mamba                 copy_            [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,d_conv] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mamba_decoder.mamba                 select           [d_inner+2*n_g*d_state,B,d_conv] -> w=[d_inner+2*n_g*d_state,B,d_conv] [d_inner+2*n_g*d_state,d_conv]
  ...
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,d_inner+2*n_g*d_state] -> [B,B,d_inner+2*n_g*d_state]
  model.layers.N.mamba_decoder.mamba                 split_with_sizes [B,B,d_inner+2*n_g*d_state] -> [B,B,d_inner]*[B,B,d_state]*[B,B,d_state]
  model.layers.N.mamba_decoder.mamba                 exp              [d_head_ssm] -> [d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 neg              [d_head_ssm] -> [d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 select           [B,B,d_head_ssm] -> [B,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,d_head_ssm] -> [B,B,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 transpose        [B,B,d_head_ssm] -> [B,d_head_ssm,B]
  model.layers.N.mamba_decoder.mamba                 expand           [B,d_head_ssm,B] -> [B,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [d_head_ssm] -> [d_head_ssm,B]
  ...
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [d_head_ssm,B] -> [d_head_ssm,B,B]
  model.layers.N.mamba_decoder.mamba                 expand           [d_head_ssm,B,B] -> [d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,d_head_ssm,n_h_ssm] -> [B,d_head_ssm,n_h_ssm,B]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,d_head_ssm,n_h_ssm,B]*[d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 exp              [B,d_head_ssm,n_h_ssm,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 view             [B,B,d_state] -> [B,B,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,B,d_state] -> [B,B,B,d_state]
  model.layers.N.mamba_decoder.mamba                 expand           [B,B,B,d_state] -> [B,B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 clone            [B,B,d_head_ssm,d_state] -> [B,B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 view             [B,B,d_head_ssm,d_state] -> [B,d_head_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,d_head_ssm,n_h_ssm,B]*[B,d_head_ssm,B,d_state] -> [B,d_head_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 view             [B,B,d_inner] -> [B,d_head_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,d_head_ssm,n_h_ssm,d_state]*[B,d_head_ssm,n_h_ssm,B] -> [B,d_head_ssm,n_h_ssm,d_state]
  ...
  model.layers.N.mamba_decoder.mamba.norm            silu             [B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_mul  [B,B,d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            view             [B,B,d_inner] -> [B,B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            pow              [B,B,B,d_inner] -> [B,B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            mean             [B,B,B,d_inner] -> [B,B,B,B]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_add  [B,B,B,B] -> [B,B,B,B]
  model.layers.N.mamba_decoder.mamba.norm            rsqrt            [B,B,B,B] -> [B,B,B,B]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_mul  [B,B,B,d_inner]*[B,B,B,B] -> [B,B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            view             [B,B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.norm            elementwise_mul  [d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mamba_decoder.mamba.out_proj        t                [d_model,d_inner] -> w=[d_model,d_inner] [d_inner,d_model]
  model.layers.N.mamba_decoder.mamba.out_proj        view             [B,B,d_inner] -> [B,d_inner]
  model.layers.N.mamba_decoder.mamba.out_proj        matmul           [B,d_inner]*[d_inner,d_model] -> w=[d_model,d_inner] [B,d_model]
  model.layers.N.mamba_decoder.mamba.out_proj        _unsafe_view     [B,d_model] -> [B,B,d_model]
  ...
  model.final_layernorm                              pow              [B,B,d_model] -> [B,B,d_model]
  model.final_layernorm                              mean             [B,B,d_model] -> [B,B,B]
  model.final_layernorm                              elementwise_add  [B,B,B] -> [B,B,B]
  model.final_layernorm                              rsqrt            [B,B,B] -> [B,B,B]
  model.final_layernorm                              elementwise_mul  [B,B,d_model]*[B,B,B] -> [B,B,d_model]
  model.final_layernorm                              elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
