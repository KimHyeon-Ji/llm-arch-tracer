...
```
  ...
  model.layers.N.shared_transformer.self_attn        transpose        [B,n_kv,T,d_head] -> [B,n_kv,d_head,T]
  ...
  model.layers.N.shared_transformer.self_attn        expand           [B,n_kv,d_head,T] -> [B,n_kv,d_head,T]
  model.layers.N.shared_transformer.self_attn        view             [B,n_kv,d_head,T] -> [n_kv,d_head,T]
  model.layers.N.shared_transformer.self_attn        batched_matmul   [n_h,T,d_head]*[n_kv,d_head,T] -> [n_h,T,T]
  ...
  model.layers.N.mamba_decoder.mamba                 sum              [B,1,d_head_ssm,d_chunk,d_state,n_h_ssm] -> [B,1,n_h_ssm,d_state,d_head_ssm]
  model.layers.N.mamba_decoder.mamba                 permute          [B,1,n_h_ssm,d_state,d_head_ssm] -> [B,1,n_h_ssm,d_head_ssm,d_state]
  ...
  model.layers.N.mamba_decoder.mamba                 constant_pad_nd  [B,n_h_ssm,1] -> [B,n_h_ssm,2]
  model.layers.N.mamba_decoder.mamba                 expand           [B,n_h_ssm,2,1] -> [B,n_h_ssm,2,2]
  ...
  model.layers.N.mamba_decoder.mamba                 sum              [B,d_head_ssm,2,2,n_h_ssm,d_state] -> [B,n_h_ssm,2,d_head_ssm,d_state]
...
```
  ...
  model.layers.N.shared_transformer.self_attn        transpose        [B,n_kv,T+1,d_head] -> [B,n_kv,d_head,T+1]
  ...
  model.layers.N.shared_transformer.self_attn        expand           [B,n_kv,d_head,T+1] -> [B,n_kv,d_head,T+1]
  model.layers.N.shared_transformer.self_attn        view             [B,n_kv,d_head,T+1] -> [n_kv,d_head,T+1]
  model.layers.N.shared_transformer.self_attn        batched_matmul   [n_h,B,d_head]*[n_kv,d_head,T+1] -> [n_h,B,T+1]
  ...
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [n_h_ssm] -> [n_h_ssm,1]
  model.layers.N.mamba_decoder.mamba                 expand           [n_h_ssm,1] -> [n_h_ssm,n_h_ssm]
  model.layers.N.mamba_decoder.mamba                 elementwise_add  [B,n_h_ssm,d_head_ssm]*[n_h_ssm,n_h_ssm] -> [B,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mamba_decoder.mamba                 expand           [n_h_ssm,1,1] -> [n_h_ssm,n_h_ssm,d_state]
  model.layers.N.mamba_decoder.mamba                 unsqueeze        [B,n_h_ssm,d_head_ssm] -> [B,n_h_ssm,d_head_ssm,1]
  model.layers.N.mamba_decoder.mamba                 elementwise_mul  [B,n_h_ssm,d_head_ssm,1]*[n_h_ssm,n_h_ssm,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
