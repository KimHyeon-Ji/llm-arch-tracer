...
|---|---|---|---|---|---|---|---|
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head]` | 1600 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head]` | 1216 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 0 | `[n_h, T, T]` | 448 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, T, d_head/2]` | 384 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, 1, d_head/2]` | 384 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, T+1, d_head]` | 384 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 0 | `[n_h, B, T+1]` | 384 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 2 | `[B, T, n_h, d_head]` | 320 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 1 | `[B, n_h, d_head, T]` | 256 |
| `tie` | `model.layers.*.self_attn` | 32 | `n_h` | `n_h`, `n_kv` | 2 | `[B, 1, n_h, d_head]` | 256 |
