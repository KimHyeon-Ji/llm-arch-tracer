...
| prefill | `model.layers.*.self_attn.q_proj` | matmul | `[['T', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['T', 'n_h*d_head']]` |
| prefill | `model.layers.*.self_attn.q_norm` | rmsnorm | `[['B', 'T', 'n_h*d_head']]` | `['n_h*d_head']` | `[['B', 'T', 'n_h*d_head']]` |
| prefill | `model.layers.*.self_attn.k_proj` | matmul | `[['T', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['T', 'n_h*d_head']]` |
| prefill | `model.layers.*.self_attn.k_norm` | rmsnorm | `[['B', 'T', 'n_h*d_head']]` | `['n_h*d_head']` | `[['B', 'T', 'n_h*d_head']]` |
| prefill | `model.layers.*.self_attn.v_proj` | matmul | `[['T', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['T', 'n_h*d_head']]` |
...
| decode | `model.layers.*.self_attn.q_proj` | matmul | `[['B', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['B', 'n_h*d_head']]` |
| decode | `model.layers.*.self_attn.q_norm` | rmsnorm | `[['B', '1', 'n_h*d_head']]` | `['n_h*d_head']` | `[['B', '1', 'n_h*d_head']]` |
| decode | `model.layers.*.self_attn.k_proj` | matmul | `[['B', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['B', 'n_h*d_head']]` |
| decode | `model.layers.*.self_attn.k_norm` | rmsnorm | `[['B', '1', 'n_h*d_head']]` | `['n_h*d_head']` | `[['B', '1', 'n_h*d_head']]` |
| decode | `model.layers.*.self_attn.v_proj` | matmul | `[['B', 'n_h*d_head'], ['n_h*d_head', 'n_h*d_head']]` | `['n_h*d_head', 'n_h*d_head']` | `[['B', 'n_h*d_head']]` |
...
| `n_h*d_head` |  | `model.layers.*.self_attn.q_proj`, `model.layers.*.self_attn.k_proj`, `model.layers.*.self_attn.v_proj`, `model.layers.*.self_attn.o_proj` 외 3개 | 5888 |
| `d_head` | 128 | `model.layers.*.self_attn`, `model.rotary_emb` | 5266 |
| `d_model` | 4096 | `model.layers.*.post_attention_layernorm`, `model.layers.*.post_feedforward_layernorm`, `model.layers.*.mlp.gate_proj`, `model.layers.*.mlp.up_proj` 외 37개 | 3506 |
...
### C. 모듈이 내는 출력 shape 전부 (51개 모듈 / 173종)
