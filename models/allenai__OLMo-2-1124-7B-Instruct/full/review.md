...
```
  ...
  model.layers.N.self_attn.q_proj                    view             [B,T,n_h*d_head] -> [T,n_h*d_head]
  model.layers.N.self_attn.k_proj                    view             [B,T,n_h*d_head] -> [T,n_h*d_head]
  model.layers.N.self_attn.v_proj                    view             [B,T,n_h*d_head] -> [T,n_h*d_head]
...
```
  ...
  model.layers.N.self_attn.q_proj                    view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  model.layers.N.self_attn.k_proj                    view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  model.layers.N.self_attn.v_proj                    view             [B,B,n_h*d_head] -> [B,n_h*d_head]
