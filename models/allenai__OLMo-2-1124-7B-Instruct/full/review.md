...
C14  PASS   used=16 >= required=16
C15  PASS   all discovered entrypoints traced
C16  INFO   2161 unmapped rows, 14 distinct raw ops: ['aten._to_copy.default', 'aten._unsafe_view.default', 'aten.alias.default', 'aten.clone.default', 'aten.expand.default', 'aten.ones.default', 'aten.scalar_tensor.default', 'aten.slice.Tensor', 'aten.t.default', 'aten.transpose.int']
C17  PASS   유도 상수 전부 설명됨, 구조 라이브러리에 등재됨
...
```
  ...
  model.layers.N.self_attn.q_proj                    view             [B,T,n_h*d_head] -> [T,d_model]
  ...
  model.layers.N.self_attn.k_proj                    view             [B,T,n_h*d_head] -> [T,d_model]
  ...
  model.layers.N.self_attn.v_proj                    view             [B,T,n_h*d_head] -> [T,d_model]
...
```
  ...
  model.layers.N.self_attn.q_proj                    t                [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
  model.layers.N.self_attn.q_proj                    view             [B,B,n_h*d_head] -> [B,d_model]
  ...
  model.layers.N.self_attn.k_proj                    t                [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
  model.layers.N.self_attn.k_proj                    view             [B,B,n_h*d_head] -> [B,d_model]
  ...
  model.layers.N.self_attn.v_proj                    t                [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
  model.layers.N.self_attn.v_proj                    view             [B,B,n_h*d_head] -> [B,d_model]
  ...
  model.layers.N.post_feedforward_layernorm          elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
