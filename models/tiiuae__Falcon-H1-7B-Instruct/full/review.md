...
```
  ...
  model.layers.N.mamba                               constant_pad_nd  [B,T,n_h_ssm,d_head_ssm] -> [B,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mamba                               elementwise_mul  [n_h_ssm,B]*[B,d_state,n_h_ssm,d_head_ssm] -> [B,d_state,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mamba                               view             [B,d_state,n_h_ssm,d_head_ssm] -> [B,1,d_state,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mamba                               constant_pad_nd  [B,T,n_h_ssm,d_state] -> [B,d_state,n_h_ssm,d_chunk]
  model.layers.N.mamba                               view             [B,d_state,n_h_ssm,d_chunk] -> [B,1,d_state,n_h_ssm,d_chunk]
  model.layers.N.mamba                               permute          [B,1,d_state,n_h_ssm] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mamba                               cumsum           [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mamba                               unsqueeze        [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state,1]
  model.layers.N.mamba                               expand           [B,n_h_ssm,1,d_state,1] -> [B,n_h_ssm,1,d_state,d_chunk]
  ...
  model.layers.N.mamba                               masked_fill      [B,n_h_ssm,1,d_state,d_chunk]*[d_chunk,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  model.layers.N.mamba                               cumsum           [B,n_h_ssm,1,d_state,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  model.layers.N.mamba                               exp              [B,n_h_ssm,1,d_state,d_chunk] -> [B,n_h_ssm,1,d_state,d_chunk]
  model.layers.N.mamba                               unsqueeze        [B,1,d_state,n_h_ssm,d_chunk] -> [B,1,d_state,1,n_h_ssm,d_chunk]
  model.layers.N.mamba                               unsqueeze        [B,1,d_state,n_h_ssm,d_chunk] -> [B,1,1,d_state,n_h_ssm,d_chunk]
  model.layers.N.mamba                               elementwise_mul  [B,1,d_state,1,n_h_ssm,d_chunk]*[B,1,1,d_state,n_h_ssm,d_chunk] -> [B,1,d_state,d_chunk,n_h_ssm,d_state]
  model.layers.N.mamba                               sum              [B,1,d_state,d_chunk,n_h_ssm,d_state] -> [B,1,d_state,d_chunk,n_h_ssm]
  model.layers.N.mamba                               permute          [B,n_h_ssm,1,d_state,d_chunk] -> [B,1,d_state,d_chunk,n_h_ssm]
  model.layers.N.mamba                               sum              [B,1,d_state,d_chunk,n_h_ssm,1] -> [B,1,d_state,d_chunk,n_h_ssm]
  model.layers.N.mamba                               sum              [B,1,d_state,d_chunk,n_h_ssm,d_head_ssm] -> [B,1,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mamba                               slice            [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,1]
  model.layers.N.mamba                               sub              [B,n_h_ssm,1,1]*[B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mamba                               exp              [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1,d_state]
  model.layers.N.mamba                               permute          [B,n_h_ssm,1,d_state] -> [B,1,d_state,n_h_ssm]
  ...
  model.layers.N.mamba                               select           [B,n_h_ssm,1,d_state] -> [B,n_h_ssm,1]
  ...
  model.layers.N.mamba                               sum              [B,1,d_state,n_h_ssm,d_head_ssm,d_chunk] -> [B,1,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mamba                               elementwise_add  [B,1,d_state,n_h_ssm,d_head_ssm]*[B,1,d_state,n_h_ssm,d_head_ssm] -> [B,1,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mamba                               elementwise_add  [B,d_state,n_h_ssm,d_head_ssm]*[B,d_state,n_h_ssm,d_head_ssm] -> [B,d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mamba                               slice            [B,d_state,n_h_ssm,d_head_ssm] -> [B,T,n_h_ssm,d_head_ssm]
