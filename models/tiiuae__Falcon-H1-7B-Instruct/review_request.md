# 검토 의뢰서 — tiiuae/Falcon-H1-7B-Instruct
...
- `develop/sources/modeling_falcon_h1.py` — 있음, 이 파일을 열어서 판정한다
- `develop/sources/configuration_falcon_h1.py` — 있음, 이 파일을 열어서 판정한다

- 온라인 원본: https://github.com/huggingface/transformers/tree/main/src/transformers/models/falcon_h1
...
| prefill | `model.layers.*.mamba` | elementwise_mul | `[['B', 'T', 'd_model']]` | `None` | `[['B', 'T', 'd_model']]` |
...
| prefill | `model.layers.*.pre_ff_layernorm` | rmsnorm | `[['B', 'T', 'd_model']]` | `['d_model']` | `[['B', 'T', 'd_model']]` |
...
| prefill | `model.layers.*.feed_forward` | elementwise_mul | `[['B', 'T', 'd_ff']]` | `None` | `[['B', 'T', 'd_ff']]` |
| prefill | `model.layers.*.feed_forward.act_fn` | silu | `[['B', 'T', 'd_ff']]` | `None` | `[['B', 'T', 'd_ff']]` |
...
| prefill | `model.layers.*.feed_forward` | elementwise_mul | `[['B', 'T', 'd_model']]` | `None` | `[['B', 'T', 'd_model']]` |
...
| decode | `model.layers.*.mamba` | elementwise_mul | `[['B', '1', 'd_model']]` | `None` | `[['B', '1', 'd_model']]` |
...
| decode | `model.layers.*.mamba.norm` | rmsnorm | `[['B', '1', 'd_inner']]` | `['d_inner']` | `[['B', 'd_inner']]` |
| decode | `model.layers.*.mamba.out_proj` | matmul | `[['B', 'd_inner'], ['d_inner', 'd_model']]` | `['d_model', 'd_inner']` | `[['B', 'd_model']]` |
| decode | `model.layers.*` | elementwise_mul | `[['B', 'd_model']]` | `None` | `[['B', 'd_model']]` |
...
| decode | `model.layers.*` | elementwise_add | `[['B', 'd_model'], ['B', '1', 'd_model']]` | `None` | `[['B', '1', 'd_model']]` |
| decode | `model.layers.*` | elementwise_add | `[['B', '1', 'd_model'], ['B', '1', 'd_model']]` | `None` | `[['B', '1', 'd_model']]` |
| decode | `model.layers.*.pre_ff_layernorm` | rmsnorm | `[['B', '1', 'd_model']]` | `['d_model']` | `[['B', '1', 'd_model']]` |
| decode | `model.layers.*.feed_forward.up_proj` | matmul | `[['B', 'd_model'], ['d_model', 'd_ff']]` | `['d_ff', 'd_model']` | `[['B', 'd_ff']]` |
| decode | `model.layers.*.feed_forward.gate_proj` | matmul | `[['B', 'd_model'], ['d_model', 'd_ff']]` | `['d_ff', 'd_model']` | `[['B', 'd_ff']]` |
| decode | `model.layers.*.feed_forward` | elementwise_mul | `[['B', '1', 'd_ff']]` | `None` | `[['B', '1', 'd_ff']]` |
| decode | `model.layers.*.feed_forward.act_fn` | silu | `[['B', '1', 'd_ff']]` | `None` | `[['B', '1', 'd_ff']]` |
...
| decode | `model.layers.*.feed_forward` | elementwise_mul | `[['B', '1', 'd_model']]` | `None` | `[['B', '1', 'd_model']]` |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.mamba`, `model.layers.*.self_attn`, `model.layers.*.mamba.norm`, `model.layers.*.input_layernorm` 외 64개 | 35886 |
...
| `d_model` | 3072 | `model.layers.*.input_layernorm`, `model.layers.*.pre_ff_layernorm`, `model.layers.*.mamba.in_proj`, `model.layers.*.self_attn.q_proj` 외 58개 | 10086 |
| `d_head` | 128 | `model.layers.*.self_attn`, `model.rotary_emb` | 7418 |
| `d_chunk` | 256 | `model.layers.*.mamba` | 6908 |
...
| `d_inner` |  | `model.layers.*.mamba.norm`, `model.layers.*.mamba.out_proj`, `model.layers.*.mamba` | 3168 |
...
| `n_h/n_kv` |  | `model.layers.*.self_attn` | 704 |
| `d_conv+1` |  | `model.layers.*.mamba` | 132 |
| `T+d_conv-1` |  | `model.layers.*.mamba.conv1d`, `model.layers.*.mamba` | 88 |
| `V` | 130049 | `lm_head`, `model.embed_tokens`, `(root)` | 24 |
...
- `model.layers.*.feed_forward`
  ...
  - `[[B, T, d_ff]]`
  - `[[B, T, d_model]]`
- `model.layers.*.feed_forward.act_fn`
  - `[[B, 1, d_ff]]`
  - `[[B, T, d_ff]]`
...
- `model.layers.*.mamba`
  ...
  - `[[B, 1, n_h_ssm, d_state]]`
  - `[[B, 1, n_h_ssm]]`
  - `[[B, 2, 1, n_h_ssm, d_head_ssm, d_state]]`
  - `[[B, 2, 2, n_h_ssm, 1, 1]]`
  - `[[B, 2, 2, n_h_ssm, 1]]`
  - `[[B, 2, 2, n_h_ssm, d_head_ssm, d_state]]`
  - `[[B, 2, 2, n_h_ssm]]`
