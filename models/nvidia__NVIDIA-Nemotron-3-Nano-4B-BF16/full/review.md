...
```
  ...
  model.layers.N.norm                                mean             [B,T,d_model] -> [B,T,B]
  model.layers.N.norm                                elementwise_add  [B,T,B] -> [B,T,B]
  model.layers.N.norm                                rsqrt            [B,T,B] -> [B,T,B]
  model.layers.N.norm                                elementwise_mul  [B,T,d_model]*[B,T,B] -> [B,T,d_model]
  ...
  model.layers.N.mixer.in_proj                       matmul           [T,d_model]*[d_model,2*d_inner+2*n_g*d_state+n_h_ssm] -> w=[2*d_inner+2*n_g*d_state+n_h_ssm,d_model] [T,2*n_h_ssm*d_head_ssm+2*n_g_ssm*d_state+n_h_ssm]
  model.layers.N.mixer.in_proj                       _unsafe_view     [T,2*n_h_ssm*d_head_ssm+2*n_g_ssm*d_state+n_h_ssm] -> [B,T,2*d_inner+2*n_g*d_state+n_h_ssm]
  ...
  model.layers.N.mixer.conv1d                        conv1d           [B,d_inner+2*n_g*d_state,T]*[d_inner+2*n_g*d_state,B,d_conv]*[d_inner+2*n_g*d_state] -> w=[d_inner+2*n_g*d_state,B,d_conv] [B,d_inner+2*n_g*d_state,T+d_conv-1]
  ...
  model.layers.N.mixer                               unsqueeze        [B,T,n_g_ssm,d_state] -> [B,T,n_g_ssm,B,d_state]
  model.layers.N.mixer                               expand           [B,T,n_g_ssm,B,d_state] -> [B,T,n_g_ssm,3*d_conv,d_state]
  ...
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm,d_head_ssm] -> [B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [n_h_ssm,B]*[B,2*d_state,n_h_ssm,d_head_ssm] -> [B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               unsqueeze        [B,T,n_h_ssm] -> [B,T,n_h_ssm,B]
  model.layers.N.mixer                               elementwise_mul  [B,T,n_h_ssm,d_head_ssm]*[B,T,n_h_ssm,B] -> [B,T,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [n_h_ssm]*[B,T,n_h_ssm] -> [B,T,n_h_ssm]
  model.layers.N.mixer                               view             [B,2*d_state,n_h_ssm,d_head_ssm] -> [B,B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm] -> [B,2*d_state,n_h_ssm]
  model.layers.N.mixer                               view             [B,2*d_state,n_h_ssm] -> [B,B,2*d_state,n_h_ssm]
  model.layers.N.mixer                               constant_pad_nd  [B,T,n_h_ssm,d_state] -> [B,2*d_state,n_h_ssm,d_state]
  model.layers.N.mixer                               view             [B,2*d_state,n_h_ssm,d_state] -> [B,B,2*d_state,n_h_ssm,d_state]
  model.layers.N.mixer                               permute          [B,B,2*d_state,n_h_ssm] -> [B,n_h_ssm,B,2*d_state]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B,2*d_state]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B,2*d_state,B]
  model.layers.N.mixer                               expand           [B,n_h_ssm,B,2*d_state,B] -> [B,n_h_ssm,B,2*d_state,2*d_state]
  model.layers.N.mixer                               ones             [] -> [2*d_state,2*d_state]
  model.layers.N.mixer                               tril             [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mixer                               bitwise_not      [2*d_state,2*d_state] -> [2*d_state,2*d_state]
  model.layers.N.mixer                               masked_fill      [B,n_h_ssm,B,2*d_state,2*d_state]*[2*d_state,2*d_state] -> [B,n_h_ssm,B,2*d_state,2*d_state]
  model.layers.N.mixer                               cumsum           [B,n_h_ssm,B,2*d_state,2*d_state] -> [B,n_h_ssm,B,2*d_state,2*d_state]
  model.layers.N.mixer                               exp              [B,n_h_ssm,B,2*d_state,2*d_state] -> [B,n_h_ssm,B,2*d_state,2*d_state]
  model.layers.N.mixer                               unsqueeze        [B,B,2*d_state,n_h_ssm,d_state] -> [B,B,2*d_state,B,n_h_ssm,d_state]
  model.layers.N.mixer                               unsqueeze        [B,B,2*d_state,n_h_ssm,d_state] -> [B,B,B,2*d_state,n_h_ssm,d_state]
  model.layers.N.mixer                               elementwise_mul  [B,B,2*d_state,B,n_h_ssm,d_state]*[B,B,B,2*d_state,n_h_ssm,d_state] -> [B,B,2*d_state,2*d_state,n_h_ssm,d_state]
  model.layers.N.mixer                               sum              [B,B,2*d_state,2*d_state,n_h_ssm,d_state] -> [B,B,2*d_state,2*d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,n_h_ssm,B,2*d_state,2*d_state] -> [B,B,2*d_state,2*d_state,n_h_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,B,2*d_state,2*d_state,n_h_ssm,B]*[B,B,2*d_state,2*d_state,n_h_ssm,B] -> [B,B,2*d_state,2*d_state,n_h_ssm,B]
  model.layers.N.mixer                               sum              [B,B,2*d_state,2*d_state,n_h_ssm,B] -> [B,B,2*d_state,2*d_state,n_h_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,B,2*d_state,2*d_state,n_h_ssm,B]*[B,B,B,2*d_state,n_h_ssm,d_head_ssm] -> [B,B,2*d_state,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               sum              [B,B,2*d_state,2*d_state,n_h_ssm,d_head_ssm] -> [B,B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               slice            [B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B,B]
  model.layers.N.mixer                               sub              [B,n_h_ssm,B,B]*[B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B,2*d_state]
  model.layers.N.mixer                               exp              [B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B,2*d_state]
  model.layers.N.mixer                               permute          [B,n_h_ssm,B,2*d_state] -> [B,B,2*d_state,n_h_ssm]
  model.layers.N.mixer                               permute          [B,B,2*d_state,n_h_ssm,d_state] -> [B,B,n_h_ssm,2*d_state,d_state]
  model.layers.N.mixer                               permute          [B,B,2*d_state,n_h_ssm,d_head_ssm] -> [B,B,n_h_ssm,2*d_state,d_head_ssm]
  model.layers.N.mixer                               sum              [B,B,n_h_ssm,2*d_state,d_state,d_head_ssm] -> [B,B,n_h_ssm,d_state,d_head_ssm]
  model.layers.N.mixer                               permute          [B,B,n_h_ssm,d_state,d_head_ssm] -> [B,B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               alias            [B,B,n_h_ssm,d_head_ssm,d_state] -> [B,B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               zeros_like       [B,B,n_h_ssm,d_head_ssm,d_state] -> [B,B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               concat           [B,B,n_h_ssm,d_head_ssm,d_state]*[B,B,n_h_ssm,d_head_ssm,d_state] -> [B,k,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               select           [B,n_h_ssm,B,2*d_state] -> [B,n_h_ssm,B]
  model.layers.N.mixer                               constant_pad_nd  [B,n_h_ssm,B] -> [B,n_h_ssm,k]
  model.layers.N.mixer                               expand           [B,n_h_ssm,k,B] -> [B,n_h_ssm,k,k]
  ...
  model.layers.N.mixer                               slice            [B,k,n_h_ssm,d_head_ssm,d_state] -> [B,B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               select           [B,k,n_h_ssm,d_head_ssm,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               sum              [B,B,2*d_state,n_h_ssm,d_head_ssm,d_state] -> [B,B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,B,2*d_state,n_h_ssm,d_head_ssm]*[B,B,2*d_state,n_h_ssm,d_head_ssm] -> [B,B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_add  [B,2*d_state,n_h_ssm,d_head_ssm]*[B,2*d_state,n_h_ssm,d_head_ssm] -> [B,2*d_state,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               slice            [B,2*d_state,n_h_ssm,d_head_ssm] -> [B,T,n_h_ssm,d_head_ssm]
  ...
  model.layers.N.mixer.norm                          mean             [B,T,n_g_ssm,d_inner/n_g] -> [B,T,n_g_ssm,B]
  model.layers.N.mixer.norm                          elementwise_add  [B,T,n_g_ssm,B] -> [B,T,n_g_ssm,B]
  model.layers.N.mixer.norm                          rsqrt            [B,T,n_g_ssm,B] -> [B,T,n_g_ssm,B]
  model.layers.N.mixer.norm                          elementwise_mul  [B,T,n_g_ssm,d_inner/n_g]*[B,T,n_g_ssm,B] -> [B,T,n_g_ssm,d_inner/n_g]
  ...
  model.layers.N.mixer.out_proj                      view             [B,T,d_inner] -> [T,n_h_ssm*d_head_ssm]
  model.layers.N.mixer.out_proj                      matmul           [T,n_h_ssm*d_head_ssm]*[d_inner,d_model] -> w=[d_model,d_inner] [T,d_model]
  ...
  model.layers.N.mixer                               transpose        [B,T,n_h,d_state] -> [B,n_h,T,d_state]
  model.layers.N.mixer.k_proj                        t                [n_g*d_state,d_model] -> w=[n_g*d_state,d_model] [d_model,n_g*d_state]
  model.layers.N.mixer.k_proj                        view             [B,T,d_model] -> [T,d_model]
  model.layers.N.mixer.k_proj                        matmul           [T,d_model]*[d_model,n_g*d_state] -> w=[n_g*d_state,d_model] [T,n_kv*d_head]
  model.layers.N.mixer.k_proj                        _unsafe_view     [T,n_kv*d_head] -> [B,T,n_g*d_state]
  model.layers.N.mixer                               transpose        [B,T,n_g_ssm,d_state] -> [B,n_g_ssm,T,d_state]
  ...
  model.layers.N.mixer.v_proj                        matmul           [T,d_model]*[d_model,n_g*d_state] -> w=[n_g*d_state,d_model] [T,n_kv*d_head]
  model.layers.N.mixer.v_proj                        _unsafe_view     [T,n_kv*d_head] -> [B,T,n_g*d_state]
  model.layers.N.mixer                               concat           [0]*[B,n_g_ssm,T,d_state] -> [B,n_g_ssm,T,d_state]
  model.layers.N.mixer                               _to_copy         [B,n_h,T,d_state] -> [B,n_h,T,d_state]
  model.layers.N.mixer                               _to_copy         [B,n_g_ssm,T,d_state] -> [B,n_g_ssm,T,d_state]
  ...
  model.layers.N.mixer                               expand           [B,n_g_ssm,B,T,d_state] -> [B,n_g_ssm,5,T,d_state]
  ...
  model.layers.N.mixer                               batched_matmul   [n_h,T,d_state]*[n_h,d_state,T] -> [n_h,T,T]
  model.layers.N.mixer                               _unsafe_view     [n_h,T,T] -> [B,n_h,T,T]
  model.layers.N.mixer                               elementwise_add  [B,n_h,T,T]*[T,T] -> [B,n_h,T,T]
  model.layers.N.mixer                               softmax          [B,n_h,T,T] -> [B,n_h,T,T]
  model.layers.N.mixer                               batched_matmul   [n_h,T,T]*[n_h,T,d_state] -> [n_h,T,d_state]
  model.layers.N.mixer                               _unsafe_view     [n_h,T,d_state] -> [B,n_h,T,d_state]
  model.layers.N.mixer                               transpose        [B,n_h,T,d_state] -> [B,T,n_h,d_state]
  model.layers.N.mixer                               clone            [B,T,n_h,d_state] -> [B,T,n_h,d_state]
  ...
  model.norm_f                                       mean             [B,T,d_model] -> [B,T,B]
  model.norm_f                                       elementwise_add  [B,T,B] -> [B,T,B]
  model.norm_f                                       rsqrt            [B,T,B] -> [B,T,B]
  model.norm_f                                       elementwise_mul  [B,T,d_model]*[B,T,B] -> [B,T,d_model]
...
```
  model.embeddings                                   embedding        [V,d_model]*[B,B] -> w=[V,d_model] [B,B,d_model]
  model.layers.N.norm                                _to_copy         [B,B,d_model] -> [B,B,d_model]
  model.layers.N.norm                                pow              [B,B,d_model] -> [B,B,d_model]
  model.layers.N.norm                                mean             [B,B,d_model] -> [B,B,B]
  model.layers.N.norm                                elementwise_add  [B,B,B] -> [B,B,B]
  model.layers.N.norm                                rsqrt            [B,B,B] -> [B,B,B]
  model.layers.N.norm                                elementwise_mul  [B,B,d_model]*[B,B,B] -> [B,B,d_model]
  model.layers.N.norm                                elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.N.mixer.in_proj                       t                [2*d_inner+2*n_g*d_state+n_h_ssm,d_model] -> w=[2*d_inner+2*n_g*d_state+n_h_ssm,d_model] [d_model,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mixer.in_proj                       view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mixer.in_proj                       matmul           [B,d_model]*[d_model,2*d_inner+2*n_g*d_state+n_h_ssm] -> w=[2*d_inner+2*n_g*d_state+n_h_ssm,d_model] [B,2*n_h_ssm*d_head_ssm+2*n_g_ssm*d_state+n_h_ssm]
  model.layers.N.mixer.in_proj                       _unsafe_view     [B,2*n_h_ssm*d_head_ssm+2*n_g_ssm*d_state+n_h_ssm] -> [B,B,2*d_inner+2*n_g*d_state+n_h_ssm]
  model.layers.N.mixer                               split_with_sizes [B,B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,0]*[B,B,0]*[B,B,d_inner]*[B,B,d_inner+2*n_g*d_state]*[B,B,n_h_ssm]
  model.layers.N.mixer                               transpose        [B,B,d_inner+2*n_g*d_state] -> [B,d_inner+2*n_g*d_state,B]
  model.layers.N.mixer                               concat           [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,B] -> [B,d_inner+2*n_g*d_state,5]
  model.layers.N.mixer                               slice            [B,d_inner+2*n_g*d_state,5] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mixer                               copy_            [B,d_inner+2*n_g*d_state,d_conv]*[B,d_inner+2*n_g*d_state,d_conv] -> [B,d_inner+2*n_g*d_state,d_conv]
  model.layers.N.mixer                               select           [d_inner+2*n_g*d_state,B,d_conv] -> w=[d_inner+2*n_g*d_state,B,d_conv] [d_inner+2*n_g*d_state,d_conv]
  ...
  model.layers.N.mixer                               unsqueeze        [B,d_inner+2*n_g*d_state] -> [B,B,d_inner+2*n_g*d_state]
  model.layers.N.mixer                               split_with_sizes [B,B,d_inner+2*n_g*d_state] -> [B,B,d_inner]*[B,B,n_g*d_state]*[B,B,n_g*d_state]
  model.layers.N.mixer                               _to_copy         [n_h_ssm] -> [n_h_ssm]
  model.layers.N.mixer                               exp              [n_h_ssm] -> [n_h_ssm]
  model.layers.N.mixer                               neg              [n_h_ssm] -> [n_h_ssm]
  model.layers.N.mixer                               select           [B,B,n_h_ssm] -> [B,n_h_ssm]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm] -> [B,B,n_h_ssm]
  model.layers.N.mixer                               transpose        [B,B,n_h_ssm] -> [B,n_h_ssm,B]
  model.layers.N.mixer                               expand           [B,n_h_ssm,B] -> [B,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               unsqueeze        [n_h_ssm] -> [n_h_ssm,B]
  ...
  model.layers.N.mixer                               unsqueeze        [n_h_ssm,B] -> [n_h_ssm,B,B]
  model.layers.N.mixer                               expand           [n_h_ssm,B,B] -> [n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               unsqueeze        [B,n_h_ssm,d_head_ssm] -> [B,n_h_ssm,d_head_ssm,B]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,B]*[n_h_ssm,d_head_ssm,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               exp              [B,n_h_ssm,d_head_ssm,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               view             [B,B,n_g*d_state] -> [B,n_g_ssm,d_state]
  model.layers.N.mixer                               unsqueeze        [B,n_g_ssm,d_state] -> [B,n_g_ssm,B,d_state]
  model.layers.N.mixer                               expand           [B,n_g_ssm,B,d_state] -> [B,n_g_ssm,3*d_conv,d_state]
  ...
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,B]*[B,n_h_ssm,B,d_state] -> [B,n_h_ssm,d_head_ssm,d_state]
  model.layers.N.mixer                               view             [B,B,d_inner] -> [B,n_h_ssm,d_head_ssm]
  model.layers.N.mixer                               elementwise_mul  [B,n_h_ssm,d_head_ssm,d_state]*[B,n_h_ssm,d_head_ssm,B] -> [B,n_h_ssm,d_head_ssm,d_state]
  ...
  model.layers.N.mixer.norm                          _to_copy         [B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mixer.norm                          silu             [B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mixer.norm                          elementwise_mul  [B,B,d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mixer.norm                          view             [B,B,d_inner] -> [B,B,n_g_ssm,d_inner/n_g]
  model.layers.N.mixer.norm                          pow              [B,B,n_g_ssm,d_inner/n_g] -> [B,B,n_g_ssm,d_inner/n_g]
  model.layers.N.mixer.norm                          mean             [B,B,n_g_ssm,d_inner/n_g] -> [B,B,n_g_ssm,B]
  model.layers.N.mixer.norm                          elementwise_add  [B,B,n_g_ssm,B] -> [B,B,n_g_ssm,B]
  model.layers.N.mixer.norm                          rsqrt            [B,B,n_g_ssm,B] -> [B,B,n_g_ssm,B]
  model.layers.N.mixer.norm                          elementwise_mul  [B,B,n_g_ssm,d_inner/n_g]*[B,B,n_g_ssm,B] -> [B,B,n_g_ssm,d_inner/n_g]
  model.layers.N.mixer.norm                          view             [B,B,n_g_ssm,d_inner/n_g] -> [B,B,d_inner]
  model.layers.N.mixer.norm                          elementwise_mul  [d_inner]*[B,B,d_inner] -> [B,B,d_inner]
  model.layers.N.mixer.out_proj                      t                [d_model,d_inner] -> w=[d_model,d_inner] [d_inner,d_model]
  model.layers.N.mixer.out_proj                      view             [B,B,d_inner] -> [B,n_h_ssm*d_head_ssm]
  model.layers.N.mixer.out_proj                      matmul           [B,n_h_ssm*d_head_ssm]*[d_inner,d_model] -> w=[d_model,d_inner] [B,d_model]
  model.layers.N.mixer.out_proj                      _unsafe_view     [B,d_model] -> [B,B,d_model]
  model.layers.0                                     elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  model.layers.N.mixer.up_proj                       t                [d_ff,d_model] -> w=[d_ff,d_model] [d_model,d_ff]
  model.layers.N.mixer.up_proj                       view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mixer.up_proj                       matmul           [B,d_model]*[d_model,d_ff] -> w=[d_ff,d_model] [B,d_ff]
  model.layers.N.mixer.up_proj                       _unsafe_view     [B,d_ff] -> [B,B,d_ff]
  model.layers.N.mixer.act_fn                        relu             [B,B,d_ff] -> [B,B,d_ff]
  model.layers.N.mixer.act_fn                        pow              [B,B,d_ff] -> [B,B,d_ff]
  model.layers.N.mixer.down_proj                     t                [d_model,d_ff] -> w=[d_model,d_ff] [d_ff,d_model]
  model.layers.N.mixer.down_proj                     view             [B,B,d_ff] -> [B,d_ff]
  model.layers.N.mixer.down_proj                     matmul           [B,d_ff]*[d_ff,d_model] -> w=[d_model,d_ff] [B,d_model]
  model.layers.N.mixer.down_proj                     _unsafe_view     [B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.mixer.q_proj                        t                [n_h*d_head,d_model] -> w=[n_h*d_head,d_model] [d_model,n_h*d_head]
  model.layers.N.mixer.q_proj                        view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mixer.q_proj                        matmul           [B,d_model]*[d_model,n_h*d_head] -> w=[n_h*d_head,d_model] [B,n_h*d_head]
  model.layers.N.mixer.q_proj                        _unsafe_view     [B,n_h*d_head] -> [B,B,n_h*d_head]
  model.layers.N.mixer                               transpose        [B,B,n_h,d_state] -> [B,n_h,B,d_state]
  model.layers.N.mixer.k_proj                        t                [n_g*d_state,d_model] -> w=[n_g*d_state,d_model] [d_model,n_g*d_state]
  model.layers.N.mixer.k_proj                        view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mixer.k_proj                        matmul           [B,d_model]*[d_model,n_g*d_state] -> w=[n_g*d_state,d_model] [B,n_kv*d_head]
  model.layers.N.mixer.k_proj                        _unsafe_view     [B,n_kv*d_head] -> [B,B,n_g*d_state]
  model.layers.N.mixer                               transpose        [B,B,n_g_ssm,d_state] -> [B,n_g_ssm,B,d_state]
  model.layers.N.mixer.v_proj                        t                [n_g*d_state,d_model] -> w=[n_g*d_state,d_model] [d_model,n_g*d_state]
  model.layers.N.mixer.v_proj                        view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mixer.v_proj                        matmul           [B,d_model]*[d_model,n_g*d_state] -> w=[n_g*d_state,d_model] [B,n_kv*d_head]
  model.layers.N.mixer.v_proj                        _unsafe_view     [B,n_kv*d_head] -> [B,B,n_g*d_state]
  model.layers.N.mixer                               concat           [B,n_g_ssm,T,d_state]*[B,n_g_ssm,B,d_state] -> [B,n_g_ssm,T+1,d_state]
  model.layers.N.mixer                               _to_copy         [B,n_h,B,d_state] -> [B,n_h,B,d_state]
  model.layers.N.mixer                               _to_copy         [B,n_g_ssm,T+1,d_state] -> [B,n_g_ssm,T+1,d_state]
  model.layers.N.mixer                               expand           [B,n_g_ssm,B,T+1,d_state] -> [B,n_g_ssm,5,T+1,d_state]
  ...
  model.layers.N.mixer                               expand           [B,n_h,B,d_state] -> [B,n_h,B,d_state]
  model.layers.N.mixer                               batched_matmul   [n_h,B,d_state]*[n_h,d_state,T+1] -> [n_h,B,T+1]
  model.layers.N.mixer                               _unsafe_view     [n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.mixer                               softmax          [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.mixer                               _to_copy         [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  model.layers.N.mixer                               batched_matmul   [n_h,B,T+1]*[n_h,T+1,d_state] -> [n_h,B,d_state]
  model.layers.N.mixer                               _unsafe_view     [n_h,B,d_state] -> [B,n_h,B,d_state]
  model.layers.N.mixer                               transpose        [B,n_h,B,d_state] -> [B,B,n_h,d_state]
  model.layers.N.mixer.o_proj                        t                [d_model,n_h*d_head] -> w=[d_model,n_h*d_head] [n_h*d_head,d_model]
  model.layers.N.mixer.o_proj                        view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  model.layers.N.mixer.o_proj                        matmul           [B,n_h*d_head]*[n_h*d_head,d_model] -> w=[d_model,n_h*d_head] [B,d_model]
  model.layers.N.mixer.o_proj                        _unsafe_view     [B,d_model] -> [B,B,d_model]
  ...
  model.norm_f                                       _to_copy         [B,B,d_model] -> [B,B,d_model]
  model.norm_f                                       pow              [B,B,d_model] -> [B,B,d_model]
  model.norm_f                                       mean             [B,B,d_model] -> [B,B,B]
  model.norm_f                                       elementwise_add  [B,B,B] -> [B,B,B]
  model.norm_f                                       rsqrt            [B,B,B] -> [B,B,B]
  model.norm_f                                       elementwise_mul  [B,B,d_model]*[B,B,B] -> [B,B,d_model]
  model.norm_f                                       elementwise_mul  [d_model]*[B,B,d_model] -> [B,B,d_model]
