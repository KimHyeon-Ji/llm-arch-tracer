...
```
  ...
  model.layers.N.mixer.in_proj                       _unsafe_view     [B,2*d_inner+2*n_g*d_state+n_h_ssm] -> [B,B,2*d_inner+2*n_g*d_state+n_h_ssm]
  ...
  model.layers.N.mixer.out_proj                      t                [d_model,d_inner] -> w=[d_model,d_inner] [d_inner,d_model]
  model.layers.N.mixer.out_proj                      view             [B,B,d_inner] -> [B,d_inner]
  ...
  model.layers.N.mixer.k_proj                        _unsafe_view     [B,n_g*d_state] -> [B,B,n_g*d_state]
  ...
  model.layers.N.mixer.v_proj                        _unsafe_view     [B,n_g*d_state] -> [B,B,n_g*d_state]
