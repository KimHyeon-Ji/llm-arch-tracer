...
```
  ...
  transformer.h.N.ln_1                               layernorm        [B,T,d_model]*[d_model]*[d_model] -> [B,T,d_model]*[B,T,B]*[B,T,B]
  ...
  transformer.h.N.attn.c_proj                        linear           [n_h*d_head]*[T,n_h*d_head]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [T,n_h*d_head]
  transformer.h.N.attn.c_proj                        view             [T,n_h*d_head] -> [B,T,n_h*d_head]
  transformer.h.0                                    elementwise_add  [B,T,d_model]*[B,T,d_model] -> [B,T,d_model]
  transformer.h.N.ln_2                               layernorm        [B,T,d_model]*[d_model]*[d_model] -> [B,T,d_model]*[B,T,B]*[B,T,B]
  transformer.h.N.mlp.c_fc                           view             [B,T,d_model] -> [T,d_model]
  transformer.h.N.mlp.c_fc                           linear           [4*d_model]*[T,d_model]*[d_model,4*d_model] -> w=[d_model,4*d_model] [T,4*d_model]
  transformer.h.N.mlp.c_fc                           view             [T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            elementwise_mul  [B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            pow              [B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            elementwise_add  [B,T,4*d_model]*[B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            tanh             [B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            elementwise_add  [B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.act                            elementwise_mul  [B,T,4*d_model]*[B,T,4*d_model] -> [B,T,4*d_model]
  transformer.h.N.mlp.c_proj                         view             [B,T,4*d_model] -> [T,4*d_model]
  transformer.h.N.mlp.c_proj                         linear           [d_model]*[T,4*d_model]*[4*d_model,d_model] -> w=[4*d_model,d_model] [T,d_model]
...
```
  transformer                                        view             [B,B] -> [B,B]
  transformer.wte                                    embedding        [V,d_model]*[B,B] -> w=[V,d_model] [B,B,d_model]
  transformer.wpe                                    embedding        [ctx,d_model]*[B,B] -> w=[ctx,d_model] [B,B,d_model]
  transformer                                        elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.N.ln_1                               layernorm        [B,B,d_model]*[d_model]*[d_model] -> [B,B,d_model]*[B,B,B]*[B,B,B]
  transformer.h.N.attn.c_attn                        view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  ...
  transformer.h.N.attn.c_attn                        view             [B,(n_h+2*n_kv)*d_head] -> [B,B,(n_h+2*n_kv)*d_head]
  transformer.h.N.attn                               split            [B,B,(n_h+2*n_kv)*d_head] -> [B,B,n_h*d_head]*[B,B,n_h*d_head]*[B,B,n_h*d_head]
  transformer.h.N.attn                               view             [B,B,n_h*d_head] -> [B,B,n_h,d_head]
  transformer.h.N.attn                               transpose        [B,B,n_h,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.attn                               concat           [B,n_h,T,d_head]*[B,n_h,B,d_head] -> [B,n_h,T+1,d_head]
  transformer.h.N.attn                               elementwise_mul  [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  ...
  transformer.h.N.attn                               expand           [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.attn                               view             [B,n_h,B,d_head] -> [n_h,B,d_head]
  ...
  transformer.h.N.attn                               _unsafe_view     [n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.attn                               softmax          [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.attn                               expand           [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.attn                               view             [B,n_h,B,T+1] -> [n_h,B,T+1]
  ...
  transformer.h.N.attn                               _unsafe_view     [n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.attn                               transpose        [B,n_h,B,d_head] -> [B,B,n_h,d_head]
  transformer.h.N.attn                               view             [B,B,n_h,d_head] -> [B,B,n_h*d_head]
  transformer.h.N.attn.c_proj                        view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  transformer.h.N.attn.c_proj                        linear           [n_h*d_head]*[B,n_h*d_head]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [B,n_h*d_head]
  transformer.h.N.attn.c_proj                        view             [B,n_h*d_head] -> [B,B,n_h*d_head]
  transformer.h.0                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.N.ln_2                               layernorm        [B,B,d_model]*[d_model]*[d_model] -> [B,B,d_model]*[B,B,B]*[B,B,B]
  transformer.h.N.mlp.c_fc                           view             [B,B,d_model] -> [B,d_model]
  transformer.h.N.mlp.c_fc                           linear           [4*d_model]*[B,d_model]*[d_model,4*d_model] -> w=[d_model,4*d_model] [B,4*d_model]
  transformer.h.N.mlp.c_fc                           view             [B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            elementwise_mul  [B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            pow              [B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            elementwise_add  [B,B,4*d_model]*[B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            tanh             [B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            elementwise_add  [B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            elementwise_mul  [B,B,4*d_model]*[B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.c_proj                         view             [B,B,4*d_model] -> [B,4*d_model]
  transformer.h.N.mlp.c_proj                         linear           [d_model]*[B,4*d_model]*[4*d_model,d_model] -> w=[4*d_model,d_model] [B,d_model]
  transformer.h.N.mlp.c_proj                         view             [B,d_model] -> [B,B,d_model]
  ...
  transformer.h.32                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.33                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.34                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.35                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.36                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.37                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.38                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.39                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.40                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.41                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.42                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.43                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.44                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.45                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.46                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.47                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.ln_f                                   layernorm        [B,B,d_model]*[d_model]*[d_model] -> [B,B,d_model]*[B,B,B]*[B,B,B]
  transformer                                        view             [B,B,d_model] -> [B,B,d_model]
