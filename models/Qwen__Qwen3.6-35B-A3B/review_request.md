...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 8880 |
| `k` | 8 | `model.layers.*.mlp.experts`, `model.layers.*.mlp.gate`, `model.layers.*.mlp.experts.act_fn` | 3080 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 3000 |
...
### C. 모듈이 내는 출력 shape 전부 (73개 모듈 / 621종)
