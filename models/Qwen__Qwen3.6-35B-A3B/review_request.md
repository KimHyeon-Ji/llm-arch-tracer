...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 7950 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 3930 |
...
### C. 모듈이 내는 출력 shape 전부 (73개 모듈 / 623종)
