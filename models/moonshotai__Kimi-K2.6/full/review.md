...
| `self_attn$` | `d_head` | `d_rope` | 305 | modeling_deepseek.py:772-774 (moonshotai__Kimi-K2.6__modeling_deepseek.py) -- q_nope, q_pe = torch.split(q, [qk_nope_head_dim, qk_rope_head_dim], dim=-1); second piece is q_pe. |
