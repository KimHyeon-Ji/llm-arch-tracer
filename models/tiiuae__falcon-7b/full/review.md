...
| KV cache 크기 | 2·n_kv·d_head = 2·1·64 = 128 elems / token / layer; all 32 layers ⇒ 4096 / token |
...
```
  ...
  transformer                                        view             [T] -> [T,B]
  transformer                                        le               [T]*[T,B] -> [T,T]
  transformer                                        select           [T,T] -> [T]
  transformer                                        select           [T] -> []
  transformer                                        bitwise_and      [T,B]*[T,T] -> [T,T]
  transformer                                        lift_fresh       [] -> []
  transformer                                        _to_copy         [] -> []
  transformer                                        bitwise_and      [T,T]*[] -> [T,T]
  transformer                                        expand           [T,T] -> [B,T,T]
  transformer                                        expand           [B,T,T] -> [B,B,T,T]
  transformer.rotary_emb                             unsqueeze        [d_head/2] -> [B,d_head/2]
  transformer.rotary_emb                             unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  transformer.rotary_emb                             expand           [B,d_head/2,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             unsqueeze        [B,T] -> [B,B,T]
  transformer.rotary_emb                             _to_copy         [B,B,T] -> [B,B,T]
  transformer.rotary_emb                             view             [B,d_head/2,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             expand           [B,B,T] -> [B,B,T]
  transformer.rotary_emb                             view             [B,B,T] -> [B,B,T]
  transformer.rotary_emb                             batched_matmul   [B,d_head/2,B]*[B,B,T] -> [B,d_head/2,T]
  ...
  transformer.h.N.input_layernorm                    layernorm        [B,T,d_model]*[d_model]*[d_model] -> [B,T,d_model]*[B,T,B]*[B,T,B]
  ...
  transformer.h.N.self_attention.query_key_value     view             [B,T,n_h*d_head] -> [T,d_model]
  ...
  transformer.h.N.self_attention                     index            [B,T,n_h+2*n_kv,d_head]*[B] -> [B,T,B,d_head]
  ...
  transformer.h.N.self_attention                     transpose        [B,T,B,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     view             [B,B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     unsqueeze        [B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     elementwise_mul  [B,n_h,T,d_head]*[B,B,T,d_head] -> [B,n_h,T,d_head]
  ...
  transformer.h.N.self_attention                     elementwise_mul  [B,B,T,d_head]*[B,B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     slice            [B,B,T,d_head] -> [B,B,T,d_head/2]
  transformer.h.N.self_attention                     neg              [B,B,T,d_head/2] -> [B,B,T,d_head/2]
  transformer.h.N.self_attention                     concat           [B,B,T,d_head/2]*[B,B,T,d_head/2] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     elementwise_add  [B,B,T,d_head]*[B,B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     concat           [0]*[B,B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     scalar_tensor    [] -> []
  transformer.h.N.self_attention                     where            [B,B,T,T]*[]*[] -> [B,B,T,T]
  transformer.h.N.self_attention                     _to_copy         [B,n_h,T,d_head] -> [B,n_h,T,d_head]
  transformer.h.N.self_attention                     _to_copy         [B,B,T,d_head] -> [B,B,T,d_head]
  transformer.h.N.self_attention                     elementwise_mul  [B,n_h,T,d_head] -> [B,n_h,T,d_head]
  transformer.h.N.self_attention                     transpose        [B,B,T,d_head] -> [B,B,d_head,T]
  transformer.h.N.self_attention                     elementwise_mul  [B,B,d_head,T] -> [B,B,d_head,T]
  ...
  transformer.h.N.self_attention                     expand           [B,B,d_head,T] -> [B,n_h,d_head,T]
  ...
  transformer.h.N.self_attention                     elementwise_add  [B,n_h,T,T]*[B,B,T,T] -> [B,n_h,T,T]
  ...
  transformer.h.N.self_attention                     expand           [B,B,T,d_head] -> [B,n_h,T,d_head]
  ...
  transformer.h.N.self_attention.dense               permute          [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
  transformer.h.N.self_attention.dense               view             [B,T,n_h*d_head] -> [T,d_model]
  transformer.h.N.self_attention.dense               matmul           [T,d_model]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [T,d_model]
  transformer.h.N.self_attention.dense               _unsafe_view     [T,d_model] -> [B,T,n_h*d_head]
  ...
  transformer.ln_f                                   layernorm        [B,T,d_model]*[d_model]*[d_model] -> [B,T,d_model]*[B,T,B]*[B,T,B]
...
```
  transformer.word_embeddings                        embedding        [V,d_model]*[B,B] -> w=[V,d_model] [B,B,d_model]
  transformer                                        arange           [] -> [B]
  transformer                                        elementwise_add  [B] -> [B]
  transformer                                        arange           [] -> [T+1]
  transformer                                        elementwise_add  [T+1] -> [T+1]
  transformer                                        new_ones         [B] -> [B]
  transformer                                        view             [B] -> [B,B]
  transformer                                        le               [T+1]*[B,B] -> [B,T+1]
  transformer                                        select           [B,T+1] -> [B]
  transformer                                        select           [B] -> []
  transformer                                        bitwise_and      [B,B]*[B,T+1] -> [B,T+1]
  transformer                                        lift_fresh       [] -> []
  transformer                                        _to_copy         [] -> []
  transformer                                        bitwise_and      [B,T+1]*[] -> [B,T+1]
  transformer                                        expand           [B,T+1] -> [B,B,T+1]
  transformer                                        expand           [B,B,T+1] -> [B,B,B,T+1]
  transformer.rotary_emb                             unsqueeze        [d_head/2] -> [B,d_head/2]
  transformer.rotary_emb                             unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  transformer.rotary_emb                             expand           [B,d_head/2,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             unsqueeze        [B,B] -> [B,B,B]
  transformer.rotary_emb                             _to_copy         [B,B,B] -> [B,B,B]
  transformer.rotary_emb                             view             [B,d_head/2,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             expand           [B,B,B] -> [B,B,B]
  transformer.rotary_emb                             view             [B,B,B] -> [B,B,B]
  transformer.rotary_emb                             batched_matmul   [B,d_head/2,B]*[B,B,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             _unsafe_view     [B,d_head/2,B] -> [B,d_head/2,B]
  transformer.rotary_emb                             transpose        [B,d_head/2,B] -> [B,B,d_head/2]
  transformer.rotary_emb                             concat           [B,B,d_head/2]*[B,B,d_head/2] -> [B,B,d_head]
  transformer.rotary_emb                             cos              [B,B,d_head] -> [B,B,d_head]
  transformer.rotary_emb                             elementwise_mul  [B,B,d_head] -> [B,B,d_head]
  transformer.rotary_emb                             sin              [B,B,d_head] -> [B,B,d_head]
  transformer.rotary_emb                             _to_copy         [B,B,d_head] -> [B,B,d_head]
  transformer.h.N.input_layernorm                    layernorm        [B,B,d_model]*[d_model]*[d_model] -> [B,B,d_model]*[B,B,B]*[B,B,B]
  transformer.h.N.self_attention.query_key_value     permute          [(n_h+2*n_kv)*d_head,n_h*d_head] -> w=[(n_h+2*n_kv)*d_head,n_h*d_head] [n_h*d_head,(n_h+2*n_kv)*d_head]
  transformer.h.N.self_attention.query_key_value     view             [B,B,n_h*d_head] -> [B,d_model]
  ...
  transformer.h.N.self_attention.query_key_value     _unsafe_view     [B,(n_h+2*n_kv)*d_head] -> [B,B,(n_h+2*n_kv)*d_head]
  transformer.h.N.self_attention                     view             [B,B,(n_h+2*n_kv)*d_head] -> [B,B,n_h+2*n_kv,d_head]
  transformer.h.N.self_attention                     slice            [B,B,n_h+2*n_kv,d_head] -> [B,B,n_h,d_head]
  transformer.h.N.self_attention                     index            [B,B,n_h+2*n_kv,d_head]*[B] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     transpose        [B,B,n_h,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     view             [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     transpose        [B,B,B,d_head] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     view             [B,B,B,d_head] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     unsqueeze        [B,B,d_head] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     elementwise_mul  [B,n_h,B,d_head]*[B,B,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     slice            [B,n_h,B,d_head] -> [B,n_h,B,d_head/2]
  transformer.h.N.self_attention                     neg              [B,n_h,B,d_head/2] -> [B,n_h,B,d_head/2]
  transformer.h.N.self_attention                     concat           [B,n_h,B,d_head/2]*[B,n_h,B,d_head/2] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     elementwise_add  [B,n_h,B,d_head]*[B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     elementwise_mul  [B,B,B,d_head]*[B,B,B,d_head] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     slice            [B,B,B,d_head] -> [B,B,B,d_head/2]
  transformer.h.N.self_attention                     neg              [B,B,B,d_head/2] -> [B,B,B,d_head/2]
  transformer.h.N.self_attention                     concat           [B,B,B,d_head/2]*[B,B,B,d_head/2] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     elementwise_add  [B,B,B,d_head]*[B,B,B,d_head] -> [B,B,B,d_head]
  transformer.h.N.self_attention                     concat           [B,B,T,d_head]*[B,B,B,d_head] -> [B,B,T+1,d_head]
  transformer.h.N.self_attention                     scalar_tensor    [] -> []
  transformer.h.N.self_attention                     where            [B,B,B,T+1]*[]*[] -> [B,B,B,T+1]
  transformer.h.N.self_attention                     _to_copy         [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     _to_copy         [B,B,T+1,d_head] -> [B,B,T+1,d_head]
  transformer.h.N.self_attention                     elementwise_mul  [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     transpose        [B,B,T+1,d_head] -> [B,B,d_head,T+1]
  transformer.h.N.self_attention                     elementwise_mul  [B,B,d_head,T+1] -> [B,B,d_head,T+1]
  transformer.h.N.self_attention                     expand           [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     view             [B,n_h,B,d_head] -> [n_h,B,d_head]
  transformer.h.N.self_attention                     expand           [B,B,d_head,T+1] -> [B,n_h,d_head,T+1]
  ...
  transformer.h.N.self_attention                     _unsafe_view     [n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.self_attention                     elementwise_add  [B,n_h,B,T+1]*[B,B,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.self_attention                     softmax          [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.self_attention                     _to_copy         [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.self_attention                     expand           [B,n_h,B,T+1] -> [B,n_h,B,T+1]
  transformer.h.N.self_attention                     view             [B,n_h,B,T+1] -> [n_h,B,T+1]
  transformer.h.N.self_attention                     expand           [B,B,T+1,d_head] -> [B,n_h,T+1,d_head]
  transformer.h.N.self_attention                     batched_matmul   [n_h,B,T+1]*[n_h,T+1,d_head] -> [n_h,B,d_head]
  transformer.h.N.self_attention                     _unsafe_view     [n_h,B,d_head] -> [B,n_h,B,d_head]
  transformer.h.N.self_attention                     permute          [B,n_h,B,d_head] -> [B,B,n_h,d_head]
  transformer.h.N.self_attention.dense               permute          [n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [n_h*d_head,n_h*d_head]
  transformer.h.N.self_attention.dense               view             [B,B,n_h*d_head] -> [B,d_model]
  transformer.h.N.self_attention.dense               matmul           [B,d_model]*[n_h*d_head,n_h*d_head] -> w=[n_h*d_head,n_h*d_head] [B,d_model]
  transformer.h.N.self_attention.dense               _unsafe_view     [B,d_model] -> [B,B,n_h*d_head]
  transformer.h.N.mlp.dense_h_to_4h                  permute          [4*d_model,d_model] -> w=[4*d_model,d_model] [d_model,4*d_model]
  transformer.h.N.mlp.dense_h_to_4h                  view             [B,B,d_model] -> [B,d_model]
  transformer.h.N.mlp.dense_h_to_4h                  matmul           [B,d_model]*[d_model,4*d_model] -> w=[4*d_model,d_model] [B,4*d_model]
  transformer.h.N.mlp.dense_h_to_4h                  _unsafe_view     [B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.act                            gelu             [B,B,4*d_model] -> [B,B,4*d_model]
  transformer.h.N.mlp.dense_4h_to_h                  permute          [d_model,4*d_model] -> w=[d_model,4*d_model] [4*d_model,d_model]
  transformer.h.N.mlp.dense_4h_to_h                  view             [B,B,4*d_model] -> [B,4*d_model]
  transformer.h.N.mlp.dense_4h_to_h                  matmul           [B,4*d_model]*[4*d_model,d_model] -> w=[d_model,4*d_model] [B,d_model]
  transformer.h.N.mlp.dense_4h_to_h                  _unsafe_view     [B,d_model] -> [B,B,d_model]
  transformer.h.0                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.0                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.1                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.1                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.2                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.2                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.3                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.3                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.4                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.4                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.5                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.5                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.6                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.6                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.7                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.7                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.8                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.8                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.9                                    add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.9                                    elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.10                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.10                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.11                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.11                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.12                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.12                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.13                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.13                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.14                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.14                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.15                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.15                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.16                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.16                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.17                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.17                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.18                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.18                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.19                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.19                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.20                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.20                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.21                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.21                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.22                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.22                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.23                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.23                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.24                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.24                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.25                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.25                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.26                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.26                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.27                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.27                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.28                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.28                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.29                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.29                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.30                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.30                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.31                                   add_             [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.h.31                                   elementwise_add  [B,B,d_model]*[B,B,d_model] -> [B,B,d_model]
  transformer.ln_f                                   layernorm        [B,B,d_model]*[d_model]*[d_model] -> [B,B,d_model]*[B,B,B]*[B,B,B]
