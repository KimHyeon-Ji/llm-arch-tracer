# 조사 안건 — meta-llama/Llama-3.1-70B
...
| 정사각 투영 (알려진 패턴) | 조사 불필요 — 축 순서만의 문제 | 320 |
...
|---|---|---|---|---:|
| `model.layers.*.self_attn.o_proj` | `n_h*d_head` | `[n_h*d_head, n_h*d_head]` | `[8192, 8192]` | 240 |
| `model.layers.*.self_attn.q_proj` | `n_h*d_head` | `[n_h*d_head, n_h*d_head]` | `[8192, 8192]` | 80 |
...
4. 저장소 README / 공식 model card — https://huggingface.co/meta-llama/Llama-3.1-70B
