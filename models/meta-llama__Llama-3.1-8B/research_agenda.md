...
| 정사각 투영 (알려진 패턴) | 조사 불필요 — 축 순서만의 문제 | 128 |
...
| `model.layers.*.self_attn.q_proj` | `n_h*d_head` | `[n_h*d_head, n_h*d_head]` | `[4096, 4096]` | 32 |
...
4. 저장소 README / 공식 model card — https://huggingface.co/meta-llama/Llama-3.1-8B
