...
| KV cache 크기 | 2·n_kv·d_head = 2·4·128 = 1024 elems / token / layer; all 48 layers ⇒ 49152 / token |
...
```
  ...
  model.layers.N.self_attn.q_norm                    elementwise_mul  [d_head]*[B,B,n_h,d_head] -> [B,B,n_h,d_head]
  ...
  model.layers.N.self_attn.k_norm                    elementwise_mul  [d_head]*[B,B,n_kv,d_head] -> [B,B,n_kv,d_head]
