...
```
  ...
  model.layers.N.linear_attn.in_proj_ba              matmul           [T,d_model]*[d_model,d_rope] -> w=[d_rope,d_model] [T,d_rope]
  model.layers.N.linear_attn.in_proj_ba              _unsafe_view     [T,d_rope] -> [B,T,d_rope]
...
```
  ...
  model.layers.N.linear_attn.in_proj_qkvz            _unsafe_view     [B,2*n_k*d_k+2*n_v*d_v] -> [B,B,2*n_k*d_k+2*n_v*d_v]
  model.layers.N.linear_attn.in_proj_ba              t                [d_rope,d_model] -> w=[d_rope,d_model] [d_model,d_rope]
  model.layers.N.linear_attn.in_proj_ba              view             [B,B,d_model] -> [B,d_model]
  model.layers.N.linear_attn.in_proj_ba              matmul           [B,d_model]*[d_model,d_rope] -> w=[d_rope,d_model] [B,d_rope]
  model.layers.N.linear_attn.in_proj_ba              _unsafe_view     [B,d_rope] -> [B,B,d_rope]
  ...
  model.layers.N.linear_attn.out_proj                t                [d_model,n_h*d_head] -> w=[d_model,n_h*d_head] [n_h*d_head,d_model]
  model.layers.N.linear_attn.out_proj                view             [B,B,n_h*d_head] -> [B,n_h*d_head]
  model.layers.N.linear_attn.out_proj                matmul           [B,n_h*d_head]*[n_h*d_head,d_model] -> w=[d_model,n_h*d_head] [B,d_model]
  ...
  model.layers.N.self_attn.q_proj                    _unsafe_view     [B,4*d_model] -> [B,B,4*d_model]
