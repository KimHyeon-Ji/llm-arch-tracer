...
```
  ...
  model.layers.N.linear_attn                         _unsafe_view     [B,T,n_h_lin_k,d_head_lin_k] -> [B,T,n_h_lin_k*d_head_lin_k]
...
```
  ...
  model.layers.N.linear_attn                         _unsafe_view     [B,1,n_h_lin_k,d_head_lin_k] -> [B,1,n_h_lin_k*d_head_lin_k]
