...
| C16 | INFO | 33812 unmapped rows, 37 distinct raw ops: ['aten._to_copy.default', 'aten._unsafe_view.default', ... |
...
```
  ...
  model.rotary_emb                                   unsqueeze        [B,d_rope/2] -> [B,d_rope/2,B]
  model.rotary_emb                                   expand           [B,d_rope/2,B] -> [B,d_rope/2,B]
  model.rotary_emb                                   unsqueeze        [B,T] -> [B,B,T]
  model.rotary_emb                                   _to_copy         [B,B,T] -> [B,B,T]
  model.rotary_emb                                   view             [B,d_rope/2,B] -> [B,d_rope/2,B]
  model.rotary_emb                                   expand           [B,B,T] -> [B,B,T]
  model.rotary_emb                                   view             [B,B,T] -> [B,B,T]
  model.rotary_emb                                   batched_matmul   [B,d_rope/2,B]*[B,B,T] -> [B,d_rope/2,T]
  ...
  model.layers.N.linear_attn.in_proj_qkvz            matmul           [T,d_model]*[d_model,2*n_k*d_k+2*n_v*d_v] -> w=[2*n_k*d_k+2*n_v*d_v,d_model] [T,2*n_h_lin_k*d_head_lin_k+2*n_h_lin_v*d_head_lin_v]
  model.layers.N.linear_attn.in_proj_qkvz            _unsafe_view     [T,2*n_h_lin_k*d_head_lin_k+2*n_h_lin_v*d_head_lin_v] -> [B,T,2*n_k*d_k+2*n_v*d_v]
  model.layers.N.linear_attn.in_proj_ba              t                [d_rope,d_model] -> w=[d_rope,d_model] [d_model,d_rope]
  model.layers.N.linear_attn.in_proj_ba              view             [B,T,d_model] -> [T,d_model]
  model.layers.N.linear_attn.in_proj_ba              matmul           [T,d_model]*[d_model,d_rope] -> w=[d_rope,d_model] [T,2*n_h_lin_v]
  model.layers.N.linear_attn.in_proj_ba              _unsafe_view     [T,2*n_h_lin_v] -> [B,T,d_rope]
  ...
  model.layers.N.linear_attn                         concat           [B,T,d_model]*[B,T,d_model]*[B,T,n_h*d_head] -> [B,T,4*d_model]
  model.layers.N.linear_attn                         transpose        [B,T,4*d_model] -> [B,4*d_model,T]
  model.layers.N.linear_attn                         constant_pad_nd  [B,4*d_model,T] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         zeros            [] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         slice            [B,4*d_model,d_conv_lin] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         copy_            [B,4*d_model,d_conv_lin]*[B,4*d_model,d_conv_lin] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn.conv1d                  conv1d           [B,4*d_model,T]*[4*d_model,B,d_conv_lin] -> w=[4*d_model,B,d_conv_lin] [B,4*d_model,n_h+2*n_kv]
  model.layers.N.linear_attn                         slice            [B,4*d_model,n_h+2*n_kv] -> [B,4*d_model,T]
  model.layers.N.linear_attn                         silu             [B,4*d_model,T] -> [B,4*d_model,T]
  model.layers.N.linear_attn                         transpose        [B,4*d_model,T] -> [B,T,4*d_model]
  model.layers.N.linear_attn                         split_with_sizes [B,T,4*d_model] -> [B,T,d_model]*[B,T,d_model]*[B,T,n_h*d_head]
  ...
  model.layers.N.linear_attn                         unsqueeze        [B,T,n_h,d_head_lin_k] -> [B,T,n_h,B,d_head_lin_k]
  model.layers.N.linear_attn                         expand           [B,T,n_h,B,d_head_lin_k] -> [B,T,n_h,d_conv_lin/2,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         sum              [B,T,n_h_lin_v,d_head_lin_k] -> [B,T,n_h_lin_v,B]
  model.layers.N.linear_attn                         elementwise_add  [B,T,n_h_lin_v,B] -> [B,T,n_h_lin_v,B]
  model.layers.N.linear_attn                         rsqrt            [B,T,n_h_lin_v,B] -> [B,T,n_h_lin_v,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,T,n_h_lin_v,d_head_lin_k]*[B,T,n_h_lin_v,B] -> [B,T,n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,d_rope] -> [B,n_h_lin_v,d_rope,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,n_h_lin_v,d_rope,d_head_lin_k]*[B,n_h_lin_v,d_rope,B] -> [B,n_h_lin_v,d_rope,d_head_lin_k]
  model.layers.N.linear_attn                         ones             [] -> [d_rope,d_rope]
  model.layers.N.linear_attn                         triu             [d_rope,d_rope] -> [d_rope,d_rope]
  model.layers.N.linear_attn                         cumsum           [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,d_rope]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,d_rope,B]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,B,d_rope]
  model.layers.N.linear_attn                         sub              [B,n_h_lin_v,B,d_rope,B]*[B,n_h_lin_v,B,B,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         tril             [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         exp              [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         transpose        [B,n_h_lin_v,B,d_rope,d_head_lin_k] -> [B,n_h_lin_v,B,d_head_lin_k,d_rope]
  model.layers.N.linear_attn                         expand           [B,n_h_lin_v,B,d_rope,d_head_lin_k] -> [B,n_h_lin_v,B,d_rope,d_head_lin_k]
  model.layers.N.linear_attn                         expand           [B,n_h_lin_v,B,d_head_lin_k,d_rope] -> [B,n_h_lin_v,B,d_head_lin_k,d_rope]
  ...
  model.layers.N.linear_attn                         _unsafe_view     [n_h_lin_v,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         elementwise_mul  [B,n_h_lin_v,B,d_rope,d_rope]*[B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         masked_fill      [B,n_h_lin_v,B,d_rope,d_rope]*[d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         neg              [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope]
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,B,d_rope]
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,B,B,d_rope] -> [B,n_h_lin_v,B,B,B]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,B,B] -> [B,n_h_lin_v,B,B,B]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,B,B,B] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,B,B]*[B,n_h_lin_v,B,B] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         copy_            [B,n_h_lin_v,B,B]*[B,n_h_lin_v,B,B] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         slice            [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,n_kv]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,B,n_kv] -> [B,n_h_lin_v,B,n_kv,B]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,B,n_kv,n_kv] -> [B,n_h_lin_v,B,n_kv]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,B,n_kv]*[B,n_h_lin_v,B,n_kv] -> [B,n_h_lin_v,B,n_kv]
  model.layers.N.linear_attn                         copy_            [B,n_h_lin_v,B,n_kv]*[B,n_h_lin_v,B,n_kv] -> [B,n_h_lin_v,B,n_kv]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,B,3,3] -> [B,n_h_lin_v,B,3]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,B,3]*[B,n_h_lin_v,B,3] -> [B,n_h_lin_v,B,3]
  model.layers.N.linear_attn                         copy_            [B,n_h_lin_v,B,3]*[B,n_h_lin_v,B,3] -> [B,n_h_lin_v,B,3]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,B,d_conv_lin,d_conv_lin] -> [B,n_h_lin_v,B,d_conv_lin]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,B,d_conv_lin]*[B,n_h_lin_v,B,d_conv_lin] -> [B,n_h_lin_v,B,d_conv_lin]
  model.layers.N.linear_attn                         copy_            [B,n_h_lin_v,B,d_conv_lin]*[B,n_h_lin_v,B,d_conv_lin] -> [B,n_h_lin_v,B,d_conv_lin]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,B,5,5] -> [B,n_h_lin_v,B,5]
  model.layers.N.linear_attn                         copy_            [B,n_h_lin_v,B,5]*[B,n_h_lin_v,B,5] -> [B,n_h_lin_v,B,5]
  model.layers.N.linear_attn                         eye              [] -> [d_rope,d_rope]
  model.layers.N.linear_attn                         expand           [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,B,d_rope,d_rope]
  ...
  model.layers.N.linear_attn                         _unsafe_view     [n_h_lin_v,d_rope,d_head_lin_k] -> [B,n_h_lin_v,B,d_rope,d_head_lin_k]
  model.layers.N.linear_attn                         exp              [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,B,d_rope]
  model.layers.N.linear_attn                         zeros            [] -> [B,n_h_lin_v,d_head_lin_k,d_head_lin_v]
  model.layers.N.linear_attn                         zeros_like       [B,n_h_lin_v,B,d_rope,d_head_lin_k] -> [B,n_h_lin_v,B,d_rope,d_head_lin_k]
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B,d_rope,d_head_lin_k] -> [B,n_h_lin_v,d_rope,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B,d_rope,d_rope] -> [B,n_h_lin_v,d_rope,d_rope]
  ...
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B,d_rope] -> [B,n_h_lin_v,d_rope]
  model.layers.N.linear_attn                         exp              [B,n_h_lin_v,d_rope,B] -> [B,n_h_lin_v,d_rope,B]
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,d_rope] -> [B,n_h_lin_v]
  model.layers.N.linear_attn                         exp              [B,n_h_lin_v,B,B] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         sub              [B,n_h_lin_v,B]*[B,n_h_lin_v,d_rope] -> [B,n_h_lin_v,d_rope]
  ...
  model.layers.N.linear_attn.out_proj                view             [B,T,n_h*d_head] -> [T,n_h_lin_v*d_head_lin_v]
  model.layers.N.linear_attn.out_proj                matmul           [T,n_h_lin_v*d_head_lin_v]*[n_h*d_head,d_model] -> w=[d_model,n_h*d_head] [T,d_model]
  ...
  model.layers.N.mlp.gate                            sum              [T,k] -> [T,B]
  model.layers.N.mlp.gate                            div_             [T,k]*[T,B] -> [T,k]
  ...
  model.layers.N.mlp.experts                         histc            [k*T] -> [d_moe]
  model.layers.N.mlp.experts                         cumsum           [d_moe] -> [d_moe]
  ...
  model.layers.N.mlp.experts                         transpose        [d_moe,2*d_moe,d_model] -> w=[d_moe,2*d_moe,d_model] [d_moe,d_model,2*d_moe]
  model.layers.N.mlp.experts                         grouped_matmul   [k*T,d_model]*[d_moe,d_model,2*d_moe]*[d_moe] -> w=[d_moe,2*d_moe,d_model] [k*T,2*d_moe]
  ...
  model.layers.N.mlp.experts                         transpose        [d_moe,d_model,E] -> w=[d_moe,d_model,E] [d_moe,E,d_model]
  model.layers.N.mlp.experts                         grouped_matmul   [k*T,d_moe]*[d_moe,E,d_model]*[d_moe] -> w=[d_moe,d_model,E] [k*T,d_model]
  ...
  model.layers.N.mlp.shared_expert_gate              t                [B,d_model] -> w=[B,d_model] [d_model,B]
  model.layers.N.mlp.shared_expert_gate              matmul           [T,d_model]*[d_model,B] -> w=[B,d_model] [T,B]
  model.layers.N.mlp                                 sigmoid          [T,B] -> [T,B]
  model.layers.N.mlp                                 elementwise_mul  [T,B]*[T,d_model] -> [T,d_model]
  ...
  model.layers.N.self_attn.q_proj                    matmul           [T,d_model]*[d_model,4*d_model] -> w=[4*d_model,d_model] [T,2*n_h*d_head]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [T,2*n_h*d_head] -> [B,T,4*d_model]
  model.layers.N.self_attn                           view             [B,T,4*d_model] -> [B,T,n_h,n_kv*d_head]
  model.layers.N.self_attn                           split            [B,T,n_h,n_kv*d_head] -> [B,T,n_h,d_head]*[B,T,n_h,d_head]
  ...
  model.layers.N.self_attn.q_norm                    mean             [B,T,n_h,d_head] -> [B,T,n_h,B]
  model.layers.N.self_attn.q_norm                    elementwise_add  [B,T,n_h,B] -> [B,T,n_h,B]
  model.layers.N.self_attn.q_norm                    rsqrt            [B,T,n_h,B] -> [B,T,n_h,B]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,T,n_h,d_head]*[B,T,n_h,B] -> [B,T,n_h,d_head]
  ...
  model.layers.N.self_attn.k_norm                    mean             [B,T,n_kv,d_head] -> [B,T,n_kv,B]
  model.layers.N.self_attn.k_norm                    elementwise_add  [B,T,n_kv,B] -> [B,T,n_kv,B]
  model.layers.N.self_attn.k_norm                    rsqrt            [B,T,n_kv,B] -> [B,T,n_kv,B]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,T,n_kv,d_head]*[B,T,n_kv,B] -> [B,T,n_kv,d_head]
  ...
  model.layers.N.self_attn                           unsqueeze        [B,T,d_rope] -> [B,B,T,d_rope]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,T,d_rope]*[B,B,T,d_rope] -> [B,n_h,T,d_rope]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,T,d_rope]*[B,B,T,d_rope] -> [B,n_kv,T,d_rope]
...
```
  ...
  model.rotary_emb                                   batched_matmul   [B,d_rope/2,B]*[B,B,B] -> [B,d_rope/2,B]
  model.rotary_emb                                   _unsafe_view     [B,d_rope/2,B] -> [B,d_rope/2,B]
  model.rotary_emb                                   transpose        [B,d_rope/2,B] -> [B,B,d_rope/2]
  model.rotary_emb                                   concat           [B,B,d_rope/2]*[B,B,d_rope/2] -> [B,B,d_rope]
  model.rotary_emb                                   cos              [B,B,d_rope] -> [B,B,d_rope]
  model.rotary_emb                                   elementwise_mul  [B,B,d_rope] -> [B,B,d_rope]
  model.rotary_emb                                   sin              [B,B,d_rope] -> [B,B,d_rope]
  model.rotary_emb                                   _to_copy         [B,B,d_rope] -> [B,B,d_rope]
  ...
  model.layers.N.linear_attn.in_proj_qkvz            t                [2*n_k*d_k+2*n_v*d_v,d_model] -> w=[2*n_k*d_k+2*n_v*d_v,d_model] [d_model,2*n_k*d_k+2*n_v*d_v]
  model.layers.N.linear_attn.in_proj_qkvz            view             [B,B,d_model] -> [B,d_model]
  model.layers.N.linear_attn.in_proj_qkvz            matmul           [B,d_model]*[d_model,2*n_k*d_k+2*n_v*d_v] -> w=[2*n_k*d_k+2*n_v*d_v,d_model] [B,2*n_h_lin_k*d_head_lin_k+2*n_h_lin_v*d_head_lin_v]
  model.layers.N.linear_attn.in_proj_qkvz            _unsafe_view     [B,2*n_h_lin_k*d_head_lin_k+2*n_h_lin_v*d_head_lin_v] -> [B,B,2*n_k*d_k+2*n_v*d_v]
  model.layers.N.linear_attn.in_proj_ba              t                [d_rope,d_model] -> w=[d_rope,d_model] [d_model,d_rope]
  model.layers.N.linear_attn.in_proj_ba              view             [B,B,d_model] -> [B,d_model]
  model.layers.N.linear_attn.in_proj_ba              matmul           [B,d_model]*[d_model,d_rope] -> w=[d_rope,d_model] [B,2*n_h_lin_v]
  model.layers.N.linear_attn.in_proj_ba              _unsafe_view     [B,2*n_h_lin_v] -> [B,B,d_rope]
  model.layers.N.linear_attn                         view             [B,B,2*n_k*d_k+2*n_v*d_v] -> [B,B,n_h,3*d_head]
  model.layers.N.linear_attn                         view             [B,B,d_rope] -> [B,B,n_h,d_conv_lin]
  model.layers.N.linear_attn                         split_with_sizes [B,B,n_h,3*d_head] -> [B,B,n_h,d_head_lin_k]*[B,B,n_h,d_head_lin_k]*[B,B,n_h,d_head]*[B,B,n_h,d_head]
  model.layers.N.linear_attn                         split_with_sizes [B,B,n_h,d_conv_lin] -> [B,B,n_h,d_conv_lin/2]*[B,B,n_h,d_conv_lin/2]
  model.layers.N.linear_attn                         clone            [B,B,n_h,d_head] -> [B,B,n_h,d_head]
  model.layers.N.linear_attn                         _unsafe_view     [B,B,n_h,d_head] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         clone            [B,B,n_h,d_conv_lin/2] -> [B,B,n_h,d_conv_lin/2]
  model.layers.N.linear_attn                         _unsafe_view     [B,B,n_h,d_conv_lin/2] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         clone            [B,B,n_h,d_head_lin_k] -> [B,B,n_h,d_head_lin_k]
  model.layers.N.linear_attn                         _unsafe_view     [B,B,n_h,d_head_lin_k] -> [B,B,d_model]
  model.layers.N.linear_attn                         view             [B,B,n_h_lin_v,d_head_lin_k] -> [B,B,n_h*d_head]
  model.layers.N.linear_attn                         concat           [B,B,d_model]*[B,B,d_model]*[B,B,n_h*d_head] -> [B,B,4*d_model]
  model.layers.N.linear_attn                         transpose        [B,B,4*d_model] -> [B,4*d_model,B]
  model.layers.N.linear_attn                         squeeze          [4*d_model,B,d_conv_lin] -> w=[4*d_model,B,d_conv_lin] [4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         concat           [B,4*d_model,d_conv_lin]*[B,4*d_model,B] -> [B,4*d_model,5]
  model.layers.N.linear_attn                         slice            [B,4*d_model,5] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         copy_            [B,4*d_model,d_conv_lin]*[B,4*d_model,d_conv_lin] -> [B,4*d_model,d_conv_lin]
  model.layers.N.linear_attn                         unsqueeze        [4*d_model,d_conv_lin] -> [4*d_model,B,d_conv_lin]
  model.layers.N.linear_attn                         conv1d           [B,4*d_model,5]*[4*d_model,B,d_conv_lin] -> [B,4*d_model,n_kv]
  model.layers.N.linear_attn                         slice            [B,4*d_model,n_kv] -> [B,4*d_model,B]
  model.layers.N.linear_attn                         silu             [B,4*d_model,B] -> [B,4*d_model,B]
  model.layers.N.linear_attn                         transpose        [B,4*d_model,B] -> [B,B,4*d_model]
  model.layers.N.linear_attn                         split_with_sizes [B,B,4*d_model] -> [B,B,d_model]*[B,B,d_model]*[B,B,n_h*d_head]
  model.layers.N.linear_attn                         view             [B,B,d_model] -> [B,B,n_h,d_head_lin_k]
  model.layers.N.linear_attn                         view             [B,B,n_h*d_head] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         sigmoid          [B,B,n_h_lin_v] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         _to_copy         [n_h_lin_v] -> [n_h_lin_v]
  model.layers.N.linear_attn                         exp              [n_h_lin_v] -> [n_h_lin_v]
  model.layers.N.linear_attn                         neg              [n_h_lin_v] -> [n_h_lin_v]
  model.layers.N.linear_attn                         _to_copy         [B,B,n_h_lin_v] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         elementwise_add  [B,B,n_h_lin_v]*[n_h_lin_v] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         softplus         [B,B,n_h_lin_v] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         elementwise_mul  [n_h_lin_v]*[B,B,n_h_lin_v] -> [B,B,n_h_lin_v]
  model.layers.N.linear_attn                         unsqueeze        [B,B,n_h,d_head_lin_k] -> [B,B,n_h,B,d_head_lin_k]
  model.layers.N.linear_attn                         expand           [B,B,n_h,B,d_head_lin_k] -> [B,B,n_h,d_conv_lin/2,d_head_lin_k]
  model.layers.N.linear_attn                         clone            [B,B,n_h,d_conv_lin/2,d_head_lin_k] -> [B,B,n_h,d_conv_lin/2,d_head_lin_k]
  model.layers.N.linear_attn                         view             [B,B,n_h,d_conv_lin/2,d_head_lin_k] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         elementwise_mul  [B,B,n_h_lin_v,d_head_lin_k]*[B,B,n_h_lin_v,d_head_lin_k] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         sum              [B,B,n_h_lin_v,d_head_lin_k] -> [B,B,n_h_lin_v,B]
  model.layers.N.linear_attn                         elementwise_add  [B,B,n_h_lin_v,B] -> [B,B,n_h_lin_v,B]
  model.layers.N.linear_attn                         rsqrt            [B,B,n_h_lin_v,B] -> [B,B,n_h_lin_v,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,B,n_h_lin_v,d_head_lin_k]*[B,B,n_h_lin_v,B] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         transpose        [B,B,n_h_lin_v,d_head_lin_k] -> [B,n_h_lin_v,B,d_head_lin_k]
  model.layers.N.linear_attn                         _to_copy         [B,n_h_lin_v,B,d_head_lin_k] -> [B,n_h_lin_v,B,d_head_lin_k]
  model.layers.N.linear_attn                         transpose        [B,B,n_h_lin_v] -> [B,n_h_lin_v,B]
  model.layers.N.linear_attn                         _to_copy         [B,n_h_lin_v,B] -> [B,n_h_lin_v,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,n_h_lin_v,B,d_head_lin_k] -> [B,n_h_lin_v,B,d_head_lin_k]
  model.layers.N.linear_attn                         zeros            [] -> [B,n_h_lin_v,B,d_head_lin_k]
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B,d_head_lin_k] -> [B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         select           [B,n_h_lin_v,B] -> [B,n_h_lin_v]
  model.layers.N.linear_attn                         exp              [B,n_h_lin_v] -> [B,n_h_lin_v]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v] -> [B,n_h_lin_v,B]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,B] -> [B,n_h_lin_v,B,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,n_h_lin_v,d_head_lin_k,d_head_lin_v]*[B,n_h_lin_v,B,B] -> [B,n_h_lin_v,d_head_lin_k,d_head_lin_v]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,d_head_lin_k] -> [B,n_h_lin_v,d_head_lin_k,B]
  model.layers.N.linear_attn                         elementwise_mul  [B,n_h_lin_v,d_head_lin_k,d_head_lin_v]*[B,n_h_lin_v,d_head_lin_k,B] -> [B,n_h_lin_v,d_head_lin_k,d_head_lin_v]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,d_head_lin_k,d_head_lin_v] -> [B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         sub              [B,n_h_lin_v,d_head_lin_k]*[B,n_h_lin_v,d_head_lin_k] -> [B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,d_head_lin_k] -> [B,n_h_lin_v,B,d_head_lin_k]
  ...
  model.layers.N.linear_attn                         transpose        [B,n_h_lin_v,B,d_head_lin_k] -> [B,B,n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn                         _to_copy         [B,B,n_h_lin_v,d_head_lin_k] -> [B,B,n_h_lin_v,d_head_lin_k]
  ...
  model.layers.N.linear_attn.norm                    _to_copy         [n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.norm                    pow              [n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.norm                    mean             [n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,B]
  ...
  model.layers.N.linear_attn.norm                    elementwise_mul  [n_h_lin_v,d_head_lin_k]*[n_h_lin_v,B] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.norm                    elementwise_mul  [d_head_lin_k]*[n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.norm                    silu             [n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.norm                    elementwise_mul  [n_h_lin_v,d_head_lin_k]*[n_h_lin_v,d_head_lin_k] -> [n_h_lin_v,d_head_lin_k]
  model.layers.N.linear_attn.out_proj                t                [d_model,n_h*d_head] -> w=[d_model,n_h*d_head] [n_h*d_head,d_model]
  model.layers.N.linear_attn.out_proj                view             [B,B,n_h*d_head] -> [B,n_h_lin_v*d_head_lin_v]
  model.layers.N.linear_attn.out_proj                matmul           [B,n_h_lin_v*d_head_lin_v]*[n_h*d_head,d_model] -> w=[d_model,n_h*d_head] [B,d_model]
  model.layers.N.linear_attn.out_proj                _unsafe_view     [B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.mlp                                 view             [B,B,d_model] -> [B,d_model]
  model.layers.N.mlp.shared_expert.gate_proj         t                [d_moe,d_model] -> w=[d_moe,d_model] [d_model,d_moe]
  ...
  model.layers.N.mlp.gate                            sum              [B,k] -> [B,B]
  model.layers.N.mlp.gate                            div_             [B,k]*[B,B] -> [B,k]
  ...
  model.layers.N.mlp.experts                         histc            [k] -> [d_moe]
  model.layers.N.mlp.experts                         cumsum           [d_moe] -> [d_moe]
  ...
  model.layers.N.mlp.experts                         transpose        [d_moe,2*d_moe,d_model] -> w=[d_moe,2*d_moe,d_model] [d_moe,d_model,2*d_moe]
  model.layers.N.mlp.experts                         grouped_matmul   [k,d_model]*[d_moe,d_model,2*d_moe]*[d_moe] -> w=[d_moe,2*d_moe,d_model] [k,2*d_moe]
  ...
  model.layers.N.mlp.experts                         transpose        [d_moe,d_model,E] -> w=[d_moe,d_model,E] [d_moe,E,d_model]
  model.layers.N.mlp.experts                         grouped_matmul   [k,d_moe]*[d_moe,E,d_model]*[d_moe] -> w=[d_moe,d_model,E] [k,d_model]
  ...
  model.layers.N.mlp.shared_expert_gate              t                [B,d_model] -> w=[B,d_model] [d_model,B]
  model.layers.N.mlp.shared_expert_gate              matmul           [B,d_model]*[d_model,B] -> w=[B,d_model] [B,B]
  model.layers.N.mlp                                 sigmoid          [B,B] -> [B,B]
  model.layers.N.mlp                                 elementwise_mul  [B,B]*[B,d_model] -> [B,d_model]
  model.layers.N.mlp                                 elementwise_add  [B,d_model]*[B,d_model] -> [B,d_model]
  model.layers.N.mlp                                 view             [B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.self_attn.q_proj                    matmul           [B,d_model]*[d_model,4*d_model] -> w=[4*d_model,d_model] [B,2*n_h*d_head]
  model.layers.N.self_attn.q_proj                    _unsafe_view     [B,2*n_h*d_head] -> [B,B,4*d_model]
  model.layers.N.self_attn                           view             [B,B,4*d_model] -> [B,B,n_h,n_kv*d_head]
  model.layers.N.self_attn                           split            [B,B,n_h,n_kv*d_head] -> [B,B,n_h,d_head]*[B,B,n_h,d_head]
  model.layers.N.self_attn                           clone            [B,B,n_h,d_head] -> [B,B,n_h,d_head]
  model.layers.N.self_attn                           _unsafe_view     [B,B,n_h,d_head] -> [B,B,n_h*d_head]
  model.layers.N.self_attn                           view             [B,B,n_h,d_head] -> [B,B,n_h,d_head]
  model.layers.N.self_attn.q_norm                    _to_copy         [B,B,n_h,d_head] -> [B,B,n_h,d_head]
  model.layers.N.self_attn.q_norm                    pow              [B,B,n_h,d_head] -> [B,B,n_h,d_head]
  model.layers.N.self_attn.q_norm                    mean             [B,B,n_h,d_head] -> [B,B,n_h,B]
  model.layers.N.self_attn.q_norm                    elementwise_add  [B,B,n_h,B] -> [B,B,n_h,B]
  model.layers.N.self_attn.q_norm                    rsqrt            [B,B,n_h,B] -> [B,B,n_h,B]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,B,n_h,d_head]*[B,B,n_h,B] -> [B,B,n_h,d_head]
  model.layers.N.self_attn.q_norm                    _to_copy         [d_head] -> [d_head]
  model.layers.N.self_attn.q_norm                    elementwise_add  [d_head] -> [d_head]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,B,n_h,d_head]*[d_head] -> [B,B,n_h,d_head]
  ...
  model.layers.N.self_attn.k_norm                    _to_copy         [B,B,n_kv,d_head] -> [B,B,n_kv,d_head]
  model.layers.N.self_attn.k_norm                    pow              [B,B,n_kv,d_head] -> [B,B,n_kv,d_head]
  model.layers.N.self_attn.k_norm                    mean             [B,B,n_kv,d_head] -> [B,B,n_kv,B]
  model.layers.N.self_attn.k_norm                    elementwise_add  [B,B,n_kv,B] -> [B,B,n_kv,B]
  model.layers.N.self_attn.k_norm                    rsqrt            [B,B,n_kv,B] -> [B,B,n_kv,B]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,n_kv,d_head]*[B,B,n_kv,B] -> [B,B,n_kv,d_head]
  model.layers.N.self_attn.k_norm                    _to_copy         [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_add  [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,n_kv,d_head]*[d_head] -> [B,B,n_kv,d_head]
  ...
  model.layers.N.self_attn                           unsqueeze        [B,B,d_rope] -> [B,B,B,d_rope]
  model.layers.N.self_attn                           slice            [B,n_h,B,d_head] -> [B,n_h,B,d_rope]
  model.layers.N.self_attn                           slice            [B,n_h,B,d_head] -> [B,n_h,B,d_head-d_rope]
  model.layers.N.self_attn                           slice            [B,n_kv,B,d_head] -> [B,n_kv,B,d_rope]
  model.layers.N.self_attn                           slice            [B,n_kv,B,d_head] -> [B,n_kv,B,d_head-d_rope]
  model.layers.N.self_attn                           elementwise_mul  [B,n_h,B,d_rope]*[B,B,B,d_rope] -> [B,n_h,B,d_rope]
  model.layers.N.self_attn                           slice            [B,n_h,B,d_rope] -> [B,n_h,B,d_rope/2]
  model.layers.N.self_attn                           neg              [B,n_h,B,d_rope/2] -> [B,n_h,B,d_rope/2]
  model.layers.N.self_attn                           concat           [B,n_h,B,d_rope/2]*[B,n_h,B,d_rope/2] -> [B,n_h,B,d_rope]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,d_rope]*[B,n_h,B,d_rope] -> [B,n_h,B,d_rope]
  model.layers.N.self_attn                           elementwise_mul  [B,n_kv,B,d_rope]*[B,B,B,d_rope] -> [B,n_kv,B,d_rope]
  model.layers.N.self_attn                           slice            [B,n_kv,B,d_rope] -> [B,n_kv,B,d_rope/2]
  model.layers.N.self_attn                           neg              [B,n_kv,B,d_rope/2] -> [B,n_kv,B,d_rope/2]
  model.layers.N.self_attn                           concat           [B,n_kv,B,d_rope/2]*[B,n_kv,B,d_rope/2] -> [B,n_kv,B,d_rope]
  model.layers.N.self_attn                           elementwise_add  [B,n_kv,B,d_rope]*[B,n_kv,B,d_rope] -> [B,n_kv,B,d_rope]
  model.layers.N.self_attn                           concat           [B,n_h,B,d_rope]*[B,n_h,B,d_head-d_rope] -> [B,n_h,B,d_head]
  model.layers.N.self_attn                           concat           [B,n_kv,B,d_rope]*[B,n_kv,B,d_head-d_rope] -> [B,n_kv,B,d_head]
  ...
  model.layers.N.self_attn                           sigmoid          [B,B,n_h*d_head] -> [B,B,n_h*d_head]
  model.layers.N.self_attn                           elementwise_mul  [B,B,n_h*d_head]*[B,B,n_h*d_head] -> [B,B,n_h*d_head]
  model.layers.N.self_attn.o_proj                    t                [d_model,n_h*d_head] -> w=[d_model,n_h*d_head] [n_h*d_head,d_model]
