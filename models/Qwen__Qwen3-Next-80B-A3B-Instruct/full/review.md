...
```
  ...
  model.layers.N.linear_attn                         unsqueeze        [B,n_h_lin_v,1,n_kv] -> [B,n_h_lin_v,1,2,1]
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,1,2,2] -> [B,n_h_lin_v,1,n_kv]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,1,n_kv]*[B,n_h_lin_v,1,n_kv] -> [B,n_h_lin_v,1,2]
  ...
  model.layers.N.linear_attn                         sum              [B,n_h_lin_v,1,4,4] -> [B,n_h_lin_v,1,d_conv_lin]
  model.layers.N.linear_attn                         elementwise_add  [B,n_h_lin_v,1,d_conv_lin]*[B,n_h_lin_v,1,d_conv_lin] -> [B,n_h_lin_v,1,4]
