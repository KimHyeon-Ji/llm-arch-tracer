...
등록된 규칙 **451,482축**, 약한 근거 617축, 휴리스틱 **2,736축 (0.52%)**, 이름 없음 73,502축.
...
| `model.layers.2.linear_attn` | `3*n_h` | 휴리스틱: 심볼의 배수 | 28 |
...
```
  ...
  model.layers.N.linear_attn                         constant_pad_nd  [B,2*n_h*d_head,T] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         zeros            [] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         slice            [B,2*n_h*d_head,n_kv] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         copy_            [B,2*n_h*d_head,n_kv]*[B,2*n_h*d_head,n_kv] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn.conv1d                  conv1d           [B,2*n_h*d_head,T]*[2*n_h*d_head,B,n_kv] -> w=[2*n_h*d_head,1,n_kv] [B,2*n_h*d_head,20]
  ...
  model.layers.N.linear_attn                         split_with_sizes [B,T,2*n_h*d_head] -> [B,T,2*n_kv*d_head]*[B,T,2*n_kv*d_head]*[B,T,n_h*d_head]
  model.layers.N.linear_attn                         view             [B,T,2*n_kv*d_head] -> [B,T,n_h,d_head_lin_k]
...
```
  ...
  model.layers.N.linear_attn                         squeeze          [2*n_h*d_head,B,n_kv] -> w=[2*n_h*d_head,1,n_kv] [2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         concat           [B,2*n_h*d_head,n_kv]*[B,2*n_h*d_head,1] -> [B,2*n_h*d_head,5]
  model.layers.N.linear_attn                         slice            [B,2*n_h*d_head,5] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         copy_            [B,2*n_h*d_head,n_kv]*[B,2*n_h*d_head,n_kv] -> [B,2*n_h*d_head,n_kv]
  model.layers.N.linear_attn                         unsqueeze        [2*n_h*d_head,n_kv] -> [2*n_h*d_head,B,n_kv]
  model.layers.N.linear_attn                         conv1d           [B,2*n_h*d_head,5]*[2*n_h*d_head,B,n_kv] -> [B,2*n_h*d_head,2]
  ...
  model.layers.N.linear_attn                         split_with_sizes [B,1,2*n_h*d_head] -> [B,1,2*n_kv*d_head]*[B,1,2*n_kv*d_head]*[B,1,n_h*d_head]
  model.layers.N.linear_attn                         view             [B,1,2*n_kv*d_head] -> [B,1,n_h,d_head_lin_k]
