...
| 이 모듈 스코프의 심볼 | 137,412 | 26.01% |
| 이름 없음 (정수 유지) | 71,543 | 13.54% |
| 이 모듈 스코프의 유도식 | 63,401 | 12.00% |
...
```
  ...
  model.layers.N.linear_attn.conv1d                  conv1d           [B,2*n_h*d_head,T]*[2*n_h*d_head,B,d_conv_lin] -> w=[2*n_h*d_head,1,d_conv_lin] [B,2*n_h*d_head,20]
