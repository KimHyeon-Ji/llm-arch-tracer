...
- `2*d_head` in `model.layers.*.self_attn (레이어 8개)` — heur_multiple, 48축
...
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 4, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 5, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 6, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 7, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 8, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 9, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 10, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 11, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 12, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 13, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 14, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 15, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 16, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 17, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 18, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 19, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 20, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 21, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 22, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 23, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 24, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 25, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 26, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 27, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 28, 64]` | 48 |
| `bare` | `model.layers.*.linear_attn` | 64 | `64` | — | 4 | `[B, n_h_lin_v, 1, 29, 64]` | 48 |
...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 56개 | 63736 |
| `n_h_lin_v` | 32 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm`, `model.layers.*.linear_attn.in_proj_b`, `model.layers.*.linear_attn.in_proj_a` | 56544 |
| `d_chunk` | 64 | `model.layers.*.linear_attn` | 21648 |
| `T` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 55개 | 7378 |
...
| `d_head_lin_k` | 128 | `model.layers.*.linear_attn` | 5016 |
| `d_head_lin_v` | 128 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.norm` | 4488 |
| `d_ff` | 9216 | `model.layers.*.mlp.gate_proj`, `model.layers.*.mlp.up_proj`, `model.layers.*.mlp.down_proj`, `model.layers.*.mlp` 외 1개 | 1856 |
| `d_head` | 256 | `model.layers.*.self_attn`, `model.layers.*.self_attn.q_norm`, `model.layers.*.self_attn.k_norm` | 1568 |
| `n_h` | 16 | `model.layers.*.self_attn`, `model.layers.*.self_attn.q_norm` | 1520 |
| `2*d_k_lin+d_v_lin` |  | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.in_proj_qkv`, `model.layers.*.linear_attn.conv1d` | 1488 |
| `n_kv` | 4 | `model.layers.*.self_attn`, `model.layers.*.self_attn.k_norm` | 1040 |
...
| `d_rope` | 64 | `model.layers.*.self_attn`, `model.rotary_emb` | 538 |
| `d_conv_lin` | 4 | `model.layers.*.linear_attn`, `model.layers.*.linear_attn.conv1d` | 480 |
| `T+1` |  | `model.layers.*.self_attn`, `model` | 407 |
| `n_v/n_k` |  | `model.layers.*.linear_attn` | 384 |
...
| `2*n_h*d_head` |  | `model.layers.*.self_attn.q_proj`, `model.layers.*.self_attn` | 144 |
| `n_h/n_kv` |  | `model.layers.*.self_attn` | 128 |
| `d_head-d_rope` |  | `model.layers.*.self_attn` | 64 |
| `T+d_conv_lin-1` |  | `model.layers.*.linear_attn.conv1d`, `model.layers.*.linear_attn` | 48 |
| `2*d_head` |  | `model.layers.*.self_attn` | 32 |
...
| `model.layers.*.linear_attn` | 2 | 720 | — |
| `model.layers.*.linear_attn` | 3 | 672 | — |
| `model.layers.*.linear_attn` | 4 | 672 | `n_kv`, `d_conv_lin` |
| `model.layers.*.linear_attn` | 6 | 672 | — |
| `model.layers.*.linear_attn` | 7 | 672 | — |
| `model.layers.*.linear_attn` | 8 | 672 | — |
| `model.layers.*.linear_attn` | 9 | 672 | — |
| `model.layers.*.linear_attn` | 10 | 672 | — |
| `model.layers.*.linear_attn` | 11 | 672 | — |
| `model.layers.*.linear_attn` | 12 | 672 | — |
| `model.layers.*.linear_attn` | 13 | 672 | — |
| `model.layers.*.linear_attn` | 14 | 672 | — |
| `model.layers.*.linear_attn` | 15 | 672 | — |
| `model.layers.*.linear_attn` | 16 | 672 | `n_h`, `n_h_lin_k` |
| `model.layers.*.linear_attn` | 17 | 672 | — |
| `model.layers.*.linear_attn` | 18 | 672 | — |
| `model.layers.*.linear_attn` | 19 | 672 | — |
| `model.layers.*.linear_attn` | 20 | 672 | — |
| `model.layers.*.linear_attn` | 21 | 672 | — |
| `model.layers.*.linear_attn` | 22 | 672 | — |
| `model.layers.*.linear_attn` | 23 | 672 | — |
| `model.layers.*.linear_attn` | 24 | 672 | — |
| `model.layers.*.linear_attn` | 25 | 672 | — |
| `model.layers.*.linear_attn` | 26 | 672 | — |
| `model.layers.*.linear_attn` | 27 | 672 | — |
| `model.layers.*.linear_attn` | 28 | 672 | — |
| `model.layers.*.linear_attn` | 29 | 672 | — |
| `model.layers.*.linear_attn` | 30 | 672 | — |
| `model.layers.*.linear_attn` | 31 | 672 | — |
| `model.layers.*.linear_attn` | 32 | 672 | `L`, `n_h_lin_v` |
| `model.layers.*.linear_attn` | 33 | 672 | — |
| `model.layers.*.linear_attn` | 34 | 672 | — |
| `model.layers.*.linear_attn` | 35 | 672 | — |
| `model.layers.*.linear_attn` | 36 | 672 | — |
| `model.layers.*.linear_attn` | 37 | 672 | — |
| `model.layers.*.linear_attn` | 38 | 672 | — |
| `model.layers.*.linear_attn` | 39 | 672 | — |
| `model.layers.*.linear_attn` | 40 | 672 | — |
| `model.layers.*.linear_attn` | 41 | 672 | — |
| `model.layers.*.linear_attn` | 42 | 672 | — |
| `model.layers.*.linear_attn` | 43 | 672 | — |
| `model.layers.*.linear_attn` | 44 | 672 | — |
| `model.layers.*.linear_attn` | 45 | 672 | — |
| `model.layers.*.linear_attn` | 46 | 672 | — |
| `model.layers.*.linear_attn` | 47 | 672 | — |
| `model.layers.*.linear_attn` | 48 | 672 | — |
| `model.layers.*.linear_attn` | 49 | 672 | — |
| `model.layers.*.linear_attn` | 50 | 672 | — |
| `model.layers.*.linear_attn` | 51 | 672 | — |
| `model.layers.*.linear_attn` | 52 | 672 | — |
| `model.layers.*.linear_attn` | 53 | 672 | — |
| `model.layers.*.linear_attn` | 54 | 672 | — |
| `model.layers.*.linear_attn` | 55 | 672 | — |
| `model.layers.*.linear_attn` | 56 | 672 | — |
| `model.layers.*.linear_attn` | 57 | 672 | — |
| `model.layers.*.linear_attn` | 58 | 672 | — |
| `model.layers.*.linear_attn` | 59 | 672 | — |
| `model.layers.*.linear_attn` | 60 | 672 | — |
| `model.layers.*.linear_attn` | 61 | 672 | — |
| `model.layers.*.linear_attn` | 62 | 672 | — |
| `model.layers.*.linear_attn` | 63 | 672 | — |
...
### C. 모듈이 내는 출력 shape 전부 (60개 모듈 / 588종)
