...
| 라벨 | 값 | 나타나는 모듈 | 축 수 |
|---|---|---|---|
| `B` |  | `model.layers.*.linear_attn`, `model.layers.*.self_attn`, `model.layers.*.input_layernorm`, `model.layers.*.post_attention_layernorm` 외 56개 | 63874 |
...
| `n_h` | 16 | `model.layers.*.self_attn`, `model.layers.*.linear_attn`, `model.layers.*.self_attn.q_norm` | 2336 |
...
| `n_kv` | 4 | `model.layers.*.self_attn`, `model.layers.*.linear_attn`, `model.layers.*.self_attn.k_norm`, `model.layers.*.linear_attn.conv1d` | 1584 |
| `n_h*d_head` |  | `model.layers.*.linear_attn.in_proj_z`, `model.layers.*.linear_attn.out_proj`, `model.layers.*.linear_attn`, `model.layers.*.self_attn.o_proj` 외 1개 | 1200 |
...
| `2*n_kv*d_head` |  | `model.layers.*.linear_attn` | 192 |
...
| `model.layers.*.linear_attn` | 2 | 1104 | — |
