...
```
  ...
  model                                              unsqueeze        [B] -> [B,B]
  model                                              unsqueeze        [B,B] -> [B,B,B]
  model                                              unsqueeze        [B,B,B] -> [B,B,B,B]
  model                                              unsqueeze        [T] -> [B,T]
  model                                              unsqueeze        [B,T] -> [B,B,T]
  model                                              unsqueeze        [B,B,T] -> [B,B,T,B]
  model                                              new_ones         [B,B,T,B] -> []
  model                                              sub              [B,B,T,B] -> [B,B,T,B]
  model                                              gt               [B,B,B,T]*[B,B,T,B] -> [B,B,T,T]
  model                                              bitwise_and      []*[B,B,T,T] -> [B,B,T,T]
  model                                              le               [B,B,B,T]*[B,B,T,B] -> [B,B,T,T]
  model                                              bitwise_and      [B,B,T,T]*[B,B,T,T] -> [B,B,T,T]
  model                                              expand           [B,B,T,T] -> [B,B,T,T]
  ...
  model.layers.N.self_attn                           view             [B,T,d_head] -> [B,T,B,d_head]
  model.layers.N.self_attn                           transpose        [B,T,B,d_head] -> [B,B,T,d_head]
  ...
  model.layers.N.self_attn.q_norm                    mean             [B,n_h,T,d_head] -> [B,n_h,T,B]
  model.layers.N.self_attn.q_norm                    elementwise_add  [B,n_h,T,B] -> [B,n_h,T,B]
  model.layers.N.self_attn.q_norm                    rsqrt            [B,n_h,T,B] -> [B,n_h,T,B]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,n_h,T,d_head]*[B,n_h,T,B] -> [B,n_h,T,d_head]
  ...
  model.layers.N.self_attn.k_norm                    _to_copy         [B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn.k_norm                    pow              [B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn.k_norm                    mean             [B,B,T,d_head] -> [B,B,T,B]
  model.layers.N.self_attn.k_norm                    elementwise_add  [B,B,T,B] -> [B,B,T,B]
  model.layers.N.self_attn.k_norm                    rsqrt            [B,B,T,B] -> [B,B,T,B]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,T,d_head]*[B,B,T,B] -> [B,B,T,d_head]
  model.layers.N.self_attn.k_norm                    _to_copy         [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_add  [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,T,d_head]*[d_head] -> [B,B,T,d_head]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,B,T,d_head]*[B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn                           slice            [B,B,T,d_head] -> [B,B,T,d_head/2]
  model.layers.N.self_attn                           neg              [B,B,T,d_head/2] -> [B,B,T,d_head/2]
  model.layers.N.self_attn                           concat           [B,B,T,d_head/2]*[B,B,T,d_head/2] -> [B,B,T,d_head]
  model.layers.N.self_attn                           elementwise_add  [B,B,T,d_head]*[B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn                           _to_copy         [] -> []
  model.layers.N.self_attn                           concat           [0]*[B,B,T,d_head] -> [B,B,T,d_head]
  model.layers.N.self_attn                           slice            [B,B,T,d_head] -> [B,B,w_local-1,d_head]
  model.layers.N.self_attn                           unsqueeze        [B,B,T,d_head] -> [B,B,B,T,d_head]
  model.layers.N.self_attn                           expand           [B,B,B,T,d_head] -> [B,B,n_h,T,d_head]
  model.layers.N.self_attn                           view             [B,B,n_h,T,d_head] -> [B,n_h,T,d_head]
  model.layers.N.self_attn                           scalar_tensor    [] -> []
  model.layers.N.self_attn                           where            [B,B,T,T]*[]*[] -> [B,B,T,T]
  ...
  model.layers.N.self_attn                           elementwise_add  [B,n_h,T,T]*[B,B,T,T] -> [B,n_h,T,T]
  ...
  model.layers.N.self_attn                           clone            [B,B,n_h,T,d_head] -> [B,B,n_h,T,d_head]
...
```
  ...
  model                                              unsqueeze        [B,w_local] -> [B,B,w_local]
  model                                              unsqueeze        [B,B,w_local] -> [B,B,B,w_local]
  model                                              new_ones         [B,B,B,B] -> []
  model                                              sub              [B,B,B,B] -> [B,B,B,B]
  model                                              gt               [B,B,B,w_local]*[B,B,B,B] -> [B,B,B,w_local]
  model                                              bitwise_and      []*[B,B,B,w_local] -> [B,B,B,w_local]
  model                                              le               [B,B,B,w_local]*[B,B,B,B] -> [B,B,B,w_local]
  model                                              bitwise_and      [B,B,B,w_local]*[B,B,B,w_local] -> [B,B,B,w_local]
  model                                              expand           [B,B,B,w_local] -> [B,B,B,w_local]
  model.rotary_emb                                   unsqueeze        [d_head/2] -> [B,d_head/2]
  model.rotary_emb                                   unsqueeze        [B,d_head/2] -> [B,d_head/2,B]
  model.rotary_emb                                   expand           [B,d_head/2,B] -> [B,d_head/2,B]
  ...
  model.layers.N.self_attn.k_proj                    _unsafe_view     [B,d_head] -> [B,B,d_head]
  model.layers.N.self_attn                           view             [B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn                           transpose        [B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn.v_proj                    t                [d_head,d_model] -> w=[d_head,d_model] [d_model,d_head]
  ...
  model.layers.N.self_attn.v_proj                    _unsafe_view     [B,d_head] -> [B,B,d_head]
  model.layers.N.self_attn.q_norm                    _to_copy         [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.self_attn.q_norm                    pow              [B,n_h,B,d_head] -> [B,n_h,B,d_head]
  model.layers.N.self_attn.q_norm                    mean             [B,n_h,B,d_head] -> [B,n_h,B,B]
  model.layers.N.self_attn.q_norm                    elementwise_add  [B,n_h,B,B] -> [B,n_h,B,B]
  model.layers.N.self_attn.q_norm                    rsqrt            [B,n_h,B,B] -> [B,n_h,B,B]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,n_h,B,d_head]*[B,n_h,B,B] -> [B,n_h,B,d_head]
  model.layers.N.self_attn.q_norm                    _to_copy         [d_head] -> [d_head]
  model.layers.N.self_attn.q_norm                    elementwise_add  [d_head] -> [d_head]
  model.layers.N.self_attn.q_norm                    elementwise_mul  [B,n_h,B,d_head]*[d_head] -> [B,n_h,B,d_head]
  model.layers.N.self_attn.k_norm                    _to_copy         [B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn.k_norm                    pow              [B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn.k_norm                    mean             [B,B,B,d_head] -> [B,B,B,B]
  model.layers.N.self_attn.k_norm                    elementwise_add  [B,B,B,B] -> [B,B,B,B]
  model.layers.N.self_attn.k_norm                    rsqrt            [B,B,B,B] -> [B,B,B,B]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,B,d_head]*[B,B,B,B] -> [B,B,B,d_head]
  model.layers.N.self_attn.k_norm                    _to_copy         [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_add  [d_head] -> [d_head]
  model.layers.N.self_attn.k_norm                    elementwise_mul  [B,B,B,d_head]*[d_head] -> [B,B,B,d_head]
  ...
  model.layers.N.self_attn                           elementwise_mul  [B,B,B,d_head]*[B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn                           slice            [B,B,B,d_head] -> [B,B,B,d_head/2]
  model.layers.N.self_attn                           neg              [B,B,B,d_head/2] -> [B,B,B,d_head/2]
  model.layers.N.self_attn                           concat           [B,B,B,d_head/2]*[B,B,B,d_head/2] -> [B,B,B,d_head]
  model.layers.N.self_attn                           elementwise_add  [B,B,B,d_head]*[B,B,B,d_head] -> [B,B,B,d_head]
  model.layers.N.self_attn                           concat           [B,B,w_local-1,d_head]*[B,B,B,d_head] -> [B,B,w_local,d_head]
  model.layers.N.self_attn                           slice            [B,B,w_local,d_head] -> [B,B,w_local-1,d_head]
  model.layers.N.self_attn                           unsqueeze        [B,B,w_local,d_head] -> [B,B,B,w_local,d_head]
  model.layers.N.self_attn                           expand           [B,B,B,w_local,d_head] -> [B,B,n_h,w_local,d_head]
  model.layers.N.self_attn                           view             [B,B,n_h,w_local,d_head] -> [B,n_h,w_local,d_head]
  model.layers.N.self_attn                           scalar_tensor    [] -> []
  model.layers.N.self_attn                           where            [B,B,B,w_local]*[]*[] -> [B,B,B,w_local]
  ...
  model.layers.N.self_attn                           _unsafe_view     [n_h,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           elementwise_add  [B,n_h,B,w_local]*[B,B,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           softmax          [B,n_h,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           _to_copy         [B,n_h,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           expand           [B,n_h,B,w_local] -> [B,n_h,B,w_local]
  model.layers.N.self_attn                           view             [B,n_h,B,w_local] -> [n_h,B,w_local]
  ...
  model.layers.N.pre_feedforward_layernorm           _to_copy         [B,B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.post_feedforward_layernorm          _to_copy         [B,B,d_model] -> [B,B,d_model]
  ...
  model.layers.N.self_attn                           concat           [B,B,T,d_head]*[B,B,B,d_head] -> [B,B,T+1,d_head]
  model.layers.N.self_attn                           _to_copy         [B,B,T+1,d_head] -> [B,B,T+1,d_head]
  model.layers.N.self_attn                           unsqueeze        [B,B,T+1,d_head] -> [B,B,B,T+1,d_head]
  model.layers.N.self_attn                           expand           [B,B,B,T+1,d_head] -> [B,B,n_h,T+1,d_head]
  model.layers.N.self_attn                           clone            [B,B,n_h,T+1,d_head] -> [B,B,n_h,T+1,d_head]
